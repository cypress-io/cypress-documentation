...
Yes, you can. You can write Cypress tests using Cucumber syntax, and a special preprocessor would convert those tests into the "regular" JavaScript Cypress tests.
