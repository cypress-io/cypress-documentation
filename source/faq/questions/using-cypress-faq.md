...
The `projectId` is a 6 character string that helps identify your project once you've {% url "set up your tests to record" dashboard-service#Recorded-runs %}. It's generated by Cypress and can be found in your {% url "configuration file (`cypress.json` by default)" configuration %}.
