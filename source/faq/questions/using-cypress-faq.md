...
There are a couple really great modules that we recommend using for this, {% url "`wait-on`" https://github.com/jeffbski/wait-on %} and {% url '`start-server-and-test`' https://github.com/bahmutov/start-server-and-test %}.
