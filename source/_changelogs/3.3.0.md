...
- Exposed `Cypress.isCy()` method to check if a value is a valid instance of `cy` or a `cy` chainable. Fixes {% issue 3822 %}.
...
- Added type definition for `Cypress.isCy()` method. Fixes {% issue 3822 %}.
