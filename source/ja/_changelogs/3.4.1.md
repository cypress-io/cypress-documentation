...
- We’re excited to announce {% url "GitHub integration" github-integration %} for the {% url "Cypress Dashboard" https://on.cypress.io/dahsboard %}. You can now get timely and useful test run information within pull-requests via status checks and pull-request comments. Learn all about it on {% url "our blog" https://www.cypress.io/blog/2019/07/29/github-integration-for-the-cypress-dashboard/ %}. Addresses {% issue 981 %}.
