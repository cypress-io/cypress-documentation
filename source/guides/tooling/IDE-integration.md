...
- {% url "Cypress-Pro" https://plugins.jetbrains.com/plugin/13987-cypress-pro %}: Integrates Cypress under the common Intellij test framework. It also provides advanced autocomplete, debugging from the IDE and other features.
