...
- {% url "Cypress-Pro" https://plugins.jetbrains.com/plugin/13987-cypress-pro %}: An improved version of the Intellij-Cypress plugin with debugging from the IDE, advanced autocomplete and other functions.  
