...
- Fixed Cypress hanging in CI due to excessive and unnecessary globbing. We finally tracked down this issue which made it appear as if Cypress got "hung" after closing a spec file and then attempting to open the next one. Fixes {% issue 2183 %} and {% issue 1905 %} and {% issue 1912 %}.
