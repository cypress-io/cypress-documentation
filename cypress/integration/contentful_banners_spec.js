...
//
//   it('emoji strip test', () => {
//     // remove all text, numbers, symbols, \n, \t
//     const onlyEmoji = allEmoji
//     .replace(/[a-zA-Z0-9-_., :&#+*]/gi, '') //remove text, numbers, symbols
//     .replace(/\n/g, '') // new lines
//     .replace(/\t/g, '') // tabs
//     // use emoji strip function
//     const striped = emojiStrip(onlyEmoji).replace(/[\u200B-\u200D\uFEFF]/uigm, '')
//
//     console.log({ test: allEmoji.replace(/[^A-Za-z_0-9.,]/ugim, '') })
//
//     // then
//     expect(striped).to.be.a('string').and.empty
//   })
// })
  ...
  it('displays all current banners with proper info', function () {
    ...
    .then((banners) => {
      ...
      .each((banner, i) => {
        ...
        .should((bannerText) => {
          const htmlText = regexpTrim(emojiStrip(bannerText))
