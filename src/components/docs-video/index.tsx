...
export default function DocsVideo({ src, title, autoPlay = false, poster }: DocsVideoProps) {
  ...
  return (
    <>
      ...
      {isLocalVideo && <LocalVideo src={src} title={title} autoPlay={autoPlay} poster={poster} />}
    </>
  );
}
