...
:::caution
The Cypress Component Testing library is still in **Alpha**. We are rapidly
...
<Tabs>
  <TabItem value="React (using CRA)" active>
...
```
  ...
  <TabItem value="Vue (using vue-cli)">
