    ...
    return [
        {
            type: node.type,
            lang: 'js',
            meta: (_a = node.meta) === null || _a === void 0 ? void 0 : _a.replace('copyTsToJs', ''),
            value: jsCode,
        },
        {
            type: node.type,
            lang: node.lang,
            meta: (_b = node.meta) === null || _b === void 0 ? void 0 : _b.replace('copyTsToJs', ''),
            value: tsCode,
        },
    ];
}
//# sourceMappingURL=copyTsToJs.js.map