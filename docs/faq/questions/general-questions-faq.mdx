...
## <Icon name="angle-right" /> Is Cypress free and open source? {#Icon-nameangle-right--Is-Cypress-free-and-open-source}
...
## <Icon name="angle-right" /> What operating systems do you support? {#Icon-nameangle-right--What-operating-systems-do-you-support}
...
## <Icon name="angle-right" /> Do you support native mobile apps? {#Icon-nameangle-right--Do-you-support-native-mobile-apps}
...
## <Icon name="angle-right" /> How is this different from 'X' testing tool? {#Icon-nameangle-right--How-is-this-different-from-X-testing-tool}
...
## <Icon name="angle-right" /> Do you support X language or X framework? {#Icon-nameangle-right--Do-you-support-X-language-or-X-framework}
...
## <Icon name="angle-right" /> Can I run Cypress on another browser other than Chrome? {#Icon-nameangle-right--Can-I-run-Cypress-on-another-browser-other-than-Chrome}

You can read about our currently available browsers
[here](/guides/guides/launching-browsers).

## <Icon name="angle-right" /> Will Cypress work in my CI provider? {#Icon-nameangle-right--Will-Cypress-work-in-my-CI-provider}

Cypress works in any [CI provider](/guides/continuous-integration/introduction).

## <Icon name="angle-right" /> Does Cypress require me to change any of my existing code? {#Icon-nameangle-right--Does-Cypress-require-me-to-change-any-of-my-existing-code}
...
## <Icon name="angle-right" /> Does Cypress use Selenium / Webdriver? {#Icon-nameangle-right--Does-Cypress-use-Selenium--Webdriver}
...
## <Icon name="angle-right" /> If Cypress runs in the browser, doesn't that mean it's sandboxed? {#Icon-nameangle-right--If-Cypress-runs-in-the-browser-doesnt-that-mean-its-sandboxed}
...
## <Icon name="angle-right" /> We use WebSockets; will Cypress work with that? {#Icon-nameangle-right--We-use-WebSockets-will-Cypress-work-with-that}

Yes.

## <Icon name="angle-right" /> We have the most complex most outrageous authentication system ever; will Cypress work with that? {#Icon-nameangle-right--We-have-the-most-complex-most-outrageous-authentication-system-ever-will-Cypress-work-with-that}
...
## <Icon name="angle-right" /> Is it possible to use cypress on `.jspa`? {#Icon-nameangle-right--Is-it-possible-to-use-cypress-on-jspa}

Yes. Cypress works on anything rendered to a browser.

## <Icon name="angle-right" /> Can I use Cypress to script user-actions on an external site like `gmail.com`? {#Icon-nameangle-right--Can-I-use-Cypress-to-script-user-actions-on-an-external-site-like-gmailcom}
...
## <Icon name="angle-right" /> Is there code coverage? {#Icon-nameangle-right--Is-there-code-coverage}
...
## <Icon name="angle-right" /> Are there driver bindings in my language? {#Icon-nameangle-right--Are-there-driver-bindings-in-my-language}
...
## <Icon name="angle-right" /> What resources do you recommend to learn JavaScript before writing Cypress tests? {#Icon-nameangle-right--What-resources-do-you-recommend-to-learn-JavaScript-before-writing-Cypress-tests}
...
## <Icon name="angle-right" /> So what benefits would one get for converting one's unit tests from Karma or Jest to Cypress? {#Icon-nameangle-right--So-what-benefits-would-one-get-for-converting-ones-unit-tests-from-Karma-or-Jest-to-Cypress}
...
## <Icon name="angle-right" /> When should I write a unit test and when should I write an end-to-end test? {#Icon-nameangle-right--When-should-I-write-a-unit-test-and-when-should-I-write-an-end-to-end-test}
...
## <Icon name="angle-right" /> How do I convince my company to use Cypress? {#Icon-nameangle-right--How-do-I-convince-my-company-to-use-Cypress}
...
## <Icon name="angle-right" /> How can I find out about new versions of Cypress? {#Icon-nameangle-right--How-can-I-find-out-about-new-versions-of-Cypress}
...
## <Icon name="angle-right" /> How often are Cypress App versions released? {#Icon-nameangle-right--How-often-are-Cypress-App-versions-released}
...
## <Icon name="angle-right" /> What information is captured or transmitted when using the Cypress App? {#Icon-nameangle-right--What-information-is-captured-or-transmitted-when-using-the-Cypress-App}
...
## <Icon name="angle-right" /> Can I write API tests using Cypress? <E2EOnlyBadge /> {#Icon-nameangle-right--Can-I-write-API-tests-using-Cypress-E2EOnlyBadge-}
