...
- read
  ...
  for best practices when writing Cucumber tests and getting started with this
  [step-by-step blog post](https://testersdock.com/cypress-cucumber-bdd/) that
  includes instructions for v9 and v10.

If your team is looking to do behavior-driven development, you might be
interested in these articles that discuss using BDD's given/when/then syntax
directly in Cypress instead of using Cucumber's scenarios:
