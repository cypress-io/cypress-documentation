...
## <Icon name="angle-right" /> Should I use Cucumber to write tests?

Cypress does not currently have an official stance on Cucumber as each use case
is unique and based on the needs of the user.
