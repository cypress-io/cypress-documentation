...
you've
[set up your tests to record](/guides/cloud/test-analytics/project-health#Latest-Runs).
...
[set up your tests to record](/guides/cloud/test-analytics/project-health#Latest-Runs).
It helps identify your project and authenticate that your project is even
_allowed_ to record tests.
