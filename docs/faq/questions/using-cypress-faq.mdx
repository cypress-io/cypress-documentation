...
- To get started, read
  ...
  for step-by-step instructions for v9 and v10, or for instructions in v10 with typescript read
  [Cucumber in Cypress: A step by step guide](https://filiphric.com/cucumber-in-cypress-a-step-by-step-guide).

If your team is looking to do behavior-driven development using BDD's given/when/then syntax
directly in Cypress instead of using Cucumber's scenarios, you might be
