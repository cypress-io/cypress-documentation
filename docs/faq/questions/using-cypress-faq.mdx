...
Alternatively, you can disabled [`testIsolation`](/guides/references/configuration#e2e)
at the suite or e2e configuration-level to prevent the clearing of browser state.
