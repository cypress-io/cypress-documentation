...
you may also need to add the following to the version control IP allow
list:**

- `35.169.145.173` - **Dedicated IP**
- `44.199.152.70` - **Dedicated IP**
- `52.70.95.89` - **Dedicated IP**
- `3.211.102.119` - **Dedicated IP** - Will be deprecated on September 25th 2023
- `18.213.72.78` - **Dedicated IP** - Will be deprecated on September 25th 2023
