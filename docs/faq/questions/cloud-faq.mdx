...
2. Then [record your runs](/guides/cloud/test-analytics/project-health#Latest-Runs).
...
means your [test run data](/guides/cloud/test-analytics/project-health#Latest-Runs) is being "recorded" to Cypress
Cloud.
...
[Billing & Usage](/guides/cloud/account-management/billing-and-usage) page within Cypress
Cloud.

## <Icon name="angle-right" /> What counts as a user?

A [user](/guides/cloud/account-management/users) is anyone with a login to Cypress Cloud who has
...
**A private project** means that only [users](/guides/cloud/account-management/users) you
explicitly invite to your [organization](//guides/cloud/account-management/organizations) can see
...
Cypress [test parallelization](/guides/cloud/smart-orchestration/parallelization) is indeed based
...
You can [archive a run](/guides/cloud/test-analytics/project-health#Archive-run) so that it does not
