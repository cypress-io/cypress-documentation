...
Yes! Share among your team or across teams, like QA, marketing, design, etc. Just open the replay, copy the url from the browser address bar and pass it along.
