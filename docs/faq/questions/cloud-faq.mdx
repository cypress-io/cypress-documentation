...
2. Then
   [record your runs](/guides/cloud/test-analytics/runs#Latest-Runs).
...
means your
[test run data](/guides/cloud/test-analytics/runs#Latest-Runs) is
...
You can [archive a run](/guides/cloud/test-analytics/runs#Archive-run)
