...
2. Then
   [record your runs](/guides/cloud/test-analytics/project-health#Latest-Runs).
...
means your
[test run data](/guides/cloud/test-analytics/project-health#Latest-Runs) is
being "recorded" to Cypress Cloud.
...
You can [archive a run](/guides/cloud/test-analytics/project-health#Archive-run)
so that it does not display in the runs list or in analytics.
