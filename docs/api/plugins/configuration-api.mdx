...
- `configFile`: The absolute path to the Cypress configuration file. See the
  [--config-file](/app/guides/command-line#cypress-open) and
...
Read our full guide on [Launching Browsers](/app/guides/launching-browsers)
...
[setupNodeEvents](/app/tooling/plugins-guide#Using-a-plugin) if you wanted.
