...
[plugins file][legacypluginsfile] function)
...
The [`setupNodeEvents`](/guides/references/configuration#setupNodeEvents)
function (or deprecated
[plugins file][legacypluginsfile] function) is
...
`require` **any node module** you have installed, including local files inside your project.
...
function (or deprecated
[plugins file][legacypluginsfile] function) has an
...
[legacypluginsfile]: https://v9.docs.cypress.io/guides/references/configuration#Plugins
