...
function (or deprecated [plugins file][legacypluginsfile] function) receives 2
...
- `configFile`: The absolute path to the
  ...
  [--config-file](/app/guide/command-line#cypress-open) and
  [configFile](/app/guide/module-api) docs for more information on this
  value.
...
[legacypluginsfile]: /app/references/legacy-configuration#Plugins
