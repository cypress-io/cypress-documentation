...
### Log the relative spec path to stdout after the spec is run {#Log-the-relative-spec-path-to-stdout-after-the-spec-is-run}
...
### Delete the recorded video if the spec passed {#Delete-the-recorded-video-if-the-spec-passed}
...
### Delete the recorded video if no tests retried {#Delete-the-recorded-video-if-no-tests-retried}
