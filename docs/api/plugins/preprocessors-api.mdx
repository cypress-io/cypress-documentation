...
### The callback function should return one of the following: {#The-callback-function-should-return-one-of-the-following}
...
### Receiving 'close' event {#Receiving-close-event}
...
### Sending 'rerun' event {#Sending-rerun-event}
