...
### Modify browser launch arguments, preferences, and extensions {#Modify-browser-launch-arguments-preferences-and-extensions}
...
#### Modify browser launch arguments: {#Modify-browser-launch-arguments}
...
##### Open devtools by default {#Open-devtools-by-default}
...
#### Add browser extensions: {#Add-browser-extensions}
...
#### Changing browser preferences: {#Changing-browser-preferences}
...
### Modify Electron app switches {#Modify-Electron-app-switches}
...
### See all Chrome browser switches {#See-all-Chrome-browser-switches}
...
### Set screen size when running headless {#Set-screen-size-when-running-headless}
...
### Override the device pixel ratio {#Override-the-device-pixel-ratio}
...
### Use fake video for webcam testing {#Use-fake-video-for-webcam-testing}
...
### Support unique file download mime types {#Support-unique-file-download-mime-types}
...
### Set a Firefox flag {#Set-a-Firefox-flag}
