...
Any valid chainer that comes from [Chai](/api/assertions#Chai) or
[Chai-jQuery](/api/assertions#Chai-jQuery) or
[Sinon-Chai](/api/assertions#Sinon-Chai).
...
- [Reference: List of Assertions](/api/assertions)
