...
| Version                             | Changes                                                                             |
| ----------------------------------- | ----------------------------------------------------------------------------------- |
| [15.3.0](/app/changelog) | Added support for `{esc}` key.                                                      |
| [15.1.0](/app/changelog) | Expanded support to include named keys and single+multi-codepoint UTF-8 characters. |
| [14.3.0](/app/changelog) | Added the `.press()` command                                                        |
