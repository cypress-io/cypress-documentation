...
- In most cases, `.and()` yields the same subject it was given from the
previous command.
...
#### Chain assertions on the same subject {#Chain-assertions-on-the-same-subject}
...
#### Chain assertions when yield changes {#Chain-assertions-when-yield-changes}
...
#### Assert the href is equal to '/users' {#Assert-the-href-is-equal-to-users}
...
#### Similarities to Chai {#Similarities-to-Chai}
...
- `.and()` will continue to [retry](/guides/core-concepts/retry-ability)
