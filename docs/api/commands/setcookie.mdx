...
| Version                                    | Changes                                                                                                                                       |
| ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------- |
| [12.7.0](/app/changelog#12-7-0) | Support `hostOnly` option for a given domain.                                                                                                 |
| [5.0.0](/app/changelog#5-0-0)   | Removed `experimentalGetCookiesSameSite` and made `sameSite` property always available.                                                       |
| [4.3.0](/app/changelog#4-3-0)   | Added `sameSite` property when the [experimentalGetCookiesSameSite](/app/references/configuration#Experiments) configuration value is `true`. |
| [0.16.0](/app/changelog#0-16-0) | `cy.setCookie()` command added                                                                                                                |
