...
```javascript
// Default: a domain cookie for app.example.com.
// Stored as .app.example.com, so it is also attached to requests for
// api.app.example.com and any other subdomain of app.example.com.
cy.visit('https://app.example.com')
cy.setCookie('cookieconsent_status', 'dismiss')

// hostOnly: true scopes the cookie to the exact host.
// Only attached to requests for app.example.com — not its subdomains,
// siblings, or parent hosts.
