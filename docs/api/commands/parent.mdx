...
#### Get the parent of the active `li` {#Get-the-parent-of-the-active-li}
...
#### Get the parent with class `sub-nav` of all `li` elements {#Get-the-parent-with-class-sub-nav-of-all-li-elements}
...
- `.parent()` requires being chained off a command that yields DOM
element(s).
