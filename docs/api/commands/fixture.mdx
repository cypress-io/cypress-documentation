...
#### Load a `users.json` fixture {#Load-a-usersjson-fixture}

```javascript
cy.fixture('users.json').as('usersData')
```

#### Omit the fixture file's extension {#Omit-the-fixture-files-extension}
...
#### Image fixtures are sent as `base64` by default {#Image-fixtures-are-sent-as-base64-by-default}
...
#### Change encoding of Image fixture {#Change-encoding-of-Image-fixture}
...
### Playing MP3 file {#Playing-MP3-file}
...
### Accessing Fixture Data {#Accessing-Fixture-Data}

#### Using `.then()` to access fixture data {#Using-then-to-access-fixture-data}
...
#### Using fixtures to bootstrap data {#Using-fixtures-to-bootstrap-data}
...
#### Modifying fixture data before using it {#Modifying-fixture-data-before-using-it}
...
#### Using the `fixture` `StaticResponse` property {#Using-the-fixture-StaticResponse-property}
...
#### Automated File Validation {#Automated-File-Validation}
...
### Loaded just once {#Loaded-just-once}
...
- `cy.fixture()` will only run assertions you have chained once, and
