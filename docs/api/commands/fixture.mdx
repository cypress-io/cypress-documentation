...
- `cy.fixture()` ignores the subject it is given.

### Assertions [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Assertions)

- `cy.fixture()` will automatically [retry](/guides/core-concepts/retry-ability)
  until the file
  [exists on disk](/guides/core-concepts/introduction-to-cypress#Default-Assertions).

### Timeouts [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Timeouts)

- `cy.fixture()` can time out while reading the file from disk.
...
[Check out our example recipe using `cy.fixture()` to bootstrap data for our application.](/examples/recipes#Server-Communication)
