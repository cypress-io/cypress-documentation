...
#### Get the root element in a [`.within()`](/api/commands/within) callback function {#Get-the-root-element-in-a-within-callback-function}
...
- `cy.root()` can time out waiting for assertions you've added to
pass.
