...
| Version                                    | Changes                                                       |
| ------------------------------------------ | ------------------------------------------------------------- |
| [12.0.0](/app/changelog#12-0-0) | `.invoke()` no longer supports promises or async functions    |
| [3.8.0](/app/changelog#3-8-0)   | Added support for `options` argument                          |
| [3.7.0](/app/changelog#3-7-0)   | Added support for arguments of type Number for `functionName` |
