...
For 'selecting' an option, type it into the input.
...
// by cancelling keydown, keypress, or textInput
...
those will show up as empty. For instance, cancelling `keydown` will not fire
