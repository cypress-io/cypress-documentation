...
#### Yield the elements that do not have class `active` {#Yield-the-elements-that-do-not-have-class-active}
...
- `.not()` requires being chained off a command that yields DOM
element(s).
