...
- `cy.wait()` ignores the subject it was given, except to pass it through if
  given a `time` argument.

### Assertions [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Assertions)

- `cy.wait()` has no [implicit assertions](/guides/core-concepts/introduction-to-cypress#Implicit-Assertions).

### Timeouts [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Timeouts)

- When given a `time` argument, `cy.wait()` cannot time out.
- When given an alias argument, `cy.wait()` can time out waiting for the request
  to go out.
- When given an alias argument, `cy.wait()` can time out waiting for the
  response to return.
...
- When given a `time` argument, `cy.wait()` yields the same subject it was
  given.
- When given an alias argument, `cy.wait()` yields an object containing the HTTP
  request and response properties of the request.
