...
[You can read more about aliasing routes in our Core Concept Guide](/app/guide/network-requests#Waiting).
...
Read about
[best practices](/app/references/best-practices#Unnecessary-Waiting) here.
...
[read more about waiting on routes here](/app/guide/network-requests#Waiting).
