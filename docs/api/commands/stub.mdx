...
#### Create a stub and manually replace a function {#Create-a-stub-and-manually-replace-a-function}
...
#### Replace a method with a stub {#Replace-a-method-with-a-stub}
...
#### Replace a method with a function {#Replace-a-method-with-a-function}
...
#### Specify the return value of a stubbed method {#Specify-the-return-value-of-a-stubbed-method}
...
#### Replace built-in window methods like prompt {#Replace-built-in-window-methods-like-prompt}
...
#### Disable logging to Command Log {#Disable-logging-to-Command-Log}
...
#### More `cy.stub()` examples {#More-cystub-examples}
...
#### Automatic reset/restore between tests {#Automatic-resetrestore-between-tests}
...
#### Difference between cy.spy() and cy.stub() {#Difference-between-cyspy-and-cystub}
