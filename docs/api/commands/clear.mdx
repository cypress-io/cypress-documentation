...
- `.clear()` yields the same subject it was given from the previous
command.
...
#### Clear the input and type a new value {#Clear-the-input-and-type-a-new-value}
...
- `.clear()` requires being chained off a command that yields DOM
