...
#### Find the closest element of the `.error` with the class 'banner' {#Find-the-closest-element-of-the-error-with-the-class-banner}
...
#### Find the closest element of `li.active` with the class 'nav' {#Find-the-closest-element-of-liactive-with-the-class-nav}
