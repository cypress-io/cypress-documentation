...
- `.uncheck()` yields the same subject it was given from the previous
command.
...
#### Uncheck element with the id 'saveUserName' {#Uncheck-element-with-the-id-saveUserName}
...
#### Uncheck the checkbox with the value of 'ga' {#Uncheck-the-checkbox-with-the-value-of-ga}
...
#### Uncheck the checkboxes with the values 'ga' and 'ca' {#Uncheck-the-checkboxes-with-the-values-ga-and-ca}
...
- `.uncheck()` requires being chained off a command that yields DOM
