...
- `cy.window()` ignores the subject it is given.

### Assertions [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Assertions)

- `cy.window()` has no [implicit assertions](/guides/core-concepts/introduction-to-cypress#Implicit-Assertions).

### Timeouts [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Timeouts)

- `cy.window()` cannot time out. The `timeout` option is only useful to set the
