...
#### Yield the remote window object {#Yield-the-remote-window-object}
...
#### Check a custom property {#Check-a-custom-property}
...
### Start tests when app is ready {#Start-tests-when-app-is-ready}
...
#### Passes timeout through to [`.should()`](/api/commands/should) assertion {#Passes-timeout-through-to-should-assertion}
...
### Cypress uses 2 different windows. {#Cypress-uses-2-different-windows}
...
- `cy.window()` can time out waiting for assertions you've added to
pass.
