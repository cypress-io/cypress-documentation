...
- `.first()` yields the first DOM element in the previous subject.
...
<DocsImage
  ...
  alt="Command Log showing get form, then find input matching 17 elements, then first"
/>
...
<DocsImage
  ...
  alt="Console output for first, listing the inputs it was applied to and the single input#firstName element it yielded"
/>
