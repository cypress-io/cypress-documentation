...
- `cy.getCookie()` ignores the subject it is given.

### Assertions [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Assertions)

- `cy.getCookie()` has no [implicit assertions](/guides/core-concepts/introduction-to-cypress#Implicit-Assertions).
...
- `cy.getCookie()` is not a query. It
  [only reads the cookie once](/guides/core-concepts/retry-ability#Only-queries-are-retried).
...
[logging in using HTML web forms](/examples/recipes#Logging-In),
[logging in using XHR web forms](/examples/recipes#Logging-In) and
[logging in with single sign on](/examples/recipes#Logging-In)
