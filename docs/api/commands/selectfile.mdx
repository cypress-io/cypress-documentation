...
### On a hidden input {#On-a-hidden-input}
...
### From an API response {#From-an-API-response}
...
### Processing data inside the test {#Processing-data-inside-the-test}
...
### Custom fileName, mimeType and lastModified {#Custom-fileName-mimeType-and-lastModified}
...
### Dropping a file on the document {#Dropping-a-file-on-the-document}
...
#### Default file existence assertion {#Default-file-existence-assertion}
