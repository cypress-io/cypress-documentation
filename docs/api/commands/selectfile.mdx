...
| Version                                  | Changes                                                                                                                      |
| ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| [9.4.0](/app/changelog#9-4-0) | Support for `TypedArray` and `mimeType` property added. Default `fileName` name is no longer lost when working with aliases. |
| [9.3.0](/app/changelog#9-3-0) | `.selectFile()` command added                                                                                                |
