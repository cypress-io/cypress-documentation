...
| [3.5.0](/app/changelog#3-5-0) | Added support for options `force` and `multiple`.                                                                       |
| [3.5.0](/app/changelog#3-5-0) | Added support for `position`, `x`, and `y` arguments.                                                                   |
| [3.5.0](/app/changelog#3-5-0) | Added sending `mouseover`, `mousemove`, `mouseout`, `pointerdown`, `pointerup`, and `pointermove` during `.dblclick()`. |
