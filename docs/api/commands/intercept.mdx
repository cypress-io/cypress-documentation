...
- `req.destroy()` - destroy the request and respond with a network error (not supported in
  [experimental WebKit](/app/references/launching-browsers#WebKit-Experimental))
...
`req.destroy()` is not supported in
[experimental WebKit](/app/references/launching-browsers#WebKit-Experimental).
Use `req.reply()` with a specific status code instead to simulate error responses
in WebKit.
...
```ts
{
   ...
   * Not supported in experimental WebKit.
   */
  destroy(): void
  /**
   * Respond to this request with a redirect to a new 'location'.
...
| forceNetworkError | Force an error by destroying the browser connection. Not supported in [experimental WebKit](/app/references/launching-browsers#WebKit-Experimental).                                                                              |
| delay             | Minimum network latency or delay to add to the response time (milliseconds)                                                                                                                                                       |
| throttleKbps      | Maximum data transfer rate of the response (kilobits/second)                                                                                                                                                                      |
