...
| Version                                    | Changes                                         |
| ------------------------------------------ | ----------------------------------------------- |
| [11.0.0](/app/changelog#11-0-0) | Throw error if Cypress command used in callback |
| [0.11.4](/app/changelog#0-11-4) | Allows callback function argument               |
| [< 0.3.3](/app/changelog#0-3-3) | `.should()` command added                       |
