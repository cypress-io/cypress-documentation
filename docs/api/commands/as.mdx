...
| Version                                    | Changes                                                       |
| ------------------------------------------ | ------------------------------------------------------------- |
| [12.3.0](/app/changelog#12-3-0) | Added option `type` to opt into the pre-12.0.0 behavior.      |
| [12.0.0](/app/changelog#12-0-0) | All aliases now re-run queries leading up to them by default. |
