...
| Version                                  | Changes                                                  |
| ---------------------------------------- | -------------------------------------------------------- |
| [9.2.0](/app/changelog#9-2-0) | Added `timeout` option                                   |
| [4.0.0](/app/changelog#4-0-0) | `cy.writeFile()` now yields `null` instead of `contents` |
| [3.1.1](/app/changelog#3-1-1) | Added `flag` option and appending with `a+`              |
| [1.0.0](/app/changelog#1-0-0) | `cy.writeFile()` command added                           |
