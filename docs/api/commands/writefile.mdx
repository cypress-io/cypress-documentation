...
**<Icon name="angle-right" /> contents** **_(String, Array, Object or
Buffer)_**
...
#### Write some text to a `txt` file {#Write-some-text-to-a-txt-file}
...
#### Write response data to a fixture file {#Write-response-data-to-a-fixture-file}
...
#### Specify the encoding as a String {#Specify-the-encoding-as-a-String}
...
#### Specify the encoding as part of the options object {#Specify-the-encoding-as-part-of-the-options-object}
...
#### Append contents to the end of a file {#Append-contents-to-the-end-of-a-file}
...
#### Write a buffer directly without encoding as a string {#Write-a-buffer-directly-without-encoding-as-a-string}
