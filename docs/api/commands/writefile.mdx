...
- `cy.writeFile()` ignores the subject it is given.
...
- `cy.writeFile()` has no [implicit assertions](/guides/core-concepts/introduction-to-cypress#Implicit-Assertions).

### Timeouts [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Timeouts)

- `cy.writeFile()` can time out while trying to encode the file or write the file to disk.
