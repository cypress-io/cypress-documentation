...
`cy.exec()` is deprecated and will be removed in a future major version. The
[`execTimeout`](/app/references/configuration#Timeouts) configuration option is
deprecated along with it.
