...
| Version                                    | Changes                                                                          |
| ------------------------------------------ | -------------------------------------------------------------------------------- |
| [12.0.0](/app/changelog#12-0-0) | `.within()` now throws an error when given more than one element as the subject. |
| [5.4.0](/app/changelog#5-4-0)   | fixed the yielded value to always be the parent element                          |
| [< 0.3.3](/app/changelog#0-3-3) | `.within()` command added                                                        |
