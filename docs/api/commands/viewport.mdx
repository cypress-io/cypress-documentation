...
| Version                                  | Changes                                                                               |
| ---------------------------------------- | ------------------------------------------------------------------------------------- |
| [5.5.0](/app/changelog#5-5-0) | Added support for `macbook-16` preset.                                                |
| [5.4.0](/app/changelog#5-4-0) | Added support for presets `iphone-7`, `iphone-8`, and `iphone-se2`.                   |
| [3.8.0](/app/changelog#3-8-0) | Removed max viewport size and lowered min viewport size to `0`.                       |
| [3.5.0](/app/changelog#3-5-0) | Added support for presets `iphone-xr`, `iphone-x`, `samsung-s10`, and `samsung-note9` |
| [3.5.0](/app/changelog#3-5-0) | Increased max viewport size to `4000`                                                 |
| [0.9.0](/app/changelog#0-9-0) | `cy.viewport()` command added                                                         |
