...
#### Resize the viewport to 1024px x 768px {#Resize-the-viewport-to-1024px-x-768px}

```javascript
cy.viewport(1024, 768)
```

#### Organize desktop vs mobile tests separately {#Organize-desktop-vs-mobile-tests-separately}
...
#### Dynamically test multiple viewports {#Dynamically-test-multiple-viewports}
...
#### Resize the viewport to iPhone 6 width and height {#Resize-the-viewport-to-iPhone-6-width-and-height}
...
#### Change the orientation to landscape {#Change-the-orientation-to-landscape}
...
#### `devicePixelRatio` is not simulated {#devicePixelRatio-is-not-simulated}
...
#### Cypress will restore the viewport in the snapshot {#Cypress-will-restore-the-viewport-in-the-snapshot}
...
### Reset viewport via `Cypress.config()` {#Reset-viewport-via-Cypressconfig}
...
### Set viewport in the test configuration {#Set-viewport-in-the-test-configuration}
