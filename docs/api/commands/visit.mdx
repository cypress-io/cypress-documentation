...
Read about
[best practices](/app/references/best-practices#Setting-a-Global-baseUrl)
here.
...
See
[how to override the browser's default user agent](/faq/questions/using-cypress-faq#Can-I-override-or-change-the-default-user-agent-the-browser-uses).
