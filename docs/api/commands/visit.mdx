...
| Version                                    | Changes                                                                          |
| ------------------------------------------ | -------------------------------------------------------------------------------- |
| [11.0.0](/app/changelog#11-0-0) | Removed `experimentalSessionAndOrigin` reference                                 |
| [3.5.0](/app/changelog#3-5-0)   | Added support for options `qs`                                                   |
| [3.3.0](/app/changelog#3-3-0)   | Added support for options `retryOnStatusCodeFailure` and `retryOnNetworkFailure` |
| [3.2.0](/app/changelog#3-2-0)   | Added options `url`, `method`, `body`, and `headers`                             |
| [1.1.3](/app/changelog#1-1-3)   | Added option `failOnStatusCode`                                                  |
| [0.18.2](/app/changelog#0-18-2) | Automatically send `Accept: text/html,*/*` request header                        |
| [0.18.2](/app/changelog#0-18-2) | Automatically send `User-Agent` header                                           |
| [0.17.0](/app/changelog#0-17-0) | Cannot `cy.visit()` two different super domains in a single test                 |
| [0.6.8](/app/changelog#0-6-8)   | Added option `log`                                                               |
| [0.4.3](/app/changelog#0-4-3)   | Added option `onBeforeLoad`                                                      |
| [< 0.3.3](/app/changelog#0-3-3) | `cy.visit()` command added                                                       |
