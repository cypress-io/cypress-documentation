...
| Version                                    | Changes                                                                                    |
| ------------------------------------------ | ------------------------------------------------------------------------------------------ |
| [12.0.0](/app/changelog#12-0-0) | Removed `experimentalSessionAndOrigin` and made the command available by default.          |
| [11.0.0](/app/changelog#11-0-0) | The `setup` option is now required.                                                        |
| [10.9.0](/app/changelog#10-9-0) | Added `cacheAcrossSpecs` property.                                                         |
| [9.6.0](/app/changelog#9-6-0)   | Added support for `experimentalSessionAndOrigin` and removed `experimentalSessionSupport`. |
| [8.2.0](/app/changelog#8-2-0)   | `cy.session()` command added and can be used when `experimentalSessionSupport` is enabled. |
