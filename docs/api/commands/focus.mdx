...
- After executing, `.focus()` [implicitly asserts](/guides/core-concepts/introduction-to-cypress#Implicit-Assertions) that the element(s) still
  [exist in the DOM](/guides/core-concepts/introduction-to-cypress#Default-Assertions).

### Timeouts [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Timeouts)

- `.focus()` can time out waiting for the element to be able to receive focus.
