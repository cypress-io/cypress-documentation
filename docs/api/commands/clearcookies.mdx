...
- `cy.clearCookies()` yields `null`.</li><li>`cy.clearCookies()` cannot
be chained further.
...
#### Clear all cookies after logging in <E2EOnlyBadge /> {#Clear-all-cookies-after-logging-in-E2EOnlyBadge-}
