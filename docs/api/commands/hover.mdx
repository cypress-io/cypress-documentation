...
[Check out our example recipe on testing hover and working with hidden elements](/examples/recipes#Testing-the-DOM).
...
[recipe leveraging Chrome remote debugging](/examples/recipes#Fundamentals) to
...
- [`Cypress.Commands.overwrite()`](/api/cypress-api/custom-commands#Overwrite-Existing-Commands)
- [Recipe: Hover and Hidden Elements](/examples/recipes#Testing-the-DOM)
