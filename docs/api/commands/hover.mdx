...
[recipe using Chrome remote debugging](/app/references/recipes#Fundamentals) to
...
#### Example of showing an element to perform action
...
While `Cypress.Commands.add()` is the recommended way to define a
...
- [`Cypress.Commands.overwrite()`](/api/cypress-api/custom-commands#Overwrite-Existing-Commands)
- [Recipe: Hover and Hidden Elements](/app/references/recipes#Testing-the-DOM)
