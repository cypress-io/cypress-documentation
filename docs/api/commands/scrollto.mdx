...
- If `.scrollTo()` is not given a subject, it will scroll the current `window`.
- If `.scrollTo()` is given a subject, it must be a DOM element.

### Assertions [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Assertions)

- `.scrollIntoView()` will automatically wait for the window or element to
  become scrollable.
- After executing, `.scrollTo()` [implicitly asserts](/guides/core-concepts/introduction-to-cypress#Implicit-Assertions) that the element(s) still
  [exist in the DOM](/guides/core-concepts/introduction-to-cypress#Default-Assertions).

### Timeouts [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Timeouts)

- `.scrollTo()` can time out waiting for the element or window to be scrollable.
...
- `.scrollTo()` yields either the element it was given or the current `window`.
