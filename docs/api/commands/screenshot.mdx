...
- `.screenshot()` yields the same subject it was given from the previous
command.
...
#### Take a screenshot and save as a specific filename {#Take-a-screenshot-and-save-as-a-specific-filename}
...
#### Take a screenshot and save in a specific directory {#Take-a-screenshot-and-save-in-a-specific-directory}
...
#### Crop a screenshot to a specific position and size {#Crop-a-screenshot-to-a-specific-position-and-size}
...
### Screenshot an element {#Screenshot-an-element}

#### Take a screenshot of the first `.post` element {#Take-a-screenshot-of-the-first-post-element}

```javascript
cy.get('.post').first().screenshot()
```

#### Take a screenshot of the first `.post` element with 10px of padding around it {#Take-a-screenshot-of-the-first-post-element-with-10px-of-padding-around-it}

```javascript
cy.get('.post').first().screenshot({ padding: 10 })
```

#### Chain off the screenshot to click the element captured {#Chain-off-the-screenshot-to-click-the-element-captured}

```javascript
cy.get('button').first().screenshot().click()
```

### Get screenshot info from the `onAfterScreenshot` callback {#Get-screenshot-info-from-the-onAfterScreenshot-callback}
...
### `after:screenshot` plugin event {#afterscreenshot-plugin-event}
...
#### Automatic screenshots on test failure {#Automatic-screenshots-on-test-failure}
...
### Viewing Screenshots {#Viewing-Screenshots}
...
#### Understanding when the screenshot is taken {#Understanding-when-the-screenshot-is-taken}
...
### Full page captures and fixed/sticky elements {#Full-page-captures-and-fixedsticky-elements}
...
#### Take a screenshot with a specific filename {#Take-a-screenshot-with-a-specific-filename}
