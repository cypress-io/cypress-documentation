---
title: 'cy.spy()'
description: Wrap a method in a spy to record calls to and arguments of the function in Cypress.
sidebar_label: spy
---
...
Wrap a method in a spy to record calls to and arguments of the
function.
...
and retrieve them later for assertions using `cy.get()`.
