...
#### Get the parents of the active li {#Get-the-parents-of-the-active-li}
...
#### Get the parents with class `main-nav` of the active li {#Get-the-parents-with-class-main-nav-of-the-active-li}
...
- `.parents()` requires being chained off a command that yields DOM
element(s).
