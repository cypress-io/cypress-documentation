...
- `cy.wrap()` ignores the subject it is given.

### Assertions [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Assertions)

- If the argument is a promise, `cy.wrap()` will automatically wait until the
  promise resolves. If the promise is rejected, `cy.wrap()` will fail the test.

### Timeouts [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Timeouts)

- `cy.wrap()` can time out waiting for the value to resolve if it is a promise.
...
[Logging in using application code](/examples/recipes#Logging-In) recipe for the
full example.
...
- [Logging In: Using application code](/examples/recipes#Logging-In) recipe
- [Unit Testing: Application Code](/examples/recipes#Unit-Testing) recipe
