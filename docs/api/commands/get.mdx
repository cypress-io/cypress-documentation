...
- `cy.get()` ignores the subject it is given.
...
- `cy.get()` will automatically [retry](/guides/core-concepts/retry-ability)
  ...
  or until a matching alias is found.

### Timeouts [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Timeouts)

- `cy.get()` can
  [time out waiting](/guides/core-concepts/introduction-to-cypress#Default-Assertions)
  for at least one matching element to exist in the DOM, or for an aliased
  request to complete.

### Yields [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Subject-Management)

- `cy.get()` is a query command, and is
  [retry-able](/guides/core-concepts/retry-ability#Commands-Queries-and-Assertions).
  It is _safe_ to chain further commands that use the subject after `cy.get()`.
- `cy.get()` yields the DOM element(s) matching the selector, or the results of
  the alias lookup.
