...
- `cy.log()` yields `null`.</li><li>`cy.log()` cannot be chained
further.
...
#### Print a message to the Command Log. {#Print-a-message-to-the-Command-Log}
...
#### Print a message with arguments to the Command Log. {#Print-a-message-with-arguments-to-the-Command-Log}
...
#### Print messages with arguments to the Command Log. {#Print-messages-with-arguments-to-the-Command-Log}
