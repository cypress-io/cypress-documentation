  ...
  it('Scenario: Successful user registration with valid data', () => {
    cy.prompt(
      [
        ...
        'And the user enters {{password}} in the password field', // password placeholder
        'And the user enters {{password}} in the confirm password field', // Same password placeholder used twice
...
describe('Feature: User Registration', () => {
  it('Scenario: Successful user registration with valid data', () => {
    ...
    // Prompt step 8: Then the user clicks the "Register User" button
    cy.get('#registration-form .btn-success').click()

    // Prompt step 10: And the user should see a success notification
    cy.get('.success').should('be.visible')

    // Prompt step 11: And the user should be added to the user list
