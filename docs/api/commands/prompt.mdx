...
New to `cy.prompt`? Start with the [**Natural Language Testing & Self-Healing** guide](/app/guides/cy-prompt), which covers how it works, choosing a workflow, writing effective prompts, self-healing, placeholders, viewing and exporting the generated code, and full examples.
...
- [Natural Language Testing & Self-Healing](/app/guides/cy-prompt)
