...
- **Specify Cypress options**: Some Cypress command options can be specified directly in your prompts using natural language. For example: `'go to "/users" with a timeout of 10 seconds'` or `'dismiss the modal using a timeout of 6 seconds'`. This allows you to customize timeout without changing your test code. Not all Cypress command options can be specified this way.
