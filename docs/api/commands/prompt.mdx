...
New to `cy.prompt`? Start with the [**AI Test Generation** guide](/app/guides/cy-prompt), which covers how it works, choosing a workflow, writing effective prompts, self-healing, placeholders, viewing and exporting the generated code, and full examples.
...
| -------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `placeholders` | `{}`    | Dynamic or sensitive values that enable caching and are excluded from AI calls. See [placeholders](/app/guides/cy-prompt#Placeholders) for more details. |
...
Several of these examples use [placeholders](/app/guides/cy-prompt#Placeholders) for dynamic or sensitive values. For the concepts behind these examples, see the [AI Test Generation guide](/app/guides/cy-prompt).
...
[Sensitive data handling](/app/guides/cy-prompt#Sensitive-data-handling).
:::
...
- [AI Test Generation](/app/guides/cy-prompt) - for generating tests from natural language
