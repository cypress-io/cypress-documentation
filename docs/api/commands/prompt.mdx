...
| -------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `placeholders` | `{}`    | Dynamic or sensitive values that enable high performance caching. See [placeholders](/app/guides/ai-test-generation#Placeholders) for more details. |
