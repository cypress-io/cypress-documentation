...
| Version                                    | Changes                                   |
| ------------------------------------------ | ----------------------------------------- |
| [13.0.0](/app/changelog#13-0-0) | `cy.readFile()` became a query            |
| [9.0.0](/app/changelog#9-0-0)   | Changed `null` encoding to read as Buffer |
| [0.17.2](/app/changelog#0-17-2) | Improved error messaging                  |
| [0.17.1](/app/changelog#0-17-1) | `cy.readFile()` command added             |
