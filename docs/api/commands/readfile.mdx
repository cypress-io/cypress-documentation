...
- `cy.readFile()` ignores the subject it is given.

### Assertions [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Assertions)

- `cy.readFile()` will automatically
  [retry](/guides/core-concepts/retry-ability) until the file
  [exists on disk](/guides/core-concepts/introduction-to-cypress#Default-Assertions)
  and is read successfully.

### Timeouts [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Timeouts)

- `cy.readFile()` can time out waiting for the file to exist.
- `cy.readFile()` can time out when reading the file into memory or sending it
  to the browser takes a significant amount of time.

### Yields [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Subject-Management)

- `cy.readFile()` is a query command, and is
  [retry-able](/guides/core-concepts/retry-ability#Commands-Queries-and-Assertions).
  It will read the file from disk until all following commands in the chain
  (such as assertions) pass.
...
`cy.readFile()` will continue to read the file until all chained commands pass.
