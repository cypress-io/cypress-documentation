...
#### Get translation data from a YAML file {#Get-translation-data-from-a-YAML-file}
...
#### Specify the encoding with the second argument {#Specify-the-encoding-with-the-second-argument}
...
#### Asserting file non-existence {#Asserting-file-non-existence}
