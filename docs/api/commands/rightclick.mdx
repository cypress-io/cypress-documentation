...
- `.rightclick()` yields the same subject it was given from the previous
command.
...
#### Right click the menu {#Right-click-the-menu}
...
#### Specify a corner of the element to right click {#Specify-a-corner-of-the-element-to-right-click}
...
#### Force a right click regardless of its actionable state {#Force-a-right-click-regardless-of-its-actionable-state}
...
#### Force a right click with position argument {#Force-a-right-click-with-position-argument}

```javascript
cy.get('#open-menu').rightclick('bottomLeft', { force: true })
```

#### Force a right click with relative coordinates {#Force-a-right-click-with-relative-coordinates}

```javascript
cy.get('#open-menu').rightclick(5, 60, { force: true })
```

#### Right click all buttons found on the page {#Right-click-all-buttons-found-on-the-page}
...
#### Right click with key combinations {#Right-click-with-key-combinations}
...
##### Command right click {#Command-right-click}
