...
#### Find all of the element's siblings following `.second` {#Find-all-of-the-elements-siblings-following-second}
...
#### Find all of the following siblings of each li. Keep only the ones with a class `selected` {#Find-all-of-the-following-siblings-of-each-li-Keep-only-the-ones-with-a-class-selected}
...
- `.nextAll()` requires being chained off a command that yields DOM
element(s).
