...
- `.shadow()` can
  ...
  for at least one subject element to host a shadow root.

### Yields [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Subject-Management)

- `.shadow()` is a query command, and will not break a chain of
  [retry-ability](/guides/core-concepts/retry-ability#Commands-Queries-and-Assertions).
  It is _safe_ to chain further commands that use the subject after `.shadow()`.
- `.shadow()` yields the shadow roots of all subject elements that have one.
