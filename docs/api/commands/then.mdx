...
#### The `button` element is yielded {#The-button-element-is-yielded}
...
#### The number is yielded from previous command {#The-number-is-yielded-from-previous-command}
...
#### The el subject is changed with another command {#The-el-subject-is-changed-with-another-command}
...
#### The number subject is changed with another command {#The-number-subject-is-changed-with-another-command}
...
#### The number subject is changed by returning {#The-number-subject-is-changed-by-returning}
...
#### Returning `undefined` will not modify the yielded subject {#Returning-undefined-will-not-modify-the-yielded-subject}
...
### Raw HTMLElements are wrapped with jQuery {#Raw-HTMLElements-are-wrapped-with-jQuery}
...
#### Example using Q {#Example-using-Q}
...
#### Example using bluebird {#Example-using-bluebird}
...
#### Example using jQuery deferred's {#Example-using-jQuery-deferreds}
