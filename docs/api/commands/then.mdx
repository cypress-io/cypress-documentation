...
- `.then()` will receive the subject yielded by the previous command. If chained
  directly off `cy`, the subject is `undefined`.

### Assertions [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Assertions)

- `.then()` has no [implicit assertions](/guides/core-concepts/introduction-to-cypress#Implicit-Assertions).
...
- If the returned values are DOM elements, it is
  ...
  chain further commands that rely on the subject after `.then()`.
