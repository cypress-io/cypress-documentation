...
<strong>Changes in Cypress [v14.0.0](/app/changelog#14-0-0)</strong>
...
since [Cypress 12.0.0](https://docs.cypress.io/app/changelog#12-0-0)
...
| Version                                     | Changes                                                                                                     |
| ------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| [14.0.0](/app/changelog#14-0-0)  | `cy.origin()` is now required when navigating between origins in the same test, rather than superdomains.   |
| [12.6.0](/app/changelog#10-7-0)  | Support for `Cypress.require()` added and support for CommonJS `require()` and ES module `import()` removed |
| [10.11.0](/app/changelog#10-7-0) | Support for CommonJS `require()` and ES module `import()` added and support for `Cypress.require()` removed |
| [10.7.0](/app/changelog#10-7-0)  | Support for `Cypress.require()` added                                                                       |
