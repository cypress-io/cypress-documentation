...
<strong><Icon name="exclamation-triangle" />
Experimental</strong>
...
### Using dynamic data in a secondary origin {#Using-dynamic-data-in-a-secondary-origin}
...
### Navigating to secondary origin with cy.visit {#Navigating-to-secondary-origin-with-cyvisit}
...
### Navigating to secondary origin with UI {#Navigating-to-secondary-origin-with-UI}
...
### Navigating to multiple secondary origins in succession {#Navigating-to-multiple-secondary-origins-in-succession}
...
### SSO login custom command {#SSO-login-custom-command}
...
### How to Test Multiple Origins {#How-to-Test-Multiple-Origins}
...
### Migrating existing tests {#Migrating-existing-tests}
...
### Callback restrictions {#Callback-restrictions}
