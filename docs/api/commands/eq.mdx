...
#### Find the 2nd element within the elements {#Find-the-2nd-element-within-the-elements}
...
#### Make an assertion on the 3rd row of a table {#Make-an-assertion-on-the-3rd-row-of-a-table}
...
#### Find the 2nd from the last element within the elements {#Find-the-2nd-from-the-last-element-within-the-elements}
...
- `.eq()` requires being chained off a command that yields DOM
element(s).
