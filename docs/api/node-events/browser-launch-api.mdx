...
| Version                                  | Changes                                                                                          |
| ---------------------------------------- | ------------------------------------------------------------------------------------------------ |
| [4.0.0](/app/changelog#4-0-0) | New `options` object replaces old `args` as second argument to `before:browser:launch`           |
| [4.0.0](/app/changelog#4-0-0) | All Chromium-based browsers, including Electron, have `chromium` set as their `family` property. |
| [4.0.0](/app/changelog#4-0-0) | Added `channel` property to browser.                                                             |
