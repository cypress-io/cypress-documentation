...
Using the [setupNodeEvents](/app/tooling/plugins-guide#Using-a-plugin)
...
[Check out our example recipe showing how to download and validate CSV and Excel files.](/examples/recipes#Testing-the-DOM)
