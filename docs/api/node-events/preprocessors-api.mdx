...
The code contains comments that explain how it uses the preprocessor API.
...
Editing the options covers cases like:

- Adding your own Babel plugins
- Modifying options for TypeScript compilation
