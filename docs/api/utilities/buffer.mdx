...
### Loading binary data read from disk {#Loading-binary-data-read-from-disk}
...
### Using dynamic file contents with `.selectFile()` {#Using-dynamic-file-contents-with-selectFile}
