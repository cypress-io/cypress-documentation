...
### Image Fixture {#Image-Fixture}

#### Using an image fixture for jQuery plugin upload {#Using-an-image-fixture-for-jQuery-plugin-upload}
...
### Getting dataUrl string {#Getting-dataUrl-string}
