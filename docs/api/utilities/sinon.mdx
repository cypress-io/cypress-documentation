...
[matchers](https://sinonjs.org/concepts/matchers/) when doing assertions.
...
- [Spies, stubs & clocks](https://example.cypress.io/commands/spies-stubs-clocks)
  example page
- [Sinon matchers](https://sinonjs.org/concepts/matchers/) documentation
  page
- [Bundled Libraries](/app/references/bundled-libraries)
- [`cy.spy()`](/api/commands/spy)
- [`cy.stub()`](/api/commands/stub)
- [Stubs, Spies, and Clocks](/app/guides/stubs-spies-and-clocks) guide
