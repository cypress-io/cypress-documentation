...
| **Name:**        | `fail`                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Yields:**      | the error **(Object)**, Mocha runnable **(Object)**                                                                                                                                                                                                                                                                                                                                                          |
| **Description:** | Fires when the test has failed. Binding to this event without rethrowing the error will prevent the test from having a 'failed' state. Subsequent commands will not be executed. However this is **strongly discouraged**. Tests should never legitimately fail. This event exists because it's extremely useful for debugging purposes. See [Catching Test Failures](#Catching-Test-Failures) for examples. |
...
| **Description:** | Fires whenever a command emits this event so it can be displayed in the Command Log. Useful to see how internal cypress commands use the [Cypress.log()](/api/cypress-api/cypress-log) API. |

| Event            | Details                                                                                                                                                                                                                            |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Name:**        | `log:changed`                                                                                                                                                                                                                      |
| **Yields:**      | log attributes **(Object)**, log instance **(Object)**                                                                                                                                                                             |
| **Description:** | Fires whenever a command's attributes changes. This event is debounced to prevent it from firing too quickly and too often. Useful to see how internal cypress commands use the [Cypress.log()](/api/cypress-api/cypress-log) API. |
