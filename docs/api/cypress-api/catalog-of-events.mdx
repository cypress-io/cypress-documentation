...
| **Name:**        | `fail`                                                                                                                                                                                                                                                                                                                                           |
| **Yields:**      | the error **(Object)**, Mocha runnable **(Object)**                                                                                                                                                                                                                                                                                              |
| **Description:** | Fires when the test has failed. Binding to this event without rethrowing the error will prevent the test from having a 'failing' state. Subsequent commands will not be executed. However this is **strongly discouraged**. Tests should never legitimately fail. This event exists because it's extremely useful for debugging purposes. See our recipe [Handling errors](/examples/recipes#Fundamentals). |
