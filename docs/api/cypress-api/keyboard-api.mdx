...
### Slow down typing by increasing the keystroke delay {#Slow-down-typing-by-increasing-the-keystroke-delay}
...
### Remove the keystroke delay {#Remove-the-keystroke-delay}
...
### Where to put Keyboard configuration {#Where-to-put-Keyboard-configuration}

<SupportFileConfiguration />

### Set the keystroke delay in test configuration {#Set-the-keystroke-delay-in-test-configuration}
