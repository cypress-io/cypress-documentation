...
Cypress [12.17.4](/app/changelog#12-17-4) includes a Webpack upgrade (v4 to v5), which [tree shakes out](https://webpack.js.org/blog/2020-10-10-webpack-5-release/#inner-module-tree-shaking) any side-effects or files that _only_ include side-effects.
...
| Version                                    | Changes                      |
| ------------------------------------------ | ---------------------------- |
| [0.20.0](/app/changelog#0-20-0) | `Cypress.Commands` API added |
