...
The `selectorPriority` API is under active development and may change in future versions as we refine the best way to generate selectors within our products. Stay updated with our [changelog](/app/changelog) for any breaking changes.
...
| Version                                    | Changes                                                            |
| ------------------------------------------ | ------------------------------------------------------------------ |
| [15.0.0](/app/changelog#15-0-0) | Renamed `Cypress.SelectorPlayground` to `Cypress.ElementSelector`. |
