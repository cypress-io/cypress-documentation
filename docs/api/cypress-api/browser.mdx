...
### Log browser information {#Log-browser-information}

#### `Cypress.browser` returns browser object {#Cypressbrowser-returns-browser-object}
...
#### Check that Chrome specific styles are applied {#Check-that-Chrome-specific-styles-are-applied}
...
#### Screenshot only in headless browser {#Screenshot-only-in-headless-browser}
