...
| Version                                    | Changes                                                                                       |
| ------------------------------------------ | --------------------------------------------------------------------------------------------- |
| [11.0.0](/app/changelog#11-0-0) | Removed `preserveOnce` and `defaults`                                                         |
| [9.7.0](/app/changelog#9-7-0)   | Deprecated `preserveOnce` and `defaults`                                                      |
| [5.0.0](/app/changelog#5-0-0)   | Renamed `whitelist` option to `preserve`                                                      |
| [0.16.1](/app/changelog#0-16-1) | `{verbose: false}` option added                                                               |
| [0.16.0](/app/changelog#0-16-0) | Removed support for `Cypress.Cookies.get`, `Cypress.Cookies.set` and `Cypress.Cookies.remove` |
| [0.12.4](/app/changelog#0-12-4) | `Cypress.Cookies` API added                                                                   |
