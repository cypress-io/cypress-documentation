...
### Blackout elements before screenshot {#Blackout-elements-before-screenshot}
...
### Take a screenshot of the entire Cypress App {#Take-a-screenshot-of-the-entire-Cypress-App}
...
### Allow timers and animations to keep running {#Allow-timers-and-animations-to-keep-running}
...
### Disable screenshots on run failures {#Disable-screenshots-on-run-failures}
...
### Overwrite existing screenshots {#Overwrite-existing-screenshots}
...
### Scale `viewport` and `fullPage` captures {#Scale-viewport-and-fullPage-captures}
...
### Change the DOM using `onBeforeScreenshot` and `onAfterScreenshot` {#Change-the-DOM-using-onBeforeScreenshot-and-onAfterScreenshot}
...
### Get properties from the `onAfterScreenshot` callback {#Get-properties-from-the-onAfterScreenshot-callback}
...
#### Where to put screenshot configuration {#Where-to-put-screenshot-configuration}
