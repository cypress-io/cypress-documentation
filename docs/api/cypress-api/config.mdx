...
#### Get all configuration options from the [Cypress configuration](/guides/references/configuration) {#Get-all-configuration-options-from-the-Cypress-configuration}
...
#### Return a single configuration option from the [Cypress configuration](/guides/references/configuration) {#Return-a-single-configuration-option-from-the-Cypress-configuration}
...
#### Change the values of configuration options from the [Cypress configuration](/guides/references/configuration) from within your tests {#Change-the-values-of-configuration-options-from-the-Cypress-configuration-from-within-your-tests}
...
#### Override multiple options from the [Cypress configuration](/guides/references/configuration) by passing an object {#Override-multiple-options-from-the-Cypress-configuration-by-passing-an-object}
...
### Not all config values can be changed at all times {#Not-all-config-values-can-be-changed-at-all-times}
...
### Test Configuration vs `Cypress.config()` {#Test-Configuration-vs-Cypressconfig}
...
### `Cypress.config()` executes Synchronously {#Cypressconfig-executes-Synchronously}
...
### Why is it `Cypress.config` and not `cy.config`? {#Why-is-it-Cypressconfig-and-not-cyconfig}
