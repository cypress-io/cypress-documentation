...
2. **Configurable Thresholds:** Auto Cancellation triggers on failure thresholds you define. `Cypress.stop` executes immediately when the specified condition is met.
