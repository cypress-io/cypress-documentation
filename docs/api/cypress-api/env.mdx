...
The [Environment Variable](/app/guide/environment-variables) guide explains
...
However,
[it is possible to set Cypress environment variables from OS-level environment variables](/app/guide/environment-variables#Option-3-CYPRESS_).
...
The [Environment Variables](/app/guide/environment-variables) guide explains
common use cases.
...
- The [Environment Variable](/app/guide/environment-variables) guide
