...
`Cypress.env()` has been deprecated in Cypress `15.9.0` and will be removed in a future major version.

Cypress recommends migrating to using [`cy.env()`](/api/commands/env) instead.

Please see the [Migration Guide](/app/guides/migration/cypress-env-to-cy-env) for more information.
...
| Version                                    | Changes                        |
| ------------------------------------------ | ------------------------------ |
| [15.9.0](/app/references/changelog#15-9-0) | `Cypress.env()` API deprecated |
...
- [Migration Guide to `cy.env()`](/app/guides/migration/cypress-env-to-cy-env)
