...
However,
it is possible to set Cypress environment variables from OS-level environment variables. See the [Environment Variables & Secrets](/app/guides/environment-variables) guide for more details.
