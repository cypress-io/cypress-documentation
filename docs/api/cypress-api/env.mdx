...
The [Environment Variable](/app/guides/environment-variables) guide explains
...
However,
[it is possible to set Cypress environment variables from OS-level environment variables](/app/guides/environment-variables#Option-3-CYPRESS_).
...
that's been
[dynamically set in a plugin](/app/tooling/plugins-guide).
...
The [Environment Variables](/app/guides/environment-variables) guide explains
common use cases.
...
- The [Environment Variable](/app/guides/environment-variables) guide
