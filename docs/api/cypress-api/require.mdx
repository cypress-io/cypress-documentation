...
| Version                                      | Changes                                                                                             |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| [12.6.0](/app/changelog#12-6-0)   | `Cypress.require` added and support for using CommonJS `require()` and ES module `import()` removed |
| [10.11.0](/app/changelog#10-11-0) | `Cypress.require` removed in favor of CommonJS `require()` and ES module `import()`                 |
| [10.7.0](/app/changelog#10-7-0)   | `Cypress.require` added                                                                             |
