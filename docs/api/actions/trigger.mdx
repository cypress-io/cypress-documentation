...
[Check out our example recipe triggering mouse and drag events to test drag and drop](/examples/recipes#Testing-the-DOM)
...
- `.trigger()` will automatically [retry](/guides/core-concepts/retry-ability)
