...
title: Assertions
sidebar_position: 10
slug: /api/assertions/assertions
---


Cypress bundles the popular [Chai](/api/assertions#Chai) assertion
library, as well as helpful extensions for
[Sinon](/api/assertions#Sinon-Chai) and
[jQuery](/api/assertions#Chai-jQuery), bringing you dozens of
