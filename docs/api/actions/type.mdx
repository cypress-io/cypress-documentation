...
### Yields [<Icon name="question-circle"/>](/app/core-concepts/introduction-to-cypress#Subject-Management)
...
[Check out our example recipe of logging in by typing username and password in HTML web forms](/examples/recipes#Logging-In)
...
### Requirements [<Icon name="question-circle"/>](/app/core-concepts/introduction-to-cypress#Chains-of-Commands)

- `.type()` requires being chained off a command that yields DOM element(s).

### Assertions [<Icon name="question-circle"/>](/app/core-concepts/introduction-to-cypress#Assertions)
...
### Timeouts [<Icon name="question-circle"/>](/app/core-concepts/introduction-to-cypress#Timeouts)
