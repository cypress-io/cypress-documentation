...
| `force`                      | `false`                                                                        | Forces the action, disables [waiting for actionability](#Assertions-Icon-namequestion-circle)                                                      |
...
- `.type()` will automatically [retry](/guides/core-concepts/retry-ability)
