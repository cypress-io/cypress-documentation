...
<a href="/app/plugins/plugins-list#custom-commands">Command Plugins</a> which you can install or download.
...
details, see the [Plugins Guide](/app/plugins/plugins-guide) and
