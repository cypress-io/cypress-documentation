...
The Plugins API allows you to hook into and extend Cypress behavior. For more details, see the [Plugins Guide](/guides/tooling/plugins-guide) and [Writing a Plugin](/api/plugins/writing-a-plugin).
