...
[Introduction to Chaining Commands and Subjects](/app/core-concepts/introduction-to-cypress#Chaining-commands-and-subjects).
...
| [`.end()`](/api/commands/end) <Badge type="caution">deprecated</Badge> | Explicitly end a chain of Cypress commands.                                                                                                                                     |
