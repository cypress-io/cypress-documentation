---
title: Integrate Microsoft Teams with Cypress Cloud
...
The Microsoft Teams integration posts your Cypress test results directly in your
...
To enable the Cypress integration for Microsoft Teams, you must be an
...
3. Visit the selected organization's **Integrations** page via the side
   ...
   <DocsImage
     src="/img/cloud/organizations/navigate-to-organization-integrations.png"
