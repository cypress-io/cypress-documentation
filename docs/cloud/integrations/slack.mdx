---
title: Integrate Slack with Cypress Cloud
...
The Cypress integration for Slack:

- Improves cross-team collaboration by instantly surfacing Cypress results to the teams that need visibility
- Confirms that key tests pass prior to launching new products or features
- Reduces the time it takes to catch failed tests
- Surfaces flaky tests as they appear, even on passing runs
...
3. You'll see a popup window for choosing the channel or individual to associate with the organization.
...
1. Navigate to the **Slack** configuration page.
2. Click **Add Slack Channel**.
3. You'll see a popup window for choosing the channel or individual to associate
...
certain channel, you can **Mute** that channel. Muting pauses and resumes
notifications for a specific channel without losing the configuration you've put
in place.
...
Review our [Privacy Policy](https://on.cypress.io/privacy-policy?utm_source=docs.cypress.io&utm_medium=slack-integration) for information about how the Cypress app for Slack collects and
