...
1. Click the "Get it Now" button on the
   ...
   <DocsImage
     src="/img/app/cloud/integrations/jira/dashboard-jira-atlassian-get-it-now.png"
     alt="Atlassian Marketplace Cypress for Jira"
   />
1. Login to Jira, Choose a site to install your app and click "Install app".
   <DocsImage
     src="/img/app/cloud/integrations/jira/dashboard-jira-atlassian-choose-site.png"
...
1. On the "Add to Jira" screen, confirm installation by clicking "Get it now"
   <DocsImage
     src="/img/app/cloud/integrations/jira/dashboard-jira-atlassian-confirm-install.png"
...
1. Once installed, click the `Get Started` link in the notification.
   <DocsImage
     src="/img/app/cloud/integrations/jira/dashboard-jira-atlassian-success.png"
...
1. On the next page, click the `Click to Finish Installation` button to be
   ...
   <DocsImage
     src="/img/app/cloud/integrations/jira/dashboard-jira-atlassian-finish-install-step.png"
...
1. Once redirected to [Cypress Cloud](https://cloud.cypress.io/), select the
   ...
   <DocsImage
     src="/img/app/cloud/integrations/jira/dashboard-jira-integration-choose-cypress-org.png"
...
1. The Jira Integration is complete. A list of projects permitted is provided on
   ...
   <DocsImage
     src="/img/app/cloud/integrations/jira/dashboard-jira-integration-completed.png"
...
2. Click on the "Create Issue" button within the results panel, which will
   ...
   <DocsImage
     src="/img/app/cloud/integrations/jira/dashboard-jira-integration-create-issue.png"
...
3. Complete and submit the Jira issue creation form by selecting the Jira
   ...
   <DocsImage
     src="/img/app/cloud/integrations/jira/dashboard-jira-integration-modal.png"
...
4. Once the issue is created, a log and reference of the issue will appear
   ...
   <DocsImage
     src="/img/app/cloud/integrations/jira/dashboard-jira-integration-inline-issue.png"
...
<DocsImage
  src="/img/app/cloud/integrations/jira/dashboard-jira-integration-jira-issue.png"
