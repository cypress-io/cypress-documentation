---
title: Integrate GitLab with Cypress Cloud
...
make sure the git information is being sent properly by following
[these guidelines](/app/continuous-integration/overview#Git-information).
If you still face issues after this,
...
[Business and Enterprise paid pricing plans](https://www.cypress.io/pricing?utm_source=docs.cypress.io&utm_medium=gitlab-integration).
...
[Team, Business and Enterprise paid pricing plans](https://www.cypress.io/pricing?utm_source=docs.cypress.io&utm_medium=gitlab-integration).
