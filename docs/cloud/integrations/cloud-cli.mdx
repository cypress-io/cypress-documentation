...
- `--limit` sets how many items to return per page. The default is 30 and the maximum is 100; larger values are capped at 100.
...
| Goal                                                  | Command                                                                                                  |
| ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| The first 5 runs for a project                        | `cy-cloud run list --projectId <projectId> --limit 5`                                                    |
