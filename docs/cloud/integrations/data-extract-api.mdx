...
All of the data that is viewable in [Enterprise Reporting ](/app/cloud/analytics/enterprise-reporting)
...
<DocsImage
  src="/img/app/cloud/analytics/enterprise-reporting-jwt.png"
