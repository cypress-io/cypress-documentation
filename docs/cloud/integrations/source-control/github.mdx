...
[set up to record](/app/cloud/account-management/projects) to Cypress Cloud
to use GitHub integration.

<DocsImage
  src="/img/app/cloud/integrations/github/pull-request-cypress-integration-comments-github-checks.jpg"
...
[these guidelines](/app/continuous-integration/introduction#Git-information).
...
2. Select the organization you wish to integrate with a GitHub account or GitHub
   ...
   <DocsImage
     src="/img/app/cloud/organizations/select-cypress-organization.jpg"
...
3. Visit the selected organization's **Integrations** page via the side
   ...
   <DocsImage
     src="/img/app/cloud/organizations/navigate-to-organization-integrations.jpg"
...
2. Select the project you wish to integrate with a GitHub repository.
   ...
   <DocsImage
     src="/img/app/cloud/projects/select-cypress-project.jpg"
...
3. Go to the project's settings page.
   ...
   <DocsImage
     src="/img/app/cloud/projects/select-project-settings.jpg"
...
5. Click the **Enable GitHub** button.
   ...
   <DocsImage
     src="/img/app/cloud/integrations/github/enable-github.jpg"
     alt="Enable GitHub"
   />
...
1. Select the desired GitHub organization or account to integrate with your
   ...
   <DocsImage
     src="/img/app/cloud/integrations/github/select-gh-org.jpg"
...
<DocsImage
  src="/img/app/cloud/integrations/github/select-gh-repos.jpg"
...
<DocsImage
  src="/img/app/cloud/integrations/github/ghe/ghe-01.jpg"
...
<DocsImage
  src="/img/app/cloud/integrations/github/ghe/ghe-02.jpg"
...
<DocsImage
  src="/img/app/cloud/integrations/github/ghe/ghe-03.jpg"
...
<DocsImage
  src="/img/app/cloud/integrations/github/ghe/ghe-04-commit.jpg"
  alt="Configure app permissions"
  width={650}
/>
<DocsImage
  src="/img/app/cloud/integrations/github/ghe/ghe-04-pr.jpg"
  alt="Configure app permissions"
  width={650}
/>
...
<DocsImage
  src="/img/app/cloud/integrations/github/ghe/ghe-05.jpg"
  alt="Collect new app info"
  width={700}
/>

<DocsImage
  src="/img/app/cloud/integrations/github/ghe/ghe-06.jpg"
  alt="Generate client secret"
  width={680}
/>

<DocsImage
  src="/img/app/cloud/integrations/github/ghe/ghe-07.jpg"
  width={645}
...
<DocsImage
  src="/img/app/cloud/integrations/github/ghe/ghe-08.jpg"
  width={700}
...
<DocsImage
  src="/img/app/cloud/integrations/github/ghe/ghe-09.jpg"
  width={700}
...
<DocsImage
  src="/img/app/cloud/integrations/github/ghe/ghe-10.jpg"
...
<DocsImage
  src="/img/app/cloud/integrations/github/org-settings-with-no-enabled-projects.jpg"
...
<DocsImage
  src="/img/app/cloud/integrations/github/project-settings-repo-selection.jpg"
...
<DocsImage
  src="/img/app/cloud/integrations/github/project-settings-selected-repo.jpg"
...
<DocsImage
  src="/img/app/cloud/integrations/github/org-settings-with-projects.jpg"
...
- **One check per
  [run group](/app/cloud/smart-orchestration/parallelization#Grouping-test-runs).**

  <DocsImage
    src="/img/app/cloud/integrations/github/status-checks-per-group.jpg"
...
<DocsImage
  src="/img/app/cloud/integrations/github/cloud-details-specs-tab.jpg"
...
<DocsImage
  src="/img/app/cloud/integrations/github/status-check-settings.jpg"
...
- **Run context details:**
  ...
  - A link to the corresponding [Branch Review](../../branch-review)
...
<DocsImage
  src="/img/app/cloud/integrations/github/pr-comments-settings.jpg"
  alt="Status checks settings"
/>
