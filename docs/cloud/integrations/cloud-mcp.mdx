...
For a deeper exploration of working with Cloud MCP's UI Coverage tools, read our guide [UI Coverage - Work with AI agents](/ui-coverage/work-with-ai-agents).
...
- [UI Coverage - Work with AI agents](/ui-coverage/work-with-ai-agents)
