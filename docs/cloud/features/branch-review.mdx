...
- **Confirm coverage moved in the right direction.** See tests that were added or modified, and (if enabled) how [UI Coverage](https://on.cypress.io/ui-coverage-trial?utm_medium=cloud-br&utm_source=docs.cypress.io&utm_term=&utm_content=UI+Coverage) and [Cypress Accessibility](http://on.cypress.io/accessibility-trial?utm_medium=cloud-br&utm_source=docs.cypress.io&utm_term=&utm_content=Cypress+Accessibility) shifted between the two branches.
...
Cypress Branch Review surfaces all of these impacts a Pull Request might have on your test suite in one place.
...
Branch Review is valuable even if you do not have a Pull Request workflow, because it allows you to compare any two runs of your choice.
...
1. **Open Branch Review for the PR.** From the Cypress comment on the Pull Request, click **"View all changes introduced in this branch"** to land in Branch Review with the PR's latest run pre-selected as the Changed run.
...
| 3   | [UI Coverage](https://on.cypress.io/ui-coverage-trial?utm_medium=cloud-br&utm_source=docs.cypress.io&utm_term=&utm_content=UI+Coverage) changes.                      |
| 4   | [Cypress Accessibility](http://on.cypress.io/accessibility-trial?utm_medium=cloud-br&utm_source=docs.cypress.io&utm_term=&utm_content=Cypress+Accessibility) changes. |
