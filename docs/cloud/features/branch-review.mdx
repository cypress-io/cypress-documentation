...
Clicking the branch label will link you directly to the appropriate [run overview](/cloud/features/recorded-runs#Run-Details) and hovering on these elements exposes additional run meta data.
