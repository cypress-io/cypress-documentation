...
Attempts are 1-indexed to match the dashboard, and the commands default to the
last (most recent) attempt when you omit `--attempt`. The CLI reads the same
