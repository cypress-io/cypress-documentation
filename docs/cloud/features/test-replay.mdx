...
To turn redaction off, open project settings in Cypress Cloud and look in the **Test Replay** section. Turn off **Prevent capturing sensitive network data**.
...
For the full list of what is redacted, see [Network data redaction](/cloud/account-management/data-storage-and-masking#Network-data-redaction).
...
- [Data storage and controls](/cloud/account-management/data-storage-and-masking#Network-data-redaction) - network redaction and other data controls
