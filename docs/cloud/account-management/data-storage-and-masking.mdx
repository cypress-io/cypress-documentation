...
For details, see [`cy.prompt` sensitive data handling](/app/guides/cy-prompt#Sensitive-data-handling) and [Studio AI sensitive data handling](/app/guides/cypress-studio#Sensitive-data-handling).
