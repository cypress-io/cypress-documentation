...
Redaction can be toggled per project, if you don't want or need the data.

- In Cypress Cloud, open your project settings.
- Go to the Test Replay section.
- Turn off redaction.
