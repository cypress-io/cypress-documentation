...
Please refer to the [Cypress Cloud Terms of Use](https://cypress.io/terms-of-use) and our [Security & Compliance](https://on.cypress.io/security/?utm_source=docs.cypress.io&utm_medium=data-storage-and-masking) guide for more specifics around reasonable use of Cypress Cloud, data storage and security at Cypress.
...
If you'd like more granular control over what data is sent to Cypress Cloud, please [contact us](https://www.cypress.io/contact/?utm_source=docs.cypress.io&utm_medium=data-storage-and-masking) to discuss your needs.
