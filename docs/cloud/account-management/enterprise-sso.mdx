---
title: 'Single sign-on (SSO) in Cypress Cloud'
...
- A Cypress Cloud account on the **Business** or **Enterprise** plan. See
  [pricing](https://www.cypress.io/pricing?utm_source=docs.cypress.io&utm_medium=enterprise-sso).
...
For Smart Card implementation, reach out to
