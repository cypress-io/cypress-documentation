...
- **Usage insight by team.** Because access is organized by team, you can understand how
  ...
  [Enterprise Reporting](/cloud/features/analytics/enterprise-reporting) — useful for
  chargebacks, capacity planning, and measuring adoption.
...
operates — enough separation to stay focused and secure, without so much granularity that
upkeep becomes a burden. Separating project access between multiple teams in Cypress Cloud
