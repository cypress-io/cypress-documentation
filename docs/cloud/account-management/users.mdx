...
1. Select the [organization](/app/cloud/account-management/organizations) you
...
<DocsImage
  src="/img/app/cloud/users/invite-user-dialog.jpg"
...
Refer to our
[Enterprise SSO Guide](/app/cloud/account-management/enterprise-sso).
...
<DocsImage
  src="/img/app/cloud/users/request-access-to-organization.png"
