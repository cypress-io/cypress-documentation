...
From the **Usage notification** card, click **Create notification** and choose the threshold that triggers the email:
...
The billing email address is where invoices and billing-related notifications
are sent. An **Owner** or **Admin** can update it from the **Billing & Usage**
page within [Cypress Cloud](https://on.cypress.io/cloud), or by contacting
[billing@cypress.io](mailto:billing@cypress.io) directly.

To update other billing details, such as your billing address or payment
information, contact [billing@cypress.io](mailto:billing@cypress.io).
