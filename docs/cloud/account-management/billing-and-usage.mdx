...
Use the **Contact us** button to reach the Cypress team about upgrading, changing, or asking questions about your plan.
...
<DocsImage
  src="/img/cloud/billing/billing-and-usage-prompt-info.png"
...
- **Custom** — notify at a number you set, which is useful for getting an earlier heads-up (for example, at 80% of your allowance) while you still have room to act.
...
- **Credit card** — the card displays the type, last four digits, and expiration. Click **Change** to update the card on file, for example when it expires or you switch to a corporate card.
