...
<DocsImage
  src="/img/app/cloud/billing/billing-and-usage-results.jpg"
...
2. Go the [Organizations page](https://on.cypress.io/dashboard/organizations) to
   ...
   <DocsImage
     src="/img/app/cloud/organizations/oss-plan-2-select-org.jpg"
...
3. Go to the **Billing & Usage** page, click **Upgrade** and then click on the
   **Apply for an open source plan** link at the bottom of the page. _Note:
   ...
   <DocsImage
     src="/img/app/cloud/organizations/oss-plan-3-billing.jpg"
     alt="Upgrade Plan"
   />
...
4. Fill in and submit the OSS plan request form.
   ...
   <DocsImage
     src="/img/app/cloud/organizations/oss-plan-5-billing.jpg"
