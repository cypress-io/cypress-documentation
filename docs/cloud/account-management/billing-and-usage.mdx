...
Reviewing usage here lets you [upgrade](https://www.cypress.io/pricing?utm_source=docs.cypress.io&utm_medium=billing-and-usage) ahead of time and avoid any interruption.

### Usage over time

Click the **Usage details** button to view graphs of your test results usage.
...
Click the **Usage details** button to view graphs of your cy.prompt AI usage.
...
- Record minimum of 500
  ...
  with the [Starter Plan](https://www.cypress.io/pricing?utm_source=docs.cypress.io&utm_medium=billing-and-usage)
...
If you have any questions regarding the OSS plan, feel free to
...
- [Cypress Cloud pricing](https://www.cypress.io/pricing?utm_source=docs.cypress.io&utm_medium=billing-and-usage)
