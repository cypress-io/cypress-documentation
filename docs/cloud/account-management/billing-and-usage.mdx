...
Your plan meters two things that matter day to day: how many **test results** you can record each month, and the limits on **AI** capabilities. Watching both here keeps the value of Cloud flowing without surprises.
