...
[Continuous Integration](/app/continuous-integration/introduction), but you
can also record your tests when running locally.

:::tip

<Icon name="check-circle" color="green" /> Make sure to [install](/app/getting-started/installing-cypress)
and [open](/app/getting-started/opening-the-app) the Cypress app to get started recording!
...
1. Click on the **Runs** tab of your project within
   [Cypress](/app/core-concepts/cypress-app).
...
3. You will need to log in to record your tests, so you'll be prompted to log in
   ...
   <DocsImage
     src="/img/app/cloud/projects/setup-a-project-1.jpg"
...
4. Choose who owns the project. You can personally own it or select an
   ...
   **Manage organizations**. Organizations work just like they do in GitHub and
   ...
   [Read more about organizations](/app/cloud/account-management/organizations).
   <DocsImage
     src="/img/app/cloud/projects/setup-a-project-2.jpg"
...
5. If you don't have any existing projects, you'll have the opportunity to
   ...
   - Choose whether this project is Public or Private. See more about
     [Public-vs-Private project settings](/app/cloud/account-management/projects#Public-vs-Private).
     <DocsImage
       src="/img/app/cloud/projects/setup-a-project-3.jpg"
...
6. Alternatively, if you've already created a project in Cypress Cloud, you can
   ...
   <DocsImage
     src="/img/app/cloud/projects/setup-a-project-4.jpg"
...
8. Now you should see a view explaining how to record your first run with your
   record key.
   <DocsImage
     src="/img/app/cloud/projects/setup-a-project-5.jpg"
     alt="Record Instructions"
   />
9. After setting up your project, Cypress inserts a unique
   [projectId](/app/cloud/account-management/projects#Project-ID) into your Cypress configuration file. If you're
   using source control, we recommend that you check your configuration file,
   including the `projectId`, into source control.
10. Within [Continuous Integration](/app/continuous-integration/introduction)
    or from your local computer's terminal, pass the displayed
    [Record Key](/app/cloud/account-management/projects#Record-key) while running the
    [cypress run](/app/guides/command-line#cypress-run) command.
...
<DocsImage
  src="/img/app/cloud/projects/cloud-runs-list.jpg"
  alt="Cloud Screenshot"
/>

<DocsImage
  src="/img/app/cloud/projects/runs-list-in-desktop-gui.jpg"
  alt="Runs List"
/>
