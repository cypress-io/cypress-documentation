...
By enabling [test retries](/app/guide/test-retries), Cypress Cloud can
...
[retry failed tests](/app/guide/test-retries#Configure-Test-Retries) to
...
[test retries](/app/guide/test-retries#Configure-Test-Retries) is required**
...
<DocsImage
  src="/img/app/cloud/flaky-test-management/flaky-runs-view.png"
...
<DocsImage
  src="/img/app/cloud/flaky-test-management/flake-analytics.png"
...
<DocsImage
  src="/img/app/cloud/flaky-test-management/flake-panel.png"
...
<DocsImage
  src="/img/app/cloud/flaky-test-management/flake-v-fail-2.png"
...
<DocsImage
  src="/img/app/cloud/flaky-test-management/flake-v-fail-1.png"
  alt="flake rate vs fail rate"
/>
...
Cypress Cloud can provide alerts via source control ([GitHub](/app/cloud/integrations/source-control/github), [GitLab](/app/cloud/integrations/source-control/gitlab), [BitBucket](/app/cloud/integrations/source-control/bitbucket)), [Slack](/app/cloud/integrations/slack), and [Microsoft Teams](/app/cloud/integrations/teams) integrations to further assist with
...
<DocsImage
  src="/img/app/cloud/flaky-test-management/gh-flake.png"
...
<DocsImage
  src="/img/app/cloud/flaky-test-management/flake-pr-comment.png"
...
<DocsImage
  src="/img/app/cloud/flaky-test-management/slack-flake.png"
...
<DocsImage
  src="/img/app/cloud/flaky-test-management/flake-slack-alert.png"
