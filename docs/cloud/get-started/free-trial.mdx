...
[Key Differences](/app/get-started/key-differences) which will help you on your journey
of [getting started](/app/get-started/installing-cypress) with Cypress. You can then write
