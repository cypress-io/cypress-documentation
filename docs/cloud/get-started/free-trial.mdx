...
With a Cloud account, you also get **Studio AI** (AI-powered assertion recommendations as you record) and [cy.prompt()](/api/commands/prompt) for natural-language test generation. See [AI at Cypress](/cloud/features/ai-at-cypress) for more details.
