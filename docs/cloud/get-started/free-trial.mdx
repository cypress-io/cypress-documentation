...
The Starter plan keeps you running with a smaller feature set: data retention is limited to 30 days, test results to 500 per monthly period, and your organization to 10 [users](/cloud/account-management/users). You can compare every plan side by side on the [pricing page](https://www.cypress.io/pricing?utm_source=docs.cypress.io&utm_medium=free-trial).
...
all Cloud features right away, [contact us](mailto:support@cypress.io).
