...
<Icon name="check-circle" color="green" /> Make sure to [install](/app/get-started/installing-cypress)
and [open](/app/get-started/opening-the-app) the Cypress app to get started recording!
...
<DocsImage
  src="/img/cloud/projects/cloud-runs-list.jpg"
