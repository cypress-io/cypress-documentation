...
<Btn label="Sign up ➜" variant="purple-dark" href="https://cloud.cypress.io/signup"/>
<Btn label="See a demo" icon="action-play-small" href="https://www.youtube.com/watch?v=vFLShoCM8pA" />
<Btn label=" Explore an example project" icon="cypress-accessibility-outline" href="https://cloud.cypress.io/projects/7s5okt" />
