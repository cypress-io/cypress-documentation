...
to switch tools. This provides notifications about new failing tests in CI, which you can then
re-run them immediately in your local environment to debug.

<DocsImage src="/img/app/core-concepts/open-mode/debug-page.png" alt="Debug page showing test results and failure details in the Cypress App" />
