...
groups starting at slightly different times can still join the same run — useful
for [parallelized](/cloud/features/smart-orchestration/parallelization) setups.
