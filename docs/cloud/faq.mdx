...
configure in [Project Settings](/cloud/account-management/projects#Project-settings).
...
Test Replay leverages [Chrome DevTools Protocol(CDP)](https://chromedevtools.github.io/devtools-protocol/), so currently supports Chromium-based browsers (Chrome and Edge) only.
