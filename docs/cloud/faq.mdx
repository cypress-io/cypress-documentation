...
Set the `CYPRESS_CLOUD_TOKEN` environment variable to a personal access token.
...
Both give programmatic access to your Cypress Cloud data. [Cloud MCP](/cloud/integrations/cloud-mcp)
is a remote server your AI client connects to, and the agent selects Cypress
tools automatically, which suits conversational, in-editor debugging. The
