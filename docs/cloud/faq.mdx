...
Your usage cycle resets each month, at which point your recorded
[test result](#What-counts-as-a-test-result) and AI usage counters return to
zero for the new period. You can confirm the dates of your current period on
your organization's
[Billing & Usage](/cloud/account-management/billing-and-usage) page.
