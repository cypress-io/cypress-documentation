...
### <Icon name="angle-right" /> How do I mask passwords and sensitive data in screenshots and videos?
...
[remove the Cypress Command Log from
...
It depends on your project's visibility and which teams have access to the
project. In a
...
organization can see its runs, screenshots, videos, and any captured data. You
can narrow this further with [teams](/cloud/account-management/teams), so that
only the users on the teams assigned to a project can see it, rather than
everyone in the organization. In a public project, anyone who knows your
`projectId` can view the recorded runs. You can change a project's visibility at
any time in [project settings](/cloud/account-management/projects#Public-vs-Private).
