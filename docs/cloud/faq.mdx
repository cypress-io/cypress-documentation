...
per hour, and the same limit applies across all plans (some organizations have a
higher limit configured). Telemetry does not count toward the limit. Contact
