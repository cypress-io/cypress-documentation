...
### 3. Form submission and XHRs {#3-Form-submission-and-XHRs}
...
### 4. Loading data with fixtures {#4-Loading-data-with-fixtures}
...
### 5. Todo item behavior {#5-Todo-item-behavior}
...
### 6. Toggling and debugging {#6-Toggling-and-debugging}
...
### 7. Filters and data-driven tests {#7-Filters-and-data-driven-tests}
...
### 8. Full end-to-end tests part 1 {#8-Full-end-to-end-tests-part-1}
...
### 9. Full end-to-end tests part 2 {#9-Full-end-to-end-tests-part-2}
