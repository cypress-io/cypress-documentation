...
[Cypress](/app/core-concepts/open-mode) is a free, downloadable and open
...
{/* prettier-ignore */}
Yes. You can customize how specs are processed by using one of our [preprocessor plugins](/app/plugins/plugins-list#preprocessors)
