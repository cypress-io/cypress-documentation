...
### <Icon name="angle-right" /> What is test isolation in Cypress?
...
the test that ran before it. Learn more in the
[Test Isolation guide](/app/core-concepts/test-isolation).

### <Icon name="angle-right" /> Does test isolation prevent flaky tests?
...
### <Icon name="angle-right" /> Is test isolation enabled by default?
...
### <Icon name="angle-right" /> Can I disable test isolation?
...
### <Icon name="angle-right" /> Can I set test isolation on an individual test?
...
### <Icon name="angle-right" /> What values does the `testIsolation` option accept?

Only the boolean values `true` or `false`. It defaults to `true`, and any other
value is invalid and will be rejected by Cypress.

### <Icon name="angle-right" /> Is test isolation available in component testing?
