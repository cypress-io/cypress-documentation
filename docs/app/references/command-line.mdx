...
| Version                                      | Changes                                                               |
| -------------------------------------------- | --------------------------------------------------------------------- |
| [15.11.0](/app/changelog#15-11-0) | Added `--pass-with-no-tests` flag to `cypress run`                    |
| [15.5.0](/app/changelog#15-5-0)   | Added the 112 exit code scenario when using `--posix-exit-codes` flag |
| [15.4.0](/app/changelog#15-4-0)   | Added `--auto-cancel-after-failures` flag to `cypress run`            |
| [5.4.0](/app/changelog)           | Added `prune` subcommand to `cypress cache`                           |
| [5.4.0](/app/changelog)           | Added `--size` flag to `cypress cache list` subcommand                |
| [4.9.0](/app/changelog)           | Added `--quiet` flag to `cypress run`                                 |
