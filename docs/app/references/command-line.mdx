...
Below is the list of the commands `cypress tap` exposes. To learn more about these commands and how to use them, review our [guide to driving Cypress with AI agents](/app/tooling/cypress-tap).
...
| ------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`instances`](/app/tooling/cypress-tap#cypress-tap-instances) | Lists the running Cypress sessions the CLI can reach.                                                                                                                                          |
