...
The bundled `electron` browser is
[deprecated](/app/references/migration-guide#Migrating-away-from-the-Electron-browser)
as of Cypress 16.0 and will be removed in a future major version. Pass an
installed browser such as `--browser chrome` instead.
