...
<strong>disallowCypressEnv</strong>

Starting with Cypress `15.9.0`, users are unable to override test/suite environent variables when the [`disallowCypressEnv`](/app/references/configuration#Global) option is set to `true`.
