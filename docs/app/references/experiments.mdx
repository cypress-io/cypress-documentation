...
**Note:** The fast visibility algorithm may have different behavior in some edge cases compared to the legacy algorithm. If you encounter issues, you can disable this option to revert to the legacy behavior. For detailed migration information and behavior differences, see the [Cypress repository](https://github.com/cypress-io/cypress).
