...
| Version                                      | Changes                                                                                                                                       |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| [16.0.0](/app/references/changelog#16-0-0)   | Removed `experimentalFastVisibility`. The modern visibility algorithm is now the default; use [`visibilityStrategy`](/app/references/configuration#Actionability) to opt back into the legacy algorithm. |
