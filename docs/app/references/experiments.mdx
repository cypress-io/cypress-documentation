...
| Version                                      | Changes                                                                                                                                       |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| [15.9.0](/app/changelog#15-9-0)   | Added component testing support for `experimentalRunAllSpecs`.                                                                                |
| [15.8.0](/app/changelog#15-8-0)   | Added support for `experimentalFastVisibility` experiment.                                                                                    |
| [15.4.0](/app/changelog)          | Removed `experimentalStudio`. Cypress Studio is available as default behavior.                                                                |
| [14.0.0](/app/changelog#14-0-0)   | Removed `experimentalJustInTimeCompile` and `experimentalSkipDomainInjection` and made it default behavior.                                   |
| [13.14.0](/app/changelog#13-14-0) | Added support for configuring the Experimental Just-In-Time (JIT) Compiling for component testing via `experimentalJustInTimeCompile`.        |
...
| [12.6.0](/app/changelog#12-6-0)   | Removed `require`/`import` and added `Cypress.require` for `experimentalOriginDependencies`.                                                  |
| [12.4.0](/app/changelog#12-4-0)   | Added `experimentalSkipDomainInjection` and `experimentalMemoryManagement`.                                                                   |
| [12.0.0](/app/changelog#12-0-0)   | Removed `experimentalSessionAndOrigin` and made it the default behavior. Added `experimentalOriginDependencies`.                              |
| [11.2.0](/app/changelog#11-2-0)   | Added `experimentalRunAllSpecs`.                                                                                                              |
| [10.8.0](/app/changelog#10-8-0)   | Added `experimentalWebKitSupport`.                                                                                                            |
| [10.6.0](/app/changelog#10-6-0)   | Added support for `experimentalSingleTabRunMode`.                                                                                             |
| [10.4.0](/app/changelog#10-4-0)   | Added support for `experimentalModifyObstructiveThirdPartyCode`.                                                                              |
| [9.6.0](/app/changelog#9-6-0)     | Added support for `experimentalSessionAndOrigin` and removed `experimentalSessionSupport`.                                                    |
| [8.2.0](/app/changelog#8-2-0)     | Added support for `experimentalSessionSupport`.                                                                                               |
| [7.1.0](/app/changelog#7-1-0)     | Added support for `experimentalInteractiveRunEvents`.                                                                                         |
| [7.0.0](/app/changelog#7-0-0)     | Removed `experimentalComponentTesting` and made it the default behavior.                                                                      |
| [6.7.0](/app/changelog#6-7-0)     | Removed `experimentalRunEvents` and made it the default behavior.                                                                             |
| [6.3.0](/app/changelog#6-3-0)     | Added support for `experimentalStudio`.                                                                                                       |
| [6.2.0](/app/changelog#6-2-0)     | Added support for `experimentalRunEvents`.                                                                                                    |
| [6.0.0](/app/changelog#6-0-0)     | Removed `experimentalNetworkStubbing` and made it the default behavior when using [cy.intercept()](/api/commands/intercept).                  |
| [6.0.0](/app/changelog#6-0-0)     | Deprecated `experimentalFetchPolyfill`.                                                                                                       |
| [5.2.0](/app/changelog#5-2-0)     | Removed `experimentalShadowDomSupport` and made it the default behavior.                                                                      |
| [5.1.0](/app/changelog#5-1-0)     | Added support for `experimentalNetworkStubbing`.                                                                                              |
| [5.0.0](/app/changelog#5-0-0)     | Removed `experimentalGetCookiesSameSite` and made it the default behavior.                                                                    |
| [4.9.0](/app/changelog#4-9-0)     | Added support for `experimentalFetchPolyfill`.                                                                                                |
| [4.8.0](/app/changelog#4-8-0)     | Added support for `experimentalShadowDomSupport`.                                                                                             |
| [4.6.0](/app/changelog#4-6-0)     | Added support for `experimentalSourceRewriting`.                                                                                              |
| [4.5.0](/app/changelog#4-5-0)     | Added support for `experimentalComponentTesting`.                                                                                             |
| [4.3.0](/app/changelog#4-3-0)     | Added support for `experimentalGetCookiesSameSite`.                                                                                           |
