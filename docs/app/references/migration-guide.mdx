...
<Icon name="exclamation-triangle" /> If `injectDocumentDomain` is enabled, Cypress
will warn that this option is deprecated.

<Icon name="exclamation-triangle" /> `injectDocumentDomain` will be removed in Cypress
15.

<Icon name="exclamation-triangle" /> Enabling `injectDocumentDomain` may cause certain
...
this `injectDocumentDomain` must be enabled.
