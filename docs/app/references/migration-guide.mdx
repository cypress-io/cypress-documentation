...
Starting in Cypress 14, Cypress will officially support the latest two major versions of Chrome, Firefox, and Edge.
...
If you're using `resourceType` in your tests, please leave feedback on which resourceType's are important to you 
