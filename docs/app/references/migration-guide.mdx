...
The following plugins still call `Cypress.env()` and will trigger the deprecation warning (and throw errors with `allowCypressEnv: false`) until they release a migrated version: [@badeball/cypress-cucumber-preprocessor](https://github.com/badeball/cypress-cucumber-preprocessor), [@neuralegion/cypress-har-generator](https://github.com/NeuraLegion/cypress-har-generator), [@pactflow/pact-cypress-adapter](https://github.com/pactflow/pact-cypress-adapter), [@simonsmith/cypress-image-snapshot](https://github.com/simonsmith/cypress-image-snapshot), [allure-cypress](https://github.com/allure-framework/allure-js), [cypress-conditional-tags](https://github.com/JaydipManiya/cypress-conditional-tags), [cypress-mailslurp](https://github.com/mailslurp/cypress-mailslurp), and [cypress-perf-baseline](https://github.com/vimukthi101/cypress-perf-baseline). Check each project for newer releases before setting `allowCypressEnv: false`.
