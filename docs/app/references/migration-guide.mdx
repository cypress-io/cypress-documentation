...
1. **Update your CI configuration and examples.** If your pipeline relied on the
   ...
   See [Continuous Integration](/app/continuous-integration/overview) for setup
   details, including [Docker images](/app/continuous-integration/overview#Cypress-Docker-Images)
   that come with browsers preinstalled.
