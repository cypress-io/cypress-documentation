...
| Version                                      | Changes                                                 |
| -------------------------------------------- | ------------------------------------------------------- |
| [15.10.0](/app/changelog#15-10-0) | Added `expose` configuration option.                    |
| [15.4.0](/app/changelog#15-4-0)   | Added `posixExitCodes` to run options.                  |
| [12.6.0](/app/changelog#12-6-0)   | Added `autoCancelAfterFailures` to run options.         |
| [10.0.0](/app/changelog#10-0-0)   | `slowTestThreshold` is now scoped to each testing type. |
| [8.7.0](/app/changelog#8-7-0)     | Added `slowTestThreshold` configuration option.         |
| [7.3.0](/app/changelog#7-3-0)     | Added `testingType` configuration option.               |
| [5.0.0](/app/changelog#5-0-0)     | Test results returned from `cypress.run()` changed.     |
| [4.11.0](/app/changelog#4-11-0)   | Added `cypress.cli` with `parseRunArguments` function.  |
| [4.9.0](/app/changelog#4-9-0)     | Added `quiet` option to `cypress.run()`                 |
