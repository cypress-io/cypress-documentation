...
See our [Web Security](/app/guides/web-security#Limitations) documentation.
...
[cypress run --record](/app/guides/command-line#cypress-run).
...
[--group](/app/guides/command-line#cypress-run-group-lt-name-gt) or
[--parallel](/app/guides/command-line#cypress-run-parallel) flag.
...
[--group](/app/guides/command-line#cypress-run-group-lt-name-gt),
[--tag](/app/guides/command-line#cypress-run-tag-lt-tag-gt),
[--parallel](/app/guides/command-line#cypress-run-parallel), or
[--auto-cancel-after-failures](/app/guides/command-line#auto-cancel-after-runs)
...
You passed the
[--group](/app/guides/command-line#cypress-run-group-lt-name-gt) or
[--parallel](/app/guides/command-line#cypress-run-parallel) flag but we could
...
You passed the
[--group](/app/guides/command-line#cypress-run-group-lt-name-gt) flag, but
this group name has already been used for this run.

If you are trying to parallelize this run, then also pass the
[--parallel](/app/guides/command-line#cypress-run-parallel) flag, else pass a
...
You passed the [--parallel](/app/guides/command-line#cypress-run-parallel)
...
You cannot use the
[--parallel](/app/guides/command-line#cypress-run-parallel) flag with this
group.
...
You must use the [--parallel](/app/guides/command-line#cypress-run-parallel)
...
[--parallel](/app/guides/command-line#cypress-run-parallel) flag to a run
...
[here](/app/guides/command-line#cypress-run-ci-build-id-lt-id-gt).
...
- If you are passing [`--ci-build-id`](/app/guides/command-line#cypress-run-ci-build-id-lt-id-gt), make sure it is generating a unique value for the run. If it is not unique and matches a previous run, you may see this error.
...
[please read our dedicated guide to it](/app/guides/web-security).
...
[read about the reasoning here](/app/guides/web-security).
...
2. Use the built-in Electron browser for tests, since it is not affected by
   these policies.
   [See the guide to launching browsers for more information.](/app/guides/launching-browsers#Electron-Browser)
