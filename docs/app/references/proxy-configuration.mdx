...
Select your operating system to see how to configure Cypress to use your proxy:

<OsTabs>
  <TabItem value="linux" label="Linux">

To set your proxy on Linux, run the following command in a terminal before
running Cypress:
...
To set your proxy on macOS, run the following command in a terminal before
running Cypress:
