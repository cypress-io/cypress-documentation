...
- Cypress won't be able to connect to
  [Cypress Cloud](/app/cloud/introduction) to log in or record test runs.
...
[Cypress environment variables](/app/guide/environment-variables)
...
_not_ [Cypress environment variables](/app/guide/environment-variables)

:::

Cypress needs to be able to authenticate properly when communicating to
[Cypress Cloud](/app/cloud/introduction). When connecting through a proxy,
