...
| Option            | Default | Description                                                                                                                                                                                                                  |
| ----------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `keystrokeDelay`  | `null`  | The delay, in milliseconds, between keystrokes while typing with [`.type()`](/api/commands/type). Must be a non-negative number. Can also be set via [`Cypress.Keyboard.defaults()`](/api/cypress-api/keyboard-api).         |
...
| Version                                      | Changes                                                                                                                                       |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| [16.0.0](/app/references/changelog#16-0-0)   | Default `keystrokeDelay` changed from `10` to `0`.                                                                                            |
