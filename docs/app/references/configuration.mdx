...
| `manageBrowserMemory`  | `false`                               | Enables improved memory management within Chromium-based browsers by clearing the browser's heap between tests. See [Manage memory accumulation](/app/guides/test-performance#Manage-memory-accumulation) for guidance on when to enable it.                                                               |
