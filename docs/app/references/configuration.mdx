...
| Version                                      | Changes                                                                                                                                       |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| [15.10.0](/app/changelog#15-10-0) | Updated `env` to no longer be settable via test configuration.                                                                                |
| [15.10.0](/app/changelog#15-10-0) | Added `expose` option for exposing public configuration values.                                                                               |
| [14.0.0](/app/changelog#14-0-0)   | Added support for re-enabling superdomain navigation with the `injectDocumentDomain` configuration option                                     |
| [13.16.0](/app/changelog#13-16-0) | Added `defaultBrowser` option.                                                                                                                |
| [13.4.0](/app/changelog#13-4-0)   | Added support for configuring the Experimental Flake Detection strategy via `retries.experimentalStrategy` and `retries.experimentalOptions`. |
| [13.0.0](/app/changelog#13-0-0)   | Removed `nodeVersion` option.                                                                                                                 |
| [13.0.0](/app/changelog#13-0-0)   | Removed `videoUploadOnPasses` option.                                                                                                         |
| [11.0.0](/app/changelog#11-0-0)   | Removed `e2e.experimentalSessionAndOrigin` option.                                                                                            |
| [10.4.0](/app/changelog#10-4-0)   | Added `e2e.testIsolation` option.                                                                                                             |
| [10.0.0](/app/changelog#10-0-0)   | Reworked page to support new `cypress.config.js` and deprecated `cypress.json` files.                                                         |
| [8.7.0](/app/changelog#8-7-0)     | Added `slowTestThreshold` option.                                                                                                             |
| [8.0.0](/app/changelog#8-0-0)     | Added `clientCertificates` option and removed `firefoxGcInterval` configuration.                                                              |
| [7.0.0](/app/changelog#7-0-0)     | Added `e2e` and `component` options.                                                                                                          |
| [7.0.0](/app/changelog#7-0-0)     | Added `redirectionLimit` option.                                                                                                              |
| [6.1.0](/app/changelog#6-1-0)     | Added `scrollBehavior` option.                                                                                                                |
| [5.2.0](/app/changelog#5-2-0)     | Added `includeShadowDom` option.                                                                                                              |
| [5.0.0](/app/changelog#5-0-0)     | Added `retries` configuration.                                                                                                                |
| [5.0.0](/app/changelog#5-0-0)     | Renamed `blacklistHosts` configuration to `blockHosts`.                                                                                       |
| [4.1.0](/app/changelog#4-12-0)    | Added `screenshotOnRunFailure` configuration.                                                                                                 |
| [4.0.0](/app/changelog#4-0-0)     | Added `firefoxGcInterval` configuration.                                                                                                      |
| [3.5.0](/app/changelog#3-5-0)     | Added `nodeVersion` configuration.                                                                                                            |
