...
| `execTimeout` <Badge type="caution">deprecated</Badge> | `60000` | Time, in milliseconds, to wait for a system command to finish executing during a [`cy.exec()`](/api/commands/exec) command. Deprecated along with `cy.exec()`. Use `taskTimeout` with [`cy.task()`](/api/commands/task) instead.                                                                                                                                                                                                                                                   |
