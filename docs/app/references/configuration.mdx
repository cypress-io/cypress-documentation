...
| `env`                  | `{}`                                  | Any values to be set as [environment variables](/app/guides/environment-variables).                                                                                                                                                                                                                       |
...
[`--config-file`](/app/guides/command-line#cypress-open-config-file-lt-configuration-file-gt)
flag.
...
See the [Command Line](/app/guides/command-line) guide for more examples.
...
[environment variables](/app/guides/environment-variables). This is
...
See the
[Environment Variables](/app/guides/environment-variables#Option-3-CYPRESS_)
...
- The
  [Cypress environment file](/app/guides/environment-variables#Option-2-cypressenvjson)
- System
  [environment variables](/app/guides/environment-variables#Option-3-CYPRESS_)
- [Command Line arguments](/app/guides/command-line)
...
[here](/app/guides/web-security#Modifying-Obstructive-Third-Party-Code).

### setupNodeEvents

The `setupNodeEvents` function allows you to tap into, modify, or extend the
internal behavior of Cypress using the [`on`](/api/node-events/writing-a-plugin#on)
and [`config`](/api/node-events/writing-a-plugin#config) arguments, and is valid as
