...
the [legacy configuration](/app/references/legacy-configuration) guide.
...
If you [configure your tests to record](/app/cloud/getting-started#Setup) the
...
| `env`                  | `{}`                                  | Any values to be set as [environment variables](/app/guide/environment-variables).                                                                                                                                                                                                                        |
...
| `retries`              | `{ "runMode": 0, "openMode": 0 }`     | The number of times to retry a failing test. Can be configured to apply to `cypress run` or `cypress open` separately. As of Cypress `13.4.0`, the experimental Flake Detection strategy can also be configured. See [Test Retries](/app/guide/test-retries) for more information.                        |
...
[`--config-file`](/app/guide/command-line#cypress-open-config-file-lt-configuration-file-gt)
flag.
...
See the [Command Line](/app/guide/command-line) guide for more examples.
...
[environment variables](/app/guide/environment-variables). This is
especially useful in
[Continuous Integration](/app/continuous-integration/introduction) or when
...
See the
[Environment Variables](/app/guide/environment-variables#Option-3-CYPRESS_)
...
- The
  [Cypress environment file](/app/guide/environment-variables#Option-2-cypressenvjson)
- System
  [environment variables](/app/guide/environment-variables#Option-3-CYPRESS_)
- [Command Line arguments](/app/guide/command-line)
...
[here](/app/guide/web-security#Modifying-Obstructive-Third-Party-Code).
...
[plugins file](/app/references/legacy-configuration#Plugins).
...
See the [plugins guide](/app/tooling/plugins-guide) for more information.
...
- [Environment variables](/app/guide/environment-variables)
