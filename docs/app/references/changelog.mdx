...
- Using [Cypress.\_.capitalize](/api/utilities/lodash) now correctly behaves the same
...
- Updated [Cypress.\_](/api/utilities/lodash) to use [lodash](https://lodash.com)
...
- [`.debug()`](/api/commands/debug) has been zipped up - it no longer logs
  ...
  run command.
- [`Cypress._`](/api/lodash), [`Cypress.$`](/api/utilities/$),
