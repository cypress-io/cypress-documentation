...
_Released XX/XX/2026_

**Features:**

- Added support for the `data-cy-bootstrap` marker script to control where Cypress injects its bootstrap code. This fixes React 18 hydration errors in SSR applications like Next.js App Router and React Router 7. See the [SSR & Hydration guide](/app/guides/ssr-hydration) for usage details. Addresses [#31447](https://github.com/cypress-io/cypress/issues/31447).
