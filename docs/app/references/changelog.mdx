...
Cypress v14.0.0 expands support for new component testing framework and dev server versions and improves performance for component testing. 
Support for older versions of Node.js, Linux distributions, browsers and component testing frameworks and dev servers is removed. 
v14.0.0 also includes breaking changes to `cy.origin` that are necessary to handle Chrome's deprecation of document.domain injection 
- this should fix issues for some users in recent Chrome versions.
...
- Cypress [environment variables](/app/references/environment-variables) that
...
- [Updated `Environment Variables`](/app/references/environment-variables)
...
- [Environment Variables](/app/references/environment-variables) that match any
...
- `Environment Variable` support has been added and can be accessed in your
  ...
  [Environment Variable](/app/references/environment-variables) and
