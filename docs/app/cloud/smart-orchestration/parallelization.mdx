...
[recording](/app/cloud/getting-started#Setup) within Continuous Integration.
If you have not set up your project yet, check out our
[Continuous Integration guide](/app/continuous-integration/introduction). If
...
[Cross Browser Testing guide](/app/guide/cross-browser-testing) for helpful
...
2. Once multiple machines are available within your CI environment, you can pass
   the [--parallel](/app/guide/command-line#cypress-run-parallel) key to
   [cypress run](/app/guide/command-line#cypress-run) to have your recorded
   tests parallelized.
...
[`--record` flag](/app/guide/command-line#cypress-run) be passed. This
...
tests in [Cypress Cloud](/app/cloud/introduction). If you have not set up
your project to record, check out our
[setup guide](/app/cloud/getting-started#Setup).

:::

## CI parallelization interactions

During parallelization mode, [Cypress Cloud](/app/cloud/introduction)
interacts with your CI machines to orchestrate the parallelization of a test run
via [load-balancing](/app/cloud/smart-orchestration/load-balancing) of specs
across available CI machines by the following process:

1. CI machines contact [Cypress Cloud](/app/cloud/introduction) to indicate
...
4. Based on these estimations, Cypress distributes
   ([load-balances](/app/cloud/smart-orchestration/load-balancing)) spec
...
[load balance strategy](/app/cloud/smart-orchestration/load-balancing#Balance-strategy)
...
Multiple [cypress run](/app/guide/command-line#cypress-run) calls can be
labeled and associated to a **single** run by passing in the
[`--group <name>` flag](/app/guide/command-line#cypress-run-group-lt-name-gt),
...
[Cross Browser Testing guide](/app/guide/cross-browser-testing) to learn
more.
...
[`--ci-build-id` flag](/app/guide/command-line#cypress-run-ci-build-id-lt-id-gt).
...
[configurable within Cypress Cloud project settings page](/app/cloud/account-management/projects#Run-completion-delay).

## Visualizing parallelization and groups in Cypress Cloud

You can see the result of each spec file that ran within
[Cypress Cloud](/app/cloud/introduction) in the run's **Specs** tab. Specs
...
- [Cypress Real World App](https://github.com/cypress-io/cypress-realworld-app)
  ...
  viewport sizes.
- [Continuous Integration Guide](/app/continuous-integration/introduction)
- [Cross Browser Testing Guide](/app/guide/cross-browser-testing)
