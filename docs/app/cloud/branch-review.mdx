...
<DocsImage
  src="/img/app/cloud/branch-review/branch-review.jpg"
...
Cypress Branch Review is currently only available for [GitHub integrated projects](/app/cloud/integrations/source-control/github). We are working on adding support for GitLab and Bitbucket soon.

:::

## Getting Started

Branch Review works by leveraging the Cypress Cloud GitHub integration to query the GitHub API for branches with pull requests. Your project will first need to be connected to a GitHub repository. If you haven't already, follow the steps in [Install the Cypress GitHub app](/app/cloud/integrations/source-control/github#Install-the-Cypress-GitHub-app) to connect your project to GitHub.
...
<DocsImage
  src="/img/app/cloud/branch-review/get-to-branch-review.jpg"
  alt="Get to Branch Review"
  caption="Active branches, shown with available PR # tags"
/>

If you do not see PR # tags associated with a branch, you may need to [pass PR numbers](/app/continuous-integration/introduction#CI-Build-Information) to runs as environment variables. This helps ensure Cypress Cloud can map PR data correctly.
...
<DocsImage
  src="/img/app/cloud/branch-review/branch-review-available.png"
...
<DocsImage
  src="/img/app/cloud/branch-review/branch-review-views.png"
...
Clicking the branch label will link you directly to the appropriate [run overview](/app/cloud/recorded-runs#Overview-tab) and hovering on these elements exposes additional run meta data.

<DocsImage
  src="/img/app/cloud/branch-review/branch-review-header.jpg"
...
Recording exactly one run for every commit as the best/only way to ensure complete and accurate comparisons. See our [best practices](/app/cloud/branch-review#Best-Practices) on grouping multiple `cypress run` calls under one run.

:::

<DocsImage
  src="/img/app/cloud/branch-review/branch-review-details.jpg"
...
3. See what has changed in a specific status, for example:
   - <img
       ...
       src="/img/app/cloud/branch-review/test-status-up.png"
     /> total number introduced in your branch
   - <img
       className="br-ui inline-block"
       src="/img/app/cloud/branch-review/test-status-down.png"
     /> total number decreased or resolved in your branch
   - <img
       className="br-ui inline-block"
       src="/img/app/cloud/branch-review/test-status-total.png"
...
<DocsImage
  src="/img/app/cloud/branch-review/test-comparison.png"
...
The Cypress Cloud GitHub Integration offers detailed run information via [PR comments](/app/cloud/integrations/source-control/github#Pull-request-comments). Follow the "View all changes introduced in this branch" link to load the Branch Review between the feature and base branches.

<DocsImage
  src="/img/app/cloud/integrations/github/pr-comment-fail.jpg"
...
Cypress Cloud allows for [grouping recorded tests](/app/cloud/smart-orchestration/parallelization#Grouping-test-runs) together under a single run. This means multiple `cypress run` calls can be labeled and associated to a single run in Cypress Cloud.
...
- Read about [multi-repo implementation](/app/cloud/account-management/projects#Multi-repo-Implementation) best practices in Cypress Cloud.
