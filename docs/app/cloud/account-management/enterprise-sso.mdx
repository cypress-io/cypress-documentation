...
1. Log into your Okta dashboard and head to the **Admin** section.
   <DocsImage
     src="/img/app/cloud/sso/okta-admin-cypress-sso-setup.png"
     alt="Okta Admin"
   />
1. Create a new SAML-based Web application.
   <DocsImage
     src="/img/app/cloud/sso/okta-add-application-step1-cypress-sso.png"
     alt="Create Okta SAML App"
   />
   <DocsImage
     src="/img/app/cloud/sso/okta-add-application-step3-cypress-sso.png"
     alt="Create Okta SAML App"
     width={600}
   />
...
- Download the certificate and upload that to Cypress Cloud.
  <DocsImage
    src="/img/app/cloud/sso/okta-download-certificate-for-cypress-dashboard.png"
...
<DocsImage src="/img/app/cloud/sso/enterprise-SSO-SAML.png" alt="SAML SSO" />
...
- All SSO Users are initially added with the
  [User Role](/app/cloud/account-management/users#User-roles) of Member. If a
...
- SSO users are separate accounts from Google/GitHub or email/password users. If
  ...
  [Owner or Admin](/app/cloud/account-management/users#User-roles).
