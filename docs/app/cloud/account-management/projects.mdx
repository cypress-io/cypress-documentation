...
more [here](/app/continuous-integration/introduction#Environment-variables).
...
<DocsImage
  src="/img/app/cloud/projects/record-keys-in-project-settings-dashboard.jpg"
...
- **Private** means that only [users](/app/cloud/account-management/users)
  you invite to your
...
4. Here you will see a section displaying **Access**. Choose the appropriate
   ...
   <DocsImage
     src="/img/app/cloud/projects/access-to-runs.jpg"
     alt="access-to-runs"
   />
...
and [Auto Cancellation](/app/cloud/smart-orchestration/run-cancellation) guides to learn more.
...
See our
[Parallelization guide](/app/cloud/smart-orchestration/parallelization#Run-completion-delay)
to learn more.

<DocsImage
  src="/img/app/cloud/projects/run-completion-delay.jpg"
  alt="Run completion delay settings"
/>
...
<DocsImage
  src="/img/app/cloud/projects/run-timeout-setting.jpg"
...
[organization](/app/cloud/account-management/organizations) you are a part of
...
4. Scroll down to the **Transfer Ownership** section and click **Transfer
   Ownership**.
   <DocsImage
     src="/img/app/cloud/projects/transfer-ownership-button.jpg"
     alt="Transfer ownership button"
   />
5. Select the user or organization, then click **Transfer**.
   <DocsImage
     src="/img/app/cloud/projects/transfer-ownership-of-project-dialog.jpg"
...
an organization that is currently enrolled in a [free trial](/app/cloud/free-trial).
...
<DocsImage
  src="/img/app/cloud/projects/cancel-transfer-of-project.jpg"
...
<DocsImage
  src="/img/app/cloud/projects/accept-or-reject-transfer-of-project.jpg"
...
4. At the very bottom of the Settings page click the **Remove Project** button.
   <DocsImage
     src="/img/app/cloud/projects/remove-project-dialog.png"
...
7. 🎉 Your badge is ready to be embedded. Copy the markdown at the bottom of the
   ...
   {/* prettier-ignore */}
    <DocsImage
      src="/img/app/cloud/projects/cloud-badge-configuration.jpg"
...
- <Logo src="/img/logo/github.svg" /> [GitHub integration guide](/app/cloud/integrations/source-control/github)
- <Logo src="/img/logo/gitlab.svg" /> [GitLab integration guide](/app/cloud/integrations/source-control/gitlab)
- <Logo src="/img/logo/bitbucket.svg" /> [Bitbucket integration guide](/app/cloud/integrations/source-control/bitbucket)

### Issue Management

- <Logo src="/img/logo/jira.svg" /> [Jira integration guide](/app/cloud/integrations/jira)

### Team Communication

- <Logo src="/img/logo/slack.svg" /> [Cypress integration for Slack guide](/app/cloud/integrations/slack)
- <Logo src="/img/logo/ms-teams.svg" /> [Cypress integration for Microsoft Teams guide](/app/cloud/integrations/teams)
