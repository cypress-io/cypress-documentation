...
[same superdomain](/app/guide/cross-origin-testing#Parts-of-a-URL) for the
...
[Cross Origin Testing Guide](/app/guide/cross-origin-testing) for more
information.
...
[working around these common problems](/app/guide/web-security#Common-Workarounds).
...
you can
[disable web security](/app/guide/web-security#Disabling-Web-Security).
...
[disabling web security](/app/guide/web-security#Disabling-Web-Security).
...
[here](/app/references/best-practices#Visiting-External-Sites)
...
[do not control](/app/references/best-practices#Visiting-External-Sites).
...
above, including
[modifying obstructive third-party code](/app/guide/web-security#Modifying-Obstructive-Third-Party-Code)
