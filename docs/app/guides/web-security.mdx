...
[working around these common problems](/app/guides/web-security#Common-Workarounds).
...
you can
[disable web security](/app/guides/web-security#Disabling-Web-Security).
...
[disabling web security](/app/guides/web-security#Disabling-Web-Security).
...
above, including
[modifying obstructive third-party code](/app/guides/web-security#Modifying-Obstructive-Third-Party-Code)
