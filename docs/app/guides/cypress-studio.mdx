...
:::note Requirements
Studio requires **internet access** and **sourcemaps**. See [enable sourcemaps](#sourcemaps) for sourcemap setup. AI features additionally require a Cypress Cloud account and linked project.
:::
...
Each recommendation includes **Accept** and **Reject (×)** buttons that remain visible even after saving. You can:
