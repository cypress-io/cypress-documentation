...
Also see [Manage memory accumulation](#Manage-memory-accumulation) for how Cypress manages browser memory on your behalf, and when it makes sense to turn that off.
