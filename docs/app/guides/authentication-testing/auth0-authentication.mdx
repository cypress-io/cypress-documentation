...
The
<Icon name="github" inline="true" contentType="rwa" /> is
...
[parallelized runs](/guides/cloud/smart-orchestration/parallelization) to speed up test run
duration.
...
<Icon name="github" inline="true" contentType="rwa" /> `.env` file with your API token.
