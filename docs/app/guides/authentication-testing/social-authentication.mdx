...
Cypress.Commands.add(
  ...
  (SOCIAL_PROVIDER: 'microsoft' | 'google' | 'facebook') => {
    ...
    switch (SOCIAL_PROVIDER) {
      case 'microsoft':
        cy.env(['MICROSOFT_USERNAME', 'MICROSOFT_PASSWORD', 'MICROSOFT_NAME']).then(
      ...
      case 'google':
        ...
        break
      case 'facebook':
        cy.env(['FACEBOOK_USERNAME', 'FACEBOOK_PASSWORD', 'FACEBOOK_NAME']).then(
          ({ facebookUsername, facebookPassword, facebookName }) => {
