...
[Chrome-family browsers](/app/guide/launching-browsers#Chrome-Browsers)
(including Electron and Chromium-based Microsoft Edge),
[WebKit](/app/guide/launching-browsers#WebKit-Experimental) (Safari's
...
[`chromeWebSecurity` configuration option to be disabled](/app/guide/web-security#Disabling-Web-Security)
may experience issues in non-Chromium based browsers.

:::

Excluding [Electron](/app/guide/launching-browsers#Electron-Browser), any
...
[`--browser`](/app/guide/command-line#Options) flag when using
[`run`](/app/guide/command-line#cypress-run) command to launch Cypress. For
...
- [Launching Browsers](/app/guide/launching-browsers)
