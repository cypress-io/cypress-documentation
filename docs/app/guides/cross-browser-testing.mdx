...
[Chrome-family browsers](/app/guides/launching-browsers#Chrome-Browsers)
(including Electron and Chromium-based Microsoft Edge),
[WebKit](/app/guides/launching-browsers#WebKit-Experimental) (Safari's
...
[`chromeWebSecurity` configuration option to be disabled](/app/guides/web-security#Disabling-Web-Security)
may experience issues in non-Chromium based browsers.

:::

Excluding [Electron](/app/guides/launching-browsers#Electron-Browser), any
...
the browser selection menu of [Cypress](/app/core-concepts/cypress-app).
...
[`--browser`](/app/guides/command-line#Options) flag when using
[`run`](/app/guides/command-line#cypress-run) command to launch Cypress. For
...
<strong>Docker Images for Testing</strong>
...
- [Launching Browsers](/app/guides/launching-browsers)
