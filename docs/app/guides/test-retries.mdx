...
You may want to use the [experimental test retries](/app/references/experiments#Experimental-Test-Retries) feature which offers more options for [detecting flaky tests](/cloud/features/flaky-test-management#Flake-Detection). This experimental feature is available as of Cypress `13.4.0`.
