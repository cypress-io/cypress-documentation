...
compressed, and uploaded to [Cypress Cloud](/app/cloud/introduction) after
...
to [Cypress Cloud](/app/cloud/introduction).
...
[Cypress Cloud](/app/cloud/introduction): our companion enterprise service
