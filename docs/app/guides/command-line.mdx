...
[Module API](/app/guides/module-api).
...
Set Cypress [environment variables](/app/guides/environment-variables).
...
[Read more about grouping.](/cloud/smart-orchestration/parallelization#Grouping-test-runs)
...
[parallel](/cloud/smart-orchestration/parallelization) across multiple
machines.
...
[group](/cloud/smart-orchestration/parallelization#Grouping-test-runs).

```shell
cypress run --record --parallel --group e2e-staging-specs
```

Read our [parallelization](/cloud/smart-orchestration/parallelization)
documentation to learn more.
...
[set up your project to record](/cloud/getting-started#Setup), make sure
...
[Cypress Cloud setup instructions](/cloud/getting-started#Setup). For an
...
Useful for when [Test Replay](/cloud/test-replay) is enabled and you would still like the Runner UI to be rendered for screenshots and video.
