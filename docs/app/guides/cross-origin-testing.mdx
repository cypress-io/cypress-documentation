...
<DocsImage src="/img/app/cross-origin-testing/parts_of_a_url.jpg" />
...
[Different superdomain per test requires cy.origin command](/app/guides/web-security#Different-superdomain-per-test-requires-cyorigin-command).
...
- [Best Practices: Visiting external sites](/app/references/best-practices#Visiting-External-Sites)
- [Web Security: Common Workarounds](/app/guides/web-security#Common-Workarounds)
- [Recipes: Logging In - Single Sign On](/examples/recipes#Logging-In)
- [Guides: Amazon Cognito Authentication](/app/end-to-end-testing/amazon-cognito-authentication)
- [Guides: Auth0 Authentication](/app/end-to-end-testing/auth0-authentication)
- [Guides: Okta Authentication](/app/end-to-end-testing/okta-authentication)
