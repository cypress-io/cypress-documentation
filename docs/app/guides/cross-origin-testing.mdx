...
[Different superdomain per test requires cy.origin command](/app/guide/web-security#Different-superdomain-per-test-requires-cyorigin-command).
...
- [Web Security: Common Workarounds](/app/guide/web-security#Common-Workarounds)
