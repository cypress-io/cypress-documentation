...
By default, when running [cypress run](/app/guide/command-line#cypress-run)
...
[See the Command Line guide for more information about the `--browser` arguments](/app/guide/command-line#cypress-run-browser-lt-browser-name-or-path-gt)
...
- [Cross browser Testing](/app/guide/cross-browser-testing)
