...
Just like the [Command Line options](/app/guides/command-line) for
...
| `ciBuildId`               | _string_            | Specify a unique identifier for a run to enable [grouping](/cloud/smart-orchestration/parallelization#Grouping-test-runs) or [parallelization](/cloud/smart-orchestration/parallelization) |
...
| `env`                     | _object_            | Specify [environment variables](/app/guides/environment-variables)                                                                                                                                  |
| `group`                   | _string_            | [Group](/cloud/smart-orchestration/parallelization#Grouping-test-runs) recorded tests together under a single run                                                                              |
...
| `parallel`                | _boolean_           | Run recorded specs in [parallel](/cloud/smart-orchestration/parallelization) across multiple machines                                                                                          |
...
| `runnerUi`                | _boolean_           | Whether to display the Cypress Runner UI. Defaults to `false` when [Test Replay](/cloud/test-replay) is enabled. Otherwise defaults to `true`.                                                 |
...
Just like the [Command Line options](/app/guides/command-line), you can pass
