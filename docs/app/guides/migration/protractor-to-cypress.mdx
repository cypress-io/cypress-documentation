...
find the right CSS selectors for the DOM elements in your application with [Cypress Studio](/app/guides/cypress-studio). With Cypress Cloud, Studio includes **Studio AI**, AI-powered assertion recommendations as you record.
