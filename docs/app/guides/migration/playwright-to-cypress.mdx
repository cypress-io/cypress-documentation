...
Unlike Playwright, Cypress does not download its own browser binaries. It uses browsers already installed on your machine, so run your tests in an installed browser such as Chrome.
