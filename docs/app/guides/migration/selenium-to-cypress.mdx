...
Executing the following command initiates a headless run. We recommend passing `--browser` (for example, `--browser chrome`) to choose an installed browser. Upon completion, a succinct
