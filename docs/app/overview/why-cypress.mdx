...
**and** [Cypress Cloud](/app/cloud/introduction) for recording tests, surfacing test results, and providing test analytics.
...
- **Next:** After building up a suite of tests and
  ...
  CI Provider, [Cypress Cloud](/app/cloud/introduction) can record your test
  runs surfacing exactly what happened during the test in [Test Replay](/app/cloud/test-replay).
...
- **Debuggability:** Stop guessing why your tests are failing.
  [Debug directly](/app/guide/debugging) from familiar tools like Developer
...
- **Spies, Stubs, and Clocks:** Verify and
  [control the behavior](/app/guide/stubs-spies-and-clocks) of functions,
  server responses, or timers. The same functionality you love from unit testing
  is right at your fingertips.
- **Network Traffic Control:** Easily
  [control, stub, and test edge cases](/app/guide/network-requests) without
...
- **Cross Browser Testing:** Run tests within Firefox and Chrome-family browsers
  ...
  [in a Continuous Integration pipeline](/app/guide/cross-browser-testing).

#### Cypress Cloud

- **Test Replay:** Record to [Cypress Cloud](/app/cloud/introduction) and replay the test exactly as it executed during the run for zero-configuration debugging using [Test Replay](/app/cloud/test-replay).
- **Smart Orchestration:** Once you're set up to record to Cypress Cloud, easily
  [parallelize](/app/cloud/smart-orchestration/parallelization) your test
  ...
  [Auto Cancellation](/app/cloud/smart-orchestration/run-cancellation) for
  tight feedback loops.
- **Flake Detection:** Discover and diagnose unreliable tests with Cypress
  Cloud's [Flaky test management](/app/cloud/flaky-test-management).
- **Branch Review:** Quickly identify the impact a pull request might have on your test suite in a single view using [Branch Review](/app/cloud/branch-review). Compare which tests are failing, flaky, pending, added, or modified between the source and base branches and prevent the merging of low-quality code.
- **Integrations:** Integrate with [GitHub](/app/cloud/integrations/source-control/github), [GitLab](/app/cloud/integrations/source-control/gitlab), or [Bitbucket](/app/cloud/integrations/source-control/bitbucket) to see test results directly on every push or pull request. Cypress Cloud also integrates with
  [Slack](/app/cloud/integrations/slack), [Jira](/app/cloud/integrations/jira), and [Microsoft Teams](/app/cloud/integrations/teams) to keep your team in the loop.
- **Test Analytics:** Track test results over time with [Test Analytics](/app/cloud/analytics/overview) to identify trends, regressions, and improvements in your test suite. Use our [Data Extract API](/app/cloud/integrations/data-extract-api) to extract the data that is important to your team.
...
With [Cypress Cloud](/app/cloud/introduction), you can record your tests, replay them exactly as they
executed during the run, and then debug using [Test Replay](/app/cloud/test-replay).
...
<DocsImage
  src="/img/app/cloud/integrations/jira/dashboard-jira-integration-install.png"
  alt="Cypress Cloud Integrations"
/>

### <Icon name="bug" /> Analyze Testing Trends

Track test results over time with [Test Analytics](/app/cloud/analytics/overview) to
identify trends, regressions, and improvements in your test suite. Use our [Data
Extract API](/app/cloud/integrations/data-extract-api) to extract the data
that is important to your team.

<DocsImage
  src="/img/app/cloud/analytics/dashboard-analytics-overview.png"
...
[across multiple browsers](/app/guide/cross-browser-testing) and
