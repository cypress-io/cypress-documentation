...
sidebar_label: Custom component testing frameworks
sidebar_position: 40
slug: /app/component-testing/custom-frameworks
---

<ProductHeading product="app" />

# Custom component testing frameworks
...
Below is a minimal Framework Definition. `defineFrameworkDefinition`
...
expected. If you do run into unexpected behavior,
...
minimal test suite for a Solid.js Mount Adapter can be found in the
[Solid.js example project](https://github.com/lmiller1990/cypress-ct-solid-js/tree/main/example-project).
...
You can find a list of available Framework Definitions in
[Supported Frameworks](/app/component-testing/get-started#Supported-Frameworks).

If you have created a Framework Definition we would be delighted to mention it in our documentation
so other Cypress users on the same framework can find it. [Submit a Pull Request](https://github.com/cypress-io/cypress-documentation/blob/main/CONTRIBUTING.md)!
