---
title: 'Recipes in Cypress: how to test common scenarios'
...
| [Evaluate performance metrics](https://github.com/cypress-io/cypress-example-recipes/tree/master/examples/testing-dom__performance-metrics) | Use Cypress to monitor a website                                             |
...
Demo recipes from the blog posts at [Cypress blog](https://www.cypress.io/blog?utm_source=docs.cypress.io&utm_medium=recipes).
...
| [Automate Angular Testing](https://www.cypress.io/blog/2019/08/02/guest-post-angular-adding-cypress-ui-tests-to-your-devops-pipeline?utm_source=docs.cypress.io&utm_medium=recipes) | Automate Angular Testing                                                                                          |
...
| [Run in Docker](https://www.cypress.io/blog/2019/05/02/run-cypress-with-a-single-docker-command/?utm_source=docs.cypress.io&utm_medium=recipes) | Run Cypress with a single Docker command |
