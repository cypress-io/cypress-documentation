...
<Icon name="exclamation-triangle" /> This feature is only available in Cypress **v12.7**
and later.

:::

Cypress Component Testing includes
[official support](/app/component-testing/overview#Supported-Frameworks) for
...
You can find a list of available Framework Definitions [here](/app/component-testing/overview#Community-Supported-Frameworks).
