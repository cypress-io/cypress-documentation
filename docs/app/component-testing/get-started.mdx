...
You can also launch Cypress for a specific [Testing Type](/app/core-concepts/testing-types) using either `--e2e` or in this case the `--component` [CLI Option](/app/guides/command-line#Options).
...
[Selector Best Practices](/app/references/best-practices#Selecting-Elements).
