...
- **Write less test boilerplate.** [Automatic waiting](/app/core-concepts/introduction-to-cypress#Cypress-Retries-Queries-Automatically) means your assertions run only after your component has rendered and updated. There is no need for `waitFor`, `act()`, or manual timeouts. You describe what should be true; Cypress waits until it is.
