...
You can also launch Cypress for a specific [Testing Type](/app/core-concepts/testing-types) using either `--e2e` or in this case the `--component` [CLI Option](/app/guide/command-line#Options).
...
We can use [Cypress Spies](/app/guide/stubs-spies-and-clocks#Spies) to
