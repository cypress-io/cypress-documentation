---
title: 'Testing social authentication in Cypress'
...
sidebar_position: 60
slug: /app/guides/authentication-testing/social-authentication
---
...
- **Step 1:** When configuring your Sample App, select the
  **Single-Page App** for you platform and **React** for the technology.
- **Step 2:** For **Social Connections**, select **Facebook**, **Microsoft**, and
  **Google**
...
- **Step 4:** You can either download the sample via the **Download Sample App**
  button or clone the
  [Auth0 React sample app](https://github.com/auth0-samples/auth0-react-samples/tree/d5848ed710db85d6ef060731b296603c0eca744b/Sample-01).
...
- Visit the **Settings** tab
  ...
  - Inside **Application URIs**, add `http://localhost:3000` to
