...
sidebar_position: 90
slug: /app/tooling/typescript-support
---
...
for [TypeScript](https://www.typescriptlang.org/). These declarations support
writing your tests in TypeScript.
...
inside your
[`cypress` folder](/app/core-concepts/writing-and-organizing-tests)
...
`**/*.ts` only if the glob is `**/*.{ts,d.ts}` or `**/*`. Safest
