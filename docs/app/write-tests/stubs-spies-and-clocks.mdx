---
title: 'Stubs, spies, and clocks in Cypress'
...
sidebar_position: 40
slug: /app/guides/stubs-spies-and-clocks
---
...
`time` to override its behavior or avoid slow tests.
...
- [Spies, stubs, and clocks](https://example.cypress.io/commands/spies-stubs-clocks)
  examples
- [Testing periodic network requests with cy.intercept and cy.clock combination](https://www.cypress.io/blog/2021/02/23/cy-intercept-and-cy-clock/?utm_source=docs.cypress.io&utm_medium=stubs-spies-and-clocks)
