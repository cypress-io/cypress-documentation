...
sidebar_label: Configure component testing
sidebar_position: 20
slug: /app/component-testing/component-framework-configuration
---
...
The index file holds global assets, such as styles, fonts, and external scripts.
