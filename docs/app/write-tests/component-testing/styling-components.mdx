...
sidebar_position: 30
slug: /app/component-testing/styling-components
---
...
On the other hand, browser-based runners like Cypress render your application's
styles and components, and Cypress's Driver takes advantage of the real
box-model and style rendering engine. Cypress's commands like
...
will need to follow this guide to get your component looking **and
...
these work together to deliver a working component.
