...
sidebar_position: 80
slug: /app/tooling/visual-testing
---
...
Chromatic uses your existing Cypress setup to enable visual testing of
...
- Read the blog post
  [Debug a Flaky Visual Regression Test](https://www.cypress.io/blog/2020/10/02/debug-a-flaky-visual-regression-test/?utm_source=docs.cypress.io&utm_medium=visual-testing)
