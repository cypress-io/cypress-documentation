...
phases:
  install:
    ...
    commands:
      ...
      # https://docs.cypress.io//app/continuous-integration/introduction#Git-information
...
**Enabling batch builds in the CodeBuild UI for the project**
...
recording test results to [Cypress Cloud](//app/cloud/introduction).
