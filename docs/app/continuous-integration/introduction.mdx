...
2. [Pass the `--record` flag to `cypress run`](/app/guides/command-line#cypress-run)
   within CI.
...
the [--parallel](/app/guides/command-line#cypress-run-parallel) flag to have
...
[Environment Variables Guide](/app/guides/environment-variables) for more
examples.
...
If you're using our [Module API](/app/guides/module-api) then you can write a
...
[commands to get information about the Cypress cache](/app/guides/command-line#cypress-cache-command)
