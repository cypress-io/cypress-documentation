...
- [cypress/base](https://github.com/cypress-io/cypress-docker-images/tree/master/base) is the entry-level Cypress Docker image.
  ...
  [prerequisite operating system packages](https://docs.cypress.io/app/get-started/installing-cypress#UbuntuDebian) for Cypress,
...
If you see a message about a missing dependency when you run Cypress in a Linux CI environment, then refer to the [Linux Prerequisites](/app/get-started/installing-cypress#Linux-Prerequisites) lists for guidance.
