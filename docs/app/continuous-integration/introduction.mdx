...
[Cypress Cloud](/app/cloud/introduction). Cloud gives you access to recorded
...
- See which machines ran each test when
  [parallelized](/app/cloud/smart-orchestration/parallelization).

#### To record tests:

1. [Set up your project to record](/app/cloud/getting-started#Setup)
2. [Pass the `--record` flag to `cypress run`](/app/guide/command-line#cypress-run)
   within CI.
...
[Read the full guide on the Cypress Cloud.](/app/cloud/introduction)
...
the [--parallel](/app/guide/command-line#cypress-run-parallel) flag to have
...
[Read the full guide on parallelization.](/app/cloud/smart-orchestration/parallelization)
...
- [cypress/base](https://github.com/cypress-io/cypress-docker-images/tree/master/base) is the entry-level Cypress Docker image.
  ...
  [prerequisite operating system packages](https://docs.cypress.io/app/getting-started/installing-cypress#UbuntuDebian) for Cypress,
...
[System Requirements](/app/getting-started/installing-cypress#System-requirements)
...
If you see a message about a missing dependency when you run Cypress in a Linux CI environment, then refer to the [Linux Prerequisites](/app/getting-started/installing-cypress#Linux-Prerequisites) lists for guidance.
...
[Learn why.](/app/cloud/account-management/projects#Identification)
...
[GitHub Integration](/app/cloud/integrations/source-control/github) or other
...
[Environment Variables Guide](/app/guide/environment-variables) for more
examples.
...
If you're using our [Module API](/app/guide/module-api) then you can write a
...
[commands to get information about the Cypress cache](/app/guide/command-line#cypress-cache-command)
