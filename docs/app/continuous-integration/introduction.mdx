...
[Cypress Cloud](/cloud/introduction). Cloud gives you access to recorded
...
- See which machines ran each test when
  [parallelized](/cloud/smart-orchestration/parallelization).

#### To record tests:

1. [Set up your project to record](/cloud/getting-started#Setup)
...
[Read the full guide on the Cypress Cloud.](/cloud/introduction)
...
[Read the full guide on parallelization.](/cloud/smart-orchestration/parallelization)
