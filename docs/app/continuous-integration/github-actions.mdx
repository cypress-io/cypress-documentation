...
[Cypress Cloud](/app/cloud/introduction) offers the ability to
[parallelize and group test runs](/app/cloud/smart-orchestration/parallelization)
along with additional insights and [analytics](/app/cloud/analytics/overview) for
Cypress tests.
