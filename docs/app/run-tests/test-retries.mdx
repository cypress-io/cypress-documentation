...
- `runMode` defines the number of test retries when running `cypress run`
- `openMode` defines the number of test retries when running `cypress open`
