---
title: 'Cross browser testing in Cypress'
...
sidebar_position: 40
slug: /app/guides/cross-browser-testing
---
...
Any browser you want to run Cypress tests in needs to be installed on your local
...
// using Chrome
it('has access to clipboard', { browser: 'chrome' }, () => {
  // ...
})
