...
sidebar_position: 40
slug: /app/continuous-integration/circleci
---
...
installs, caches, and runs Cypress tests in CircleCI with less
effort. The orb abstracts common steps necessary for running your tests in
CircleCI to make your life as a developer better!
...
The `install-browsers` flag installs Chrome, Chrome for Testing, Edge, Firefox,
and the geckodriver. Use it together with the `--browser` flag in your
`cypress-command` to run your tests in an installed browser.
