...
sidebar_position: 60
slug: /app/continuous-integration/gitlab-ci
---
...
- Finally, our scripts will:
  ...
  - Run the Cypress tests within the GitLab repository. To run in an installed
    browser like Chrome or Firefox, see
    [Testing with Cypress Docker Images](#Testing-with-Cypress-Docker-Images)
    below.
...
using three useful features of
