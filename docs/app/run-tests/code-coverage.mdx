...
slug: /app/tooling/code-coverage
---
...
branches, error handlers, edge cases — that never had a test written for
...
see our [UI Coverage](/ui-coverage/get-started/introduction) guide.
...
<PackageManagerTabs run="nyc instrument --compact=false src instrumented" />
...
<PackageManagerTabs install="vite-plugin-istanbul" dev />
...
<PackageManagerTabs install="@cypress/code-coverage" dev />
...
testing tool (find more
[unit testing recipes](https://github.com/cypress-io/cypress-example-recipes#unit-testing)).
...
<DocsVideo
  src="https://youtube.com/embed/dwU5gUG2-EM"
