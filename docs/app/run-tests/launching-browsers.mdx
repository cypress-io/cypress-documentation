...
sidebar_label: Browser launch options
sidebar_position: 50
slug: /app/references/launching-browsers
---
...
Cypress currently supports Chrome-family browsers (including Edge and Chrome for Testing)
...
implicit fallback to Electron) will fail. See
...
an issue not on the "Known Issues" list,
...
<PackageManagerTabs exec="playwright install-deps webkit" />
