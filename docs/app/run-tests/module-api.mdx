...
sidebar_label: Run Cypress from Node.js
sidebar_position: 20
slug: /app/references/module-api
---

<ProductHeading product="app" />

# Run Cypress from Node.js
...
| `configFile`              | _string_            | Path to the [configuration file](/app/references/configuration) to be used.                                                                                                                                  |
...
Here is an example of programmatically running a spec file. The file
...
To handle these possible errors, you can add a `catch` to
`cypress.run()`:
