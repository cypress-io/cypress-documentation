...
streamlines the setup with just two Node.js commands: ['npm install'](/app/get-started/install-cypress#npm-install)
...
You will first [install Cypress](/app/get-started/install-cypress).
You will then [open the Cypress application](/app/get-started/open-the-app).
