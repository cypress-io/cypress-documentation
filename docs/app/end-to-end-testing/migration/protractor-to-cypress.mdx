...
slug: /app/end-to-end-testing/protractor-to-cypress
---
...
With [Cypress](/app/core-concepts/cypress-app), your tests run in an
interactive browser environment in real time. Cypress's
[Command Log](/app/core-concepts/cypress-app#Command-Log) displays the tests
from your test suite and their assertions. When you
[click on a command or assertion](https://docs.cypress.io/app/core-concepts/cypress-app#Clicking-on-Commands)
...
[Selector Playground](https://docs.cypress.io/app/core-concepts/cypress-app#Selector-Playground).
...
the [command log](/app/core-concepts/cypress-app#Command-Log), you can see
...
- Replay the test as it executed during the recorded run with full debug capability using [Test Replay](/app/cloud/test-replay) in Cypress Cloud.
...
allows you to [retry failed tests](/app/guide/test-retries). Sometimes tests
...
[detect flaky tests](/app/cloud/flaky-test-management) that run in your CI/CD
pipeline.
...
[Cypress Cloud](https://docs.cypress.io/app/cloud/introduction).
...
[run your tests in all Continuous Integration environments](/app/continuous-integration/introduction).
...
[many of the other popular CI environments](/app/continuous-integration/ci-provider-examples).
Even if your CI provider isn't listed, you can still run Cypress in your CI
environment.

## Parallelization

[Cypress Cloud](/app/cloud/introduction) allows you to run your test files in
parallel across multiple CI machines.

With Cypress, your tests can be
[parallelized on a per spec file basis](https://docs.cypress.io/app/cloud/smart-orchestration/parallelization).
...
[do not recommend relying on the state of previous tests](/app/references/best-practices#Having-Tests-Rely-On-The-State-Of-Previous-Tests).
...
For more information, check out our
[docs on parallelization](/app/cloud/smart-orchestration/parallelization#Overview)!
...
[Cypress Cloud](https://docs.cypress.io/app/cloud/introduction) recording key
...
[Cypress Cloud](/app/cloud/introduction) to learn more.
...
check out [our official documentation here](/app/overview/why-cypress).
