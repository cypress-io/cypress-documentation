...
sidebar_label: 'Your First Test with Cypress'
...
[installed Cypress](/app/getting-started/installing-cypress) and
[opened Cypress](/app/getting-started/opening-the-app), now it's time to add
...
Over in the [Command Log](/app/core-concepts/cypress-app#Command-Log) you'll
see Cypress display the suite, the test and your first assertion (which should
be passing in green).

<DocsImage
  src="/img/app/getting-started/e2e/v10/first-test.png"
...
[on the righthand side](/app/core-concepts/cypress-app#Application-Under-Test).
...
[Debugging Errors](/app/guide/debugging#Errors).
...
<DocsImage
  src="/img/app/getting-started/e2e/v10/first-test-failing.png"
  alt="Failing test"
/>

[Cypress](/app/core-concepts/cypress-app) gives you a visual structure of
...
1. The [Command Log](/app/core-concepts/cypress-app#Command-Log) now shows
   the new `VISIT` action.
2. The Kitchen Sink application has been loaded into the
   [App Preview](/app/core-concepts/cypress-app#Overview) pane.
...
[Command Log](/app/core-concepts/cypress-app#Command-Log) and still be green.
...
<DocsImage
  src="/img/app/getting-started/e2e/v10/first-test-failing-contains.png"
...
Also note that the [App Preview](/app/core-concepts/cypress-app#Overview)
...
on it [here](/app/references/best-practices#Selecting-Elements).
...
[guide](/app/references/cypress-studio) for more information.
...
- Take our free
  ...
  course.
- Learn more about the [Cypress App](/app/core-concepts/cypress-app) UI.
...
- Record your test results to [Cypress Cloud](/app/cloud/introduction) for
...
<DocsImage
  src="/img/app/getting-started/e2e/search-box.png"
