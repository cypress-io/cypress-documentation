...
[opened Cypress](/app/getting-started/opening-the-app) in your project, the
...
[best practices](/app/references/best-practices#Web-Servers) here.
...
<DocsImage
  src="/img/app/getting-started/e2e/v10/testing-your-app-home-page-spec.png"
...
<DocsImage
  src="/img/app/getting-started/e2e/v10/testing-your-app-visit-fail.png"
...
Please read our [Guide on Network Requests](/app/guide/network-requests) for
...
- [Command Line](/app/guide/command-line) for running all your tests outside
  via `cypress run`
- [Continuous Integration](/app/continuous-integration/introduction) for
  running Cypress in CI
- [Cross Browser Testing](/app/guide/cross-browser-testing) for optimally
