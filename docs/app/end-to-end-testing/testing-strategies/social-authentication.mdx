...
slug: /app/end-to-end-testing/social-authentication
---
...
- Understanding [challenges](/app/references/best-practices#When-logging-in)
...
[challenges](/app/references/best-practices#Potential-Challenges-Authenticating-with-Social-Platforms)
mentioned in our
[Best Practices Guide](/app/references/best-practices).
...
[supported methods](/app/guide/environment-variables#Setting).
...
- [Cross Origin Testing Guide](/app/guide/cross-origin-testing)
- [AWS Cognito Authentication Guide](/app/end-to-end-testing/amazon-cognito-authentication)
- [Azure Active Directory Authentication Guide](/app/end-to-end-testing/azure-active-directory-authentication)
