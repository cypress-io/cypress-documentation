...
e2eSpecific: true
slug: /app/end-to-end-testing/okta-authentication
---
...
- [Login with `cy.origin()`](/app/end-to-end-testing/okta-authentication#Login-with-cyorigin)
- [Programmatic Access](/app/end-to-end-testing/okta-authentication#Programmatic-Login)
