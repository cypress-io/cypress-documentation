...
e2eSpecific: true
slug: /app/end-to-end-testing/amazon-cognito-authentication
---
...
- [Login with `cy.origin()`](/app/end-to-end-testing/amazon-cognito-authentication#Login-with-cyorigin)
- [Programmatic Access](/app/end-to-end-testing/amazon-cognito-authentication#Programmatic-Login)
