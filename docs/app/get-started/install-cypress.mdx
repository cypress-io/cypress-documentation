...
We recommend running your tests in an installed browser. Cypress supports the
latest 3 major versions of the following:
...
so your runs don't rely on the bundled Electron default. See
