...
- [Integrate test results into your workflow](#Integrate-into-your-workflow)
...
- [Accessibility testing](accessibility/get-started/introduction)
...
[locally installed](/app/get-started/install-cypress) App
**and** [Cypress Cloud](/cloud/get-started/introduction) for recording tests, surfacing test results, and providing test analytics.
Additionally, the Cypress Cloud provides add-ons for [Cypress Accessibility](/accessibility/get-started/introduction) and [UI Coverage](/ui-coverage/get-started/introduction).
...
Cypress [Component Testing](/app/component-testing/overview) provides a component workbench for you to quickly
