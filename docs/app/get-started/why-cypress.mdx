...
- **Cypress Studio & Studio AI<Icon useCypressIcon name="general-sparkle-double-large" className="inline mt-[-4px]" strokeColor="purple-500" fillColor="white" />:** Record interactions in your app to generate and
...
- **Cypress Cloud MCP** <Icon useCypressIcon name="general-sparkle-double-large" className="inline mt-[-4px]" strokeColor="purple-500" fillColor="white" />: Turn your AI assistant into a debugging agent with direct access to real-time Cloud results. Query test failures, stack traces, and run metadata directly from your IDE with the [Cypress Cloud MCP](/cloud/integrations/cloud-mcp).
- gives AI coding assistants a direct window into your application’s health and stability by connect it directly to Cypress Cloud.
