...
- **[Automatic waiting](/app/core-concepts/introduction-to-cypress#Cypress-retries-queries-automatically)** removes the timing logic that other tools require you to hand-write and maintain.
...
- **Automatic Waiting:** Never add waits or sleeps to your tests. Cypress
  [automatically waits](/app/core-concepts/introduction-to-cypress#Cypress-retries-queries-automatically)
