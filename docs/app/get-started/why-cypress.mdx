...
[locally installed](/app/get-started/installing-cypress) app
**and** [Cypress Cloud](/cloud/get-started/introduction) for recording tests, surfacing test results, and providing test analytics.
...
With [Cypress Cloud](/cloud/get-started/introduction), you can record your tests, replay them exactly as they
executed during the run, and then debug using [Test Replay](/cloud/features/test-replay).
...
Track test results over time with [Test Analytics](/cloud/features/analytics/overview) to
