...
sidebar_position: 10
slug: /app/get-started/why-cypress
---
...
- **[Test Replay](/cloud/features/test-replay)** replays the test exactly as it executed during the run for zero-configuration debugging.
...
- **[Smart Orchestration](/cloud/features/smart-orchestration/parallelization)** keeps CI fast as your suite grows by parallelizing specs, prioritizing the ones most likely to fail, and cancelling builds that are clearly broken.
...
- **Integrations:** Integrate with [GitHub](/cloud/integrations/github), [GitLab](/cloud/integrations/gitlab), or [Bitbucket](/cloud/integrations/bitbucket) to see test results directly on every push or pull request. Cypress Cloud also integrates with
  [Slack](/cloud/integrations/slack), [Jira](/cloud/integrations/jira), and [Microsoft Teams](/cloud/integrations/microsoft-teams) to keep your team in the loop.
...
- **Run-level reports:** Get a detailed report of accessibility issues found in your test runs with [Run-level reports](/accessibility/reports/run-level-reports).
- **Results where you work:** Use the [Results API](/accessibility/connect-and-extend/results-api) to integrate results into CI, and [Cloud MCP](/cloud/integrations/cloud-mcp) to surface them in your AI agent for faster diagnosis and iteration.
...
aim to elevate the art of software development by using test results to
...
general [file system operations](/api/commands/task), and
...
- For [Component Tests](/app/component-testing/get-started), Cypress is
  browser-based, exercising not only your component's functionality but also its
  styles and appearance. You can visually see your
...
[clone the repository](https://github.com/cypress-io/cypress-realworld-app)
and start testing.
