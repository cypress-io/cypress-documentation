...
sidebar_position: 50
slug: /app/get-started/open-the-app
---
...
[Project structure](/app/core-concepts/writing-and-organizing-tests), or scroll
down and click **Continue**. The defaults work well for most projects,
...
You can use the Cypress app without an account. Logging in to
[Cypress Cloud](/cloud/get-started/introduction) from the profile menu in the
top right connects the app to your Cloud organization and unlocks insights from
your recorded runs, right inside the app:
