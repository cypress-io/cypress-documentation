...
[writing plugins](/app/tooling/plugins-guide) that _can perform visual
testing_.
...
<DocsImage
  src="/img/app/visual-testing/diff-2.png"
...
<Icon name="check-circle" color="green" /> **Best Practice:** Use [Component Testing](/app/component-testing/overview)
...
- [Plugins](/app/tooling/plugins-guide)
