...
# <Icon name="hexagon-nodes" /> Cypress AI Skills
...
Cypress skills work with any AI coding tool that supports custom instructions, including Cursor, <Icon name="claude" /> Claude Code, <Icon name="github" /> GitHub Copilot, and others.
