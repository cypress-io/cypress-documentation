...
configuration file or via the [command line](/app/guides/command-line).
...
[command line](/app/guides/command-line) options.
...
<Icon
  name="github"
  inline="true"
  url="https://github.com/cypress-io/cypress-example-circleci-orb"
/>
.
...
the [command line](/app/guides/command-line).
