...
<CypressCommandTabs command="run --reporter reporters/custom.js" />
...
<CypressCommandTabs command="run --reporter mochawesome" />
...
<CypressCommandTabs command='run --reporter junit --reporter-options "mochaFile=results/my-test-output.xml,toConsole=true"' />
...
<CypressCommandTabs command='run --reporter junit --reporter-options "mochaFile=results/my-test-output-[hash].xml"' />
...
<PackageManagerTabs
  install="cypress-multi-reporters mocha-junit-reporter"
  dev
/>
...
<CypressCommandTabs command="run --reporter cypress-multi-reporters --reporter-options configFile=reporter-config.json" />
...
<PackageManagerTabs
  install="mochawesome mochawesome-merge mochawesome-report-generator"
  dev
/>
...
<CypressCommandTabs command='run --reporter mochawesome --reporter-options reportDir="cypress/results",overwrite=false,html=false,json=true' />
...
<PackageManagerTabs run="mochawesome-merge cypress/results/*.json -o mochawesome.json" />
...
<PackageManagerTabs run="marge mochawesome.json" />
