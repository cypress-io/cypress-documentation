...
<strong>This is a brief overview</strong>
...
You can [check out the API docs here](/api/node-events/writing-a-plugin).
...
the [command line](/app/guides/command-line), or system environment
variables.
...
[Our curated list of Cypress plugins.](/plugins)
...
function in the [Cypress configuration](/app/references/configuration).
...
[Writing a Plugin](/api/node-events/writing-a-plugin) guide.
