...
When clicking on a file path or an [error](/app/guide/debugging#Errors) in
the [command log](/app/core-concepts/cypress-app#Command-Log), Cypress will
...
[installed Cypress](/app/getting-started/installing-cypress).
