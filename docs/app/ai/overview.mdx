...
This walkthrough follows an AI coding agent through the full agentic testing
loop with Cypress. Skills teach it to write Cypress tests, `cypress tap` lets it
build and verify them against a live session, the Cloud CLI triages failed CI
runs from the terminal, and Cloud MCP brings full run context, including UI
Coverage and Cypress Accessibility results, into your editor.

<DocsVideo
  src="https://www.youtube.com/embed/TD0u9ayqXXE"
  title="Agentic Testing with Cypress: Turn Your AI Agent Into a Testing Teammate"
/>
