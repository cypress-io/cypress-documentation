...
<PackageManagerTabs exec="skills update" />

The update check only tracks project-level installs, not global ones.
...
- **[Run Cypress tests from your AI agent](/app/tooling/cypress-tap)**: Let your agent run, watch, and
  debug the tests it writes against a live Cypress session.
