...
sidebar_position: 30
slug: /app/guides/cypress-studio
e2eSpecific: true
---
...
## AI smart recommendations :sparkles: {#AI-smart-recommendations}
...
For full details on how Cypress handles data and AI model security, see the [Security & Compliance page](https://www.cypress.io/security?utm_source=docs.cypress.io&utm_medium=cypress-studio).
...
- [Cypress Cloud plans](https://www.cypress.io/pricing?utm_source=docs.cypress.io&utm_medium=cypress-studio)
- [Security & Compliance](https://www.cypress.io/security?utm_source=docs.cypress.io&utm_medium=cypress-studio)
