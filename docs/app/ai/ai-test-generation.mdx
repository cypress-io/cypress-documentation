---
title: 'Generate tests with cy.prompt'
...
sidebar_label: Generate tests with cy.prompt
sidebar_position: 40
slug: /app/guides/ai-test-generation
e2eSpecific: true
---

<ProductHeading product="cloud" />

# Generate tests with cy.prompt
...
For detailed information about how Cypress protects your data and manages AI model security, see our [Security & Compliance page](https://www.cypress.io/security?utm_source=docs.cypress.io&utm_medium=ai-test-generation).
