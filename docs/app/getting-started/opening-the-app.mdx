...
script of the same name instead and [Cypress CLI commands](/app/guides/command-line) may not work as expected.
...
You can [read more about the CLI here](/app/guides/command-line).
...
<DocsImage
  src="/img/app/getting-started/opening-the-app/choose-testing-type.png"
...
<DocsImage
  src="/img/app/getting-started/opening-the-app/scaffolded-files.png"
...
<DocsImage
  src="/img/app/getting-started/opening-the-app/select-browser.png"
...
[to try Component Testing, go here](/app/component-testing/overview).
