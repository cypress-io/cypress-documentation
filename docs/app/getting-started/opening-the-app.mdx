...
script of the same name instead and [Cypress CLI commands](/app/guide/command-line) may not work as expected.
...
You can [read more about the CLI here](/app/guide/command-line).
...
[our guide on launching browsers](/app/guide/launching-browsers). Again,
