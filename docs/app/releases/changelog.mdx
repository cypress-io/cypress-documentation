...
`Cypress.env()` is now deprecated and will be removed in a future major release of Cypress. To understand why, and how to migrate, please read our [Migration Guide](https://on.cypress.io/cypress-env-migration). Addressed in [#33181](https://github.com/cypress-io/cypress/pull/33181).
...
- Easily debug failed CI test runs recorded to the Cypress Cloud from your local
  Cypress app with the new Debug page. Please leave any feedback in the
...
- Added new
  ...
  experienced "Out of Memory" issues. Please leave any feedback in the
...
- Re-implemented the 'Run All Specs' for End to End Testing for running multiple
  ...
  [`experimentalRunAllSpecs`](/app/references/experiments#End-to-End-Testing).
  Please leave any feedback in the
...
- During `cypress open`, the ability to "Run all specs" and "Run filtered specs"
  has been removed. Please leave feedback about the removal in the
  ['Run all specs' discussion](https://github.com/cypress-io/cypress/discussions/21628).
  Your feedback will help us make product decisions around the future of this
  feature.
