...
[Command Log](/app/core-concepts/cypress-app#Command-Log).
...
the command in the [Command Log](/app/core-concepts/cypress-app#Command-Log).
...
When you use the [Command Log](/app/core-concepts/cypress-app#Command-Log) to
