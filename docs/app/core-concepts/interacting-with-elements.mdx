...
- It is positioned fully outside of the browser viewport
  - _this is a compatibility issue with the legacy visibility algorithm_ when it comes to asserting visibility. Scroll elements into view before asserting on their visibility.
- It is fully covered by another element
