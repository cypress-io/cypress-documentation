...
[Cypress Cloud](/app/cloud/introduction), you'll see data from your latest
...
[recorded](/app/cloud/getting-started#Set-up-a-project-to-record).
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/the-launchpad.png"
  alt="The Launchpad"
/>
...
[you can run `cypress open` with the `--browser` and `--component` or `--e2e` options](/app/guide/command-line#cypress-open)
to go straight to the Specs page.

### Specs

<DocsImage
  src="/img/app/core-concepts/cypress-app/spec-explorer.png"
  alt="Specs"
/>
...
A test is considered to be [flaky](/app/cloud/flaky-test-management) when it
...
<DocsImage src="/img/app/core-concepts/cypress-app/spec-page.png" alt="Specs" />
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/recorded-runs.jpg"
  alt="Recorded Runs"
/>

This screen shows detailed information about the most recently recorded
[test runs](/app/cloud/recorded-runs#Latest-Runs) to Cypress Cloud, showing
the latest first.

Cypress uses Git to show runs for your branch. Ensure that version control is
properly configured and that you are sending Git information to Cypress Cloud.
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/debug-page.png"
  alt="Debug"
/>
...
[Test Replay](/app/cloud/test-replay) and other artifacts like screenshots,
videos, and logs from your tests.

The Debug page shows the latest completed
[test run](/app/cloud/recorded-runs#Latest-Runs) that matches the `HEAD` commit
...
information using
[custom environment variables](/app/continuous-integration/introduction#Git-information).

### Cloud Run Notifications

<DocsImage
  src="/img/app/cloud/runs/app-notification.jpg"
  alt="App notification on macOS"
/>

You can receive notifications in the Cypress app for recorded runs directly from
Cypress Cloud. Learn more about [Cloud Run Notifications](/app/cloud/recorded-runs#Notifications).
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/test-runner.png"
  alt="The Test Runner"
/>
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/command-log.png"
  alt="Cypress app"
  width-600
/>
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/open-file-in-IDE.gif"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/first-test-hover-contains.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/first-test-url-revert.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/first-test-click-revert.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/first-test-page-load.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/instrument-panel-routes.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/instrument-panel-stubs.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/instrument-panel-spies.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/application-under-test.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/viewport-scaling.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/aut-error-e2e.png"
  alt="Errors"
/>
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/viewport-scaling-ct.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/aut-error-ct.png"
...
[Cypress Studio](/app/references/cypress-studio) to record your browser
interactions.
...
<strong>This is configurable</strong>
...
Please read our
[Best Practices guide](/app/references/best-practices#Selecting-Elements) on
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/open-selector-playground.gif"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/copy-selector-in-selector-playground.gif"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/typing-a-selector-to-find-in-playground.gif"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/cy-contains-in-selector-playground.gif"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/turn-off-highlight-in-selector-playground.gif"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/keyboard-shortcuts.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/first-test-console-output.png"
...
<DocsImage
  src="/img/app/core-concepts/cypress-app/first-test-paused.png"
...
| Version                                  | Changes                             |
| ---------------------------------------- | ----------------------------------- |
| [3.5.0](/app/references/changelog#3-5-0) | Added keyboard shortcuts to Cypress |
| [1.3.0](/app/references/changelog#1-3-0) | Added Selector Playground           |
