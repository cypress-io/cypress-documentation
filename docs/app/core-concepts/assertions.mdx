...
sidebar_position: 40
slug: /app/references/assertions
---
...
If you're looking to understand **how** to use these assertions, read
...
entire list of available [BDD Chai assertions](http://chaijs.com/api/bdd/).
...
All chained assertions will use the same reference to the original
