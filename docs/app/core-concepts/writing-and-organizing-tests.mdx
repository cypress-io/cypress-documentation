...
Replay the test as it executed during the recorded run with full debug capability using [<Logo src="/img/cloud/features/test-replay/replay-icon.svg" /> Test Replay](/cloud/features/test-replay).
