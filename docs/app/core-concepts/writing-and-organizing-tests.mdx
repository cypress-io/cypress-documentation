...
Spec files are where your tests live. By default they're located in
`cypress/e2e`, but you can [configure](/app/references/configuration#e2e) a
different directory. To make adoption easy, Cypress lets you write specs in
whichever flavor of JavaScript your team already uses:
