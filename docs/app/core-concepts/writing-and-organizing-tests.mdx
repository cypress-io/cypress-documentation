...
So a file named `cypress/e2e/login.js` is **not** picked up by default. It
...
only to end-to-end testing. It is not a configurable option for component
...
Cypress watches your entire project root for spec files, not just the
