...
When running in using [cypress open](/app/guides/command-line#cypress-open),
...
- [cypress.env.json](/app/guides/environment-variables)
...
[cypress open](/app/guides/command-line#cypress-open).
