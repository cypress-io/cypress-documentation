...
slug: /app/references/trade-offs
e2eSpecific: true
---
...
[`cy.task()`](/api/commands/task) or [`cy.request()`](/api/commands/request)
...
the entire environment to test collaboration with 100% coverage**.
