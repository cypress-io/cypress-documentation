...
This automatic retrying makes Cypress immune to dozens of timing problems.
Consider all the reasons a query for a DOM element might fail at the exact moment
you run it:
...
Without automatic retrying, you'd have to defend against every one of these by
hand, with a brittle mashup of arbitrary waits, conditional retries, and null
checks littering your tests. With built-in retrying and
