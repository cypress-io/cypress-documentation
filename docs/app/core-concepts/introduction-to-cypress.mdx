...
[customizable timeouts](#Timeouts), Cypress handles much of this for you, helping
keep these common sources of flake out of your tests.
...
In Cypress, assertions **automatically retry**. Think of them as **guards**: you
describe what your application _should_ look like, and Cypress will **block,
wait, and retry** until it reaches that state, or fail the test if it never does.
