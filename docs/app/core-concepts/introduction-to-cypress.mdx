...
_eventually_ passes, or it fails—and when it fails, the remaining commands don't
...
non-deterministic tests—different runs behaving differently, which undermines the
