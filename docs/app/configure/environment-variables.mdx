...
sidebar_label: Environment variables and secrets
sidebar_position: 20
slug: /app/guides/environment-variables
---
...
and [`CYPRESS_PROJECT_ID`](/cloud/account-management/projects#Project-ID) are
