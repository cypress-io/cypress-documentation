...
| `execTimeout` <Badge type="caution">deprecated</Badge> | `60000` | Time, in milliseconds, to wait for a system command to finish executing during a [`cy.exec()`](/api/commands/exec) command. Deprecated in Cypress `15.21.0` along with `cy.exec()`. Use `taskTimeout` with [`cy.task()`](/api/commands/task) instead.                                                                                                                                                                                                                                                |
...
- `execTimeout` <Badge type="caution">deprecated</Badge>
- `includeShadowDom`
- `keystrokeDelay`
...
| [15.21.0](/app/references/changelog#15-21-0) | Deprecated `execTimeout` alongside [`cy.exec()`](/api/commands/exec). Use `taskTimeout` with [`cy.task()`](/api/commands/task) instead.                                         |
