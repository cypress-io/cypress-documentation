...
<DocsImage
  src="/img/accessibility/reports/element-detail-view.png"
...
<DocsImage
  src="/img/accessibility/reports/element-detail-solutions.png"
...
<DocsImage
  src="/img/accessibility/reports/element-detail-devtools.png"
  alt="The violation detail view with Chrome DevTools open beneath it. The Elements panel shows the highlighted markup for the pinned selector, an anchor with role='menuitem' and a data-cy attribute matching the element named in the rules list above, with its computed styles in the Styles pane."
  caption="The snapshot is real DOM, so DevTools inspects it like any other page. Print to Console followed by Reveal in Elements panel jumps straight to the failing element."
/>
...
<DocsImage
  src="/img/accessibility/reports/element-detail-missing-element.png"
  width="60%"
  alt="A dimmed DOM snapshot overlaid with the Cypress logo, the heading 'Element is not in this snapshot', the line 'Click to change to a snapshot containing this element.', and a chip naming the hovered element, #password."
/>
...
<DocsImage
  src="/img/accessibility/reports/element-detail-filter-menu.png"
  width="100%"
...
<DocsImage
  src="/img/accessibility/reports/element-detail-share-issue.png"
