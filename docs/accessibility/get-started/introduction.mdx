...
<ul class="guidesList">
  ...
  <li class="card">
    ...
    >
      ...
      <div class="card__title" id="card-title-2">Maintain Accessibility</div>
      <p>
  ...
  <li class="card">
    ...
    >
      ...
      <div class="card__title" id="card-title-4">Feedback during local development</div>
      <p>
  ...
  <li class="card">
    ...
    >
      ...
      <div class="card__title" id="card-title-6">Maximize coverage</div>
      <p>
