...
- **Flexible pipeline integration**: The [Results API](/accessibility/connect-and-extend/results-api) delivers accessibility outcomes to your CI pipeline, so your workflow can branch on them and enforce accessibility policies programmatically.
