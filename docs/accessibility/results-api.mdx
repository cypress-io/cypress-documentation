...
See the [related guide](/accessibility/guides/block-pull-requests) for a higher level examples of what it looks like to use the Results API to set a policy and fail a pull request.
