...
- [Azure](/app/continuous-integration/ci-provider-examples#Azure-Pipelines) (requires Cypress v13.13.1)
...
- [Jenkins](/app/continuous-integration/ci-provider-examples#Jenkins)
...
getAccessibilityResults({
  ...
  if (total > 0) {
    ...
    console.log(
      `${total} Accessibility violations were detected - ${critical} critical, ${serious} serious, ${moderate} moderate, and ${minor} minor.`
    )
...
2. Pass in the necessary [arguments](#arguments) to `getAccessibilityResults`.
