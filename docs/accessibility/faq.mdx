...
description: 'Get answers to common questions about Cypress Accessibility, including ignoring elements with elementFilters, the Ignored status, score impact, and configuration.'
sidebar_label: FAQ
