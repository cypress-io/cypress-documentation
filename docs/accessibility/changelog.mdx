...
## Week of 3/30/2026
- The [Cloud MCP](/cloud/integrations/cloud-mcp) now includes Accessibility tools, so your AI agents can query and act on Accessibility data directly. Review the [Accessibility in AI guide](/accessibility/guides/accessibility-in-agent) for an example workflow.
