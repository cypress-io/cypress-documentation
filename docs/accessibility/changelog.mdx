...
- Cypress Accessibility analytics have been expanded in [Enterprise Reporting](/cloud/features/analytics/enterprise-reporting), surfacing trends in rule failure counts, severity level of issues, and more. Get all the details in our guide, [Detect and Manage Changes](/accessibility/guides/detect-changes#Analytics).
...
- We now support fetching Accessibility results from Buildkite CI with the [Results API](/accessibility/guides/results-api).

## Week of Jan 16, 2026

- We've upgraded our axe-core version to [4.11.0](https://docs.deque.com/axe-release-impact/4.11.0/en/release-notes).
- We now support fetching Accessibility results from Bitbucket CI with the [Results API](/accessibility/guides/results-api).
...
- We now support fetching Accessibility results from Drone CI with the [Results API](/accessibility/guides/results-api).
...
- We now support fetching Accessibility results from AWS CodeBuild with the [Results API](/accessibility/guides/results-api).
...
- We now support fetching Accessibility results from CircleCI workflows with the [Results API](/accessibility/guides/results-api).

## Week of Jul 29, 2024

- Fetching results in Azure and Jenkins is now supported in the new [Results API](/accessibility/guides/results-api), which enables you to programmatically fetch your run's Accessibility results in a CI environment.

## Week of Jul 15, 2024

- The new [Results API](/accessibility/guides/results-api), which enables you to programmatically fetch your run's Accessibility results in a CI environment, now supports fetching results in GitLab CI workflows.

## Week of Jun 24, 2024

- We have added the new [Results API](/accessibility/guides/results-api) which enables you to programmatically fetch your run's Accessibility results in a CI environment. This allows you to review the results within CI and to determine if the results are acceptable or need to be addressed before code changes can merge.
