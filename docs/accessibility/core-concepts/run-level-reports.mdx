...
:::tip Query reports with Cloud MCP

If you have [Cloud MCP](/cloud/integrations/cloud-mcp) configured, your AI agent can query this same data directly—violation counts, failing rules, view rankings, and element-level failures—without leaving your editor.
