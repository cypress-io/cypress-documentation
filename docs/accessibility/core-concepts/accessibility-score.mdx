...
A 100% score isn't evidence that a WCAG success criterion is supported. See [Use results to inform a VPAT](/accessibility/guides/inform-a-vpat) for how to use a report in an accessibility conformance report.
...
Refer to the [Inspecting Violation Details section](/accessibility/reports/element-detail-view) for more information on understanding and addressing violations.
