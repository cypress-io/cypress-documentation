...
1. **Retrieving results**: Results are accessible via the [Results API](/accessibility/guides/results-api) for optional CI pipeline actions (e.g., failing builds based on unmet standards) and via Cloud MCP for agentic triage.
