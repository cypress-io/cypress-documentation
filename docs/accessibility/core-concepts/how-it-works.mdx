...
1. **Retreiving results**: Results are accessible via the [Results API](/accessibility/results-api) for optional CI pipeline actions (e.g., failing builds based on unmet standards) and via Cloud MCP for agentic triage.
