...
When you click on an element in the expanded Rule section, you have access to several actions that help you share and track accessibility violations.
...
To use the Create Jira issue feature, you must have the [Jira integration](/cloud/integrations/jira) installed and configured for your Cypress Cloud organization.
