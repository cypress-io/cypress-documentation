...
When several elements share the same test id or similar structure, require extra attributes (such as a component or slot name) in the **violation target selectors** shown in reports:
