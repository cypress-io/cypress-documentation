...
Good element identification makes element selectors more readable and meaningful when [reviewing violation details](/accessibility/reports/element-detail-view), and when [creating tickets](/accessibility/reports/element-detail-view#Create-Jira-issue), or having the selectors interpreted by AI tools (see the we [Work with AI agents](/accessibility/work-with-ai-agents))
