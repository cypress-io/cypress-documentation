...
If you have [Cloud MCP](/cloud/integrations/cloud-mcp) configured, you can ask your agent to pull violation details from Cypress Cloud and work through fixes for a specific rule:
