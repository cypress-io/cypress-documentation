...
Use Branch review when reviewing a pull request made by another developer or before you create your own. You can compare the report from your changed branch with the equivalent reports on the main branch. The diff allows you to see any issues that your changes have improved or fixed completely, as well as net-new issues introduced, and any new instances of existing failures.

Since this reduces the amount of violations to review to just what was affected by the PR code changes, you won't spend any time looking for what's relevant -- and if there is no diff, you'll know your PR does not affect the accessibility score.

#### Compare during local development (without waiting for CI)
...
#### Analytics 
The analytics for Cypress Accessibility are located within the Enterprise Reporting area of Cypress Cloud.
