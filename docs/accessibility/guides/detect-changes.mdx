...
- Run comparisons with [Branch Review](/accessibility/guides/compare-reports)
...
See the main [Accessibility Branch Review docs](/accessibility/guides/compare-reports) for a video demo of this workflow.
