...
<DocsImage
  ...
  width="75%"
  alt="Browser developer tools console showing a logged element line and an inline AI prompt labeled NEW that reads 'Write a comment to generate... add red borders to all the divs.' A context menu is open over the console output with 'Open in Elements panel' highlighted."
/>
