...
Eventually, the Cypress App will support displaying accessibility feedback during local development. For now, the important thing to note is: you do *not* need to push your changes and wait for your entire build process to complete.
...
(You can skip the `--key` option by setting `CYPRESS_RECORD_KEY` as an environment variable. Learn more about recording in our [docs about recorded runs](https://docs.cypress.io/guides/cloud/recorded-runs)).  
...
If you expect your team to do a lot of runs this way and that this would producing clutter in your main Cypress projects, you can set up a dedicated Cloud project for “locally generated” runs to keep things organized.
