...
description: 'Make Cypress Accessibility identify elements and build violation target selectors from your own HTML attributes, such as data-component or data-automation-id, by adding them to the priority list of significant attributes.'
