...
Cypress Accessibility organizes every report around **views**, the distinct pages and components of your application. Each view collects the [snapshots](/accessibility/reports/run-level-reports#Snapshots) captured on that page and reports the accessibility violations found there, so you review, score, and track each part of your app as a unit.
...
- [Views in accessibility reports](/accessibility/reports/run-level-reports#Views): how views organize your report and per-view score
