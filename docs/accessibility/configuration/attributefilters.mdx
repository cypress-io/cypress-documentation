...
- [`significantAttributes`](/accessibility/configuration/significantattributes): prioritize the attributes Cypress should prefer as identifiers — the complement to filtering out the ones it should ignore.
