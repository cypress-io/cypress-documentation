...
1. [Recording test results with the `--record` flag](https://on.cypress.io/how-do-i-record-runs)
   ...
   - [Integrating testing with the pull-request (PR) process](/guides/cloud/integrations/github-integration)
     via
     [commit status check guards](/guides/cloud/integrations/github-integration#Status-checks)
     and convenient
     [test report comments](/guides/cloud/integrations/github-integration#Pull-request-comments).
