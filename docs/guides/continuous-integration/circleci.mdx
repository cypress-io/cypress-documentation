...
is the _official_ CircleCI Orb of Cypress. Although you do not need to use the
...
run tests across 4 CI machines [in parallel](/guides/cloud/smart-orchestration/parallelization) may
have:
