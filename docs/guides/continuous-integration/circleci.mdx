...
#### Example `.circleci/config.yml` v2 config file {#Example-circleciconfigyml-v2-config-file}
...
#### Example `.circleci/config.yml` v2 config file with `yarn` {#Example-circleciconfigyml-v2-config-file-with-yarn}
