...
built with Google Chrome `107`. This allows us to specify a browser version
without any influence due to browser version changes in the GitHub runner image.
...
systems are available in the **Cypress Real World App**.
