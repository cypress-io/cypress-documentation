...
For Yarn and npm, the Cypress GitHub Action will automatically cache and restore your Node
dependencies for you. The Cypress Github Action does not do any caching for pnpm, and
[advises not to use any caching of any form](https://github.com/cypress-io/github-action?tab=readme-ov-file#pnpm).
