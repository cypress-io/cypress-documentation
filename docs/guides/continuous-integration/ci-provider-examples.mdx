...
<Icon
  name="book"
  color="gray"
  url="/guides/continuous-integration/circleci"
  callout="CircleCI Guide"
/><br />
<Icon
  name="external-link-alt"
  color="gray"
  url="https://dashboard.cypress.io/projects/7s5okt"
  callout="See CircleCI + Cypress Dashboard in action"
/><br /> <br />

:::info

### <Icon name="graduation-cap" /> Real World Example <Badge type="success">New</Badge> {#Icon-namegraduation-cap--Real-World-Example-Badge-typesuccessNewBadge}
...
<Icon
  name="book"
  color="gray"
  url="/guides/continuous-integration/github-actions"
...
<Icon
  ...
  callout="See GitHub Actions + Cypress Dashboard in action"
/><br /> <br />

:::info

### <Icon name="graduation-cap" /> Real World Example <Badge type="success">New</Badge> {#Icon-namegraduation-cap--Real-World-Example-Badge-typesuccessNewBadge-1}
...
<Icon
  name="book"
  color="gray"
  url="/guides/continuous-integration/bitbucket-pipelines"
...
<Icon
  ...
  callout="See BitBucket Pipelines + Cypress Dashboard in action"
/>
<br /> <br />

:::info

### <Icon name="graduation-cap" /> Real World Example <Badge type="success">New</Badge> {#Icon-namegraduation-cap--Real-World-Example-Badge-typesuccessNewBadge-2}
...
<Icon
  name="book"
  color="gray"
  url="/guides/continuous-integration/gitlab-ci"
  callout="GitLab CI Guide"
/>
<br />
<Icon
  name="external-link-alt"
  ...
  callout="See GitLab CI + Cypress Dashboard in action"
/>
<br /> <br />

:::info

### <Icon name="graduation-cap" /> Real World Example <Badge type="success">New</Badge> {#Icon-namegraduation-cap--Real-World-Example-Badge-typesuccessNewBadge-3}
...
<Icon
  name="book"
  color="gray"
  url="/guides/continuous-integration/aws-codebuild"
...
<Icon
  ...
  callout="See AWS CodeBuild + Cypress Dashboard in action"
/>
<br /> <br />

:::info

### <Icon name="graduation-cap" /> Real World Example <Badge type="success">New</Badge> {#Icon-namegraduation-cap--Real-World-Example-Badge-typesuccessNewBadge-4}
