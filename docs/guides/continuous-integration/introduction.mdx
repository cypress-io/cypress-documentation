...
to protect your Record Key. [Learn why.](/guides/cloud/account-management/projects#Identification)
...
[GitHub Integration](/guides/cloud/integrations/source-control/github) or other tasks might not
