...
1. [Set up your project to record](/guides/cloud/getting-started#Setup)
...
[Read the full guide on parallelization.](/guides/cloud/smart-orchestration/parallelization)
...
- If you are using `pnpm` and Github Actions, **do not cache anything** across builds.
  The Cypress Github Action [does not support](https://github.com/cypress-io/github-action/issues/1044)
  caching of any form, and caching pnpm packages between builds will result in
...
[Learn why.](/guides/cloud/account-management/projects#Identification)
...
[GitHub Integration](/guides/cloud/integrations/source-control/github) or other
