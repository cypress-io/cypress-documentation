...
### Boot your server {#Boot-your-server}
...
#### Recording tests allow you to: {#Recording-tests-allow-you-to}
...
#### To record tests: {#To-record-tests}
...
### Official Cypress Docker Images {#Official-Cypress-Docker-Images}
...
#### Docker images & CI examples {#Docker-images--CI-examples}
...
#### We recommend users: {#We-recommend-users}
...
### Running headless tests without Xvfb {#Running-headless-tests-without-Xvfb}
