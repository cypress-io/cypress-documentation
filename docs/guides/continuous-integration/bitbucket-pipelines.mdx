...
[analytics](/guides/cloud/test-analytics/analytics) for Cypress tests.
...
1. [Recording test results with the `--record` flag](https://on.cypress.io/how-do-i-record-runs)
   ...
   - In-depth and shareable
     [test reports](/guides/cloud/test-analytics/project-health#Latest-Runs).
   ...
   - [Detecting flaky tests](/guides/cloud/test-analytics/flaky-test-management)
     and surfacing them via
     [Slack alerts](/guides/cloud/test-analytics/flaky-test-management#Slack) or
