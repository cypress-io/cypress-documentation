...
[parallelize and group test runs](/guides/cloud/smart-orchestration/parallelization) along with
additional insights and [analytics](/guides/cloud/test-analytics/analytics) for Cypress tests.
...
1. [Recording test results with the `--record` flag](https://on.cypress.io/how-do-i-record-runs)
   ...
   - In-depth and shareable [test reports](/guides/cloud/test-analytics/project-health#Latest-Runs).
   ...
   - [Integrating testing with the pull-request process](/guides/cloud/integrations/source-control/bitbucket)
     via
     [commit status check guards](/guides/cloud/integrations/source-control/bitbucket#Status-checks)
     and convenient
     [pull request comments](/guides/cloud/integrations/source-control/bitbucket#Pull-Request-comments).
   - [Detecting flaky tests](/guides/cloud/test-analytics/flaky-test-management) and surfacing
     them via [Slack alerts](/guides/cloud/test-analytics/flaky-test-management#Slack) or
     [Bitbucket PR status checks](/guides/cloud/integrations/source-control/bitbucket).

2. [Parallelizing test runs](/guides/cloud/smart-orchestration/parallelization) and optimizing
   their execution via
