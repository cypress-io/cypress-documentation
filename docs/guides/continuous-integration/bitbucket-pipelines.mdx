...
1. [Recording test results with the `--record` flag](https://on.cypress.io/how-do-i-record-runs)
   ...
   - [Integrating testing with the pull-request process](/guides/cloud/integrations/bitbucket)
     via
     [commit status check guards](/guides/cloud/integrations/bitbucket#Status-checks)
     and convenient
     [pull request comments](/guides/cloud/integrations/bitbucket#Pull-Request-comments).
   - [Detecting flaky tests](/guides/cloud/flaky-test-management) and surfacing
     ...
     [Bitbucket PR status checks](/guides/cloud/integrations/bitbucket).
