...
1. [Recording test results with the `--record` flag](https://on.cypress.io/how-do-i-record-runs)
   ...
   - [Integrating testing with the merge-request process](/guides/cloud/integrations/source-control/gitlab)
     via
     [commit status guards](/guides/cloud/integrations/source-control/gitlab#Commit-statuses)
     and convenient
     [test report comments](/guides/cloud/integrations/source-control/gitlab#Merge-Request-comments).
   - [Detecting flaky tests](/guides/cloud/test-analytics/flaky-test-management) and surfacing
     ...
     [GitLab PR status checks](/guides/cloud/integrations/source-control/gitlab).
