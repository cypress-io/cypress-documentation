...
1. [Recording test results with the `--record` flag](https://on.cypress.io/how-do-i-record-runs)
   ...
   - [Integrating testing with the merge-request process](/guides/cloud/integrations/gitlab-integration)
     via
     [commit status guards](/guides/cloud/integrations/gitlab-integration#Commit-statuses)
     and convenient
     [test report comments](/guides/cloud/integrations/gitlab-integration#Merge-Request-comments).
   - [Detecting flaky tests](/guides/cloud/flaky-test-management) and surfacing
     ...
     [GitLab PR status checks](/guides/cloud/integrations/gitlab-integration).
