...
## Programmatic Authentication with Amazon Cognito {#Programmatic-Authentication-with-Amazon-Cognito}
...
## Setting Amazon Cognito app credentials in Cypress {#Setting-Amazon-Cognito-app-credentials-in-Cypress}
...
## Custom Command for Amazon Cognito Authentication {#Custom-Command-for-Amazon-Cognito-Authentication}
...
## Adapting an Amazon Cognito App for Testing {#Adapting-an-Amazon-Cognito-App-for-Testing}
