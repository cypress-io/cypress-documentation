...
<strong>Why authenticate programmatically?</strong>
...
## Google Developer Console Setup {#Google-Developer-Console-Setup}
...
### Google Project and Application Setup {#Google-Project-and-Application-Setup}
...
### Using the Google OAuth 2.0 Playground to Create Testing Credentials {#Using-the-Google-OAuth-20-Playground-to-Create-Testing-Credentials}
...
## Setting Google app credentials in Cypress {#Setting-Google-app-credentials-in-Cypress}
...
## Custom Command for Google Authentication {#Custom-Command-for-Google-Authentication}
...
## Adapting a Google App for Testing {#Adapting-a-Google-App-for-Testing}
...
### Adapting the back end {#Adapting-the-back-end}
...
### Adapting the front end {#Adapting-the-front-end}
