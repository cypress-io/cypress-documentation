...
## Okta Developer Console Setup {#Okta-Developer-Console-Setup}
...
## Setting Okta app credentials in Cypress {#Setting-Okta-app-credentials-in-Cypress}
...
## Custom Command for Okta Authentication {#Custom-Command-for-Okta-Authentication}
...
## Adapting an Okta App for Testing {#Adapting-an-Okta-App-for-Testing}
