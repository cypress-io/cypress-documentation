...
<DocsImage
  ...
  alt="The Cypress App with the Create new empty spec button highlighted"
></DocsImage>
...
<DocsImage
  ...
  alt="The Cypress App showing the spec list with the newly created spec"
></DocsImage>
...
<DocsImage
  ...
  alt="My first test shown passing in the Cypress App"
></DocsImage>
...
## Write a _real_ test {#Write-a-_real_-test}
...
### <Icon name="globe" /> Step 1: Visit a page {#Icon-nameglobe--Step-1-Visit-a-page}
...
<strong>Only Test Apps You Control</strong>
...
### <Icon name="search" /> Step 2: Query for an element {#Icon-namesearch--Step-2-Query-for-an-element}
...
### <Icon name="mouse-pointer" /> Step 3: Click an element {#Icon-namemouse-pointer--Step-3-Click-an-element}
...
### <Icon name="check-square" /> Step 4: Make an assertion {#Icon-namecheck-square--Step-4-Make-an-assertion}
...
#### Adding more commands and assertions {#Adding-more-commands-and-assertions}
...
3. _And they type "fake@email.com" into the `[data-testid="action-email"]` input_
4. _**Then** the URL should include `/commands/actions`_
5. _And the `[data-testid="action-email"]` input has "fake@email.com" as its value_
...
- Check out the <Icon name="github" inline="true" contentType="rwa" /> for practical demonstrations of Cypress testing practices, configuration, and
