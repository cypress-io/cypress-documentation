...
- Start [testing your app](/guides/end-to-end-testing/introduction/testing-your-app).
...
- Record your test results to [the Dashboard](/guides/dashboard/introduction) for advanced features like parallelization, flake detection, and more.
- Check out the <Icon name="github" inline="true" contentType="rwa" /> for practical demonstrations of Cypress testing practices, configuration, and strategies in a real-world project.
