...
## <Icon name="terminal" /> Step 1: Start your server {#Icon-nameterminal--Step-1-Start-your-server}
...
## <Icon name="globe" /> Step 2: Visit your server {#Icon-nameglobe--Step-2-Visit-your-server}
...
<DocsImage
  ...
  alt="Error in Cypress App showing cy.visit failed"
></DocsImage>

If you've started your server, then you should see your application loaded and
working.

## <Icon name="cogs" /> Step 3: Configure Cypress {#Icon-namecogs--Step-3-Configure-Cypress}
...
### Stubbing the server {#Stubbing-the-server}
...
#### Generate the fixture stubs ahead of time {#Generate-the-fixture-stubs-ahead-of-time}
...
#### Write a single e2e test without stubs, and then stub the rest {#Write-a-single-e2e-test-without-stubs-and-then-stub-the-rest}
...
#### Fully test the login flow -- but only once! {#Fully-test-the-login-flow----but-only-once}
...
#### Bypassing your UI {#Bypassing-your-UI}
...
- <Icon name="github" inline="true" contentType="rwa" /> demonstrations of Cypress testing practices, configuration, and strategies in a real-world project.
