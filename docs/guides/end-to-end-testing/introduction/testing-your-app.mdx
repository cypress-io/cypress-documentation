...
<strong>Use e2e folder instead of integration</strong>

In the video you can see the test files are located in the 'intergration' folder.
In the newest version of cypress you are not allowed to use 'cy.visit' on component testing.
So the correct folder would be the 'e2e' folder.
...
- [Cypress API](/api/commands/and) to learn what commands are available as you
  work
