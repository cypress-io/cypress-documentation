...
In the video you can see the test files are located in the 'intergration'
folder. In the newest version of cypress you are not allowed to use 'cy.visit'
on component testing. So the correct folder would be the 'e2e' folder.
