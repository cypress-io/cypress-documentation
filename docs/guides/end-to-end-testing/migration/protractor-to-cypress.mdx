...
To see how this conversion would work with some of your own test code, you can paste it into the interactive [Cypress Migrator tool](https://migrator.cypress.io/), which will generate the equivalent Cypress code.
