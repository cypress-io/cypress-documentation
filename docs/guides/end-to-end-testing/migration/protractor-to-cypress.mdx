...
## Benefits of Using Cypress {#Benefits-of-Using-Cypress}
...
### Interact with your tests in a browser {#Interact-with-your-tests-in-a-browser}
...
### Time travel through tests {#Time-travel-through-tests}
...
### Gain Visibility in Headless Mode with Screenshots and Videos {#Gain-Visibility-in-Headless-Mode-with-Screenshots-and-Videos}
...
### How to Get DOM Elements {#How-to-Get-DOM-Elements}

#### Getting a single element on the page {#Getting-a-single-element-on-the-page}
...
#### Getting multiple elements on a page {#Getting-multiple-elements-on-a-page}
...
### How to Interact with DOM Elements {#How-to-Interact-with-DOM-Elements}
...
## Navigating Websites {#Navigating-Websites}
...
## Automatic Retrying and Waiting {#Automatic-Retrying-and-Waiting}
...
## Cypress vs WebDriver Control Flow {#Cypress-vs-WebDriver-Control-Flow}
...
### Protractor without Page Objects {#Protractor-without-Page-Objects}
...
### Protractor with Page Objects {#Protractor-with-Page-Objects}
...
### Cypress without Page Objects {#Cypress-without-Page-Objects}
...
### Cypress with Page Objects {#Cypress-with-Page-Objects}
...
## Angular Schematic Configuration {#Angular-Schematic-Configuration}
...
### Running the builder with a specific browser {#Running-the-builder-with-a-specific-browser}
...
### Recording test results to the Cypress Dashboard {#Recording-test-results-to-the-Cypress-Dashboard}
...
### Specifying a custom Cypress configuration file {#Specifying-a-custom-Cypress-configuration-file}
...
### Running Cypress in parallel mode within CI {#Running-Cypress-in-parallel-mode-within-CI}
...
### Do I have to replace all of my tests with Cypress immediately? {#Do-I-have-to-replace-all-of-my-tests-with-Cypress-immediately}
...
### Can Protractor and Cypress coexist in the same app? {#Can-Protractor-and-Cypress-coexist-in-the-same-app}
