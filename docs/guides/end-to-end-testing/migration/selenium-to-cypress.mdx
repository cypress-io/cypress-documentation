...
to work against. After selecting a browser, Cypress will suggest creating an
example spec, or you can jump right into it.
...
<br />
<br />
If you've selected 'create an example spec', Cypress should immediately start
...
<br />
Another big change is, you no longer need any WebDriver definitions. Cypress takes
...
<br />- ##### [Parallelization](https://docs.cypress.io/guides/cloud/smart-orchestration/parallelization)
...
<br />- ##### [Analytics and Reporting](https://docs.cypress.io/guides/cloud/analytics)
