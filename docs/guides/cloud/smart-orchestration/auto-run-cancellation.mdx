...
Save on CI resources by automatically canceling a Cypress run upon the first test failure.
...
[recommendations](/guides/cloud/test-analytics/project-health#Recommendations)
on the run overview page to see how much time we predict these features would
save you.
