...
[recording](/guides/cloud/getting-started#Setup) within Continuous Integration. If you
...
[balance strategy](/guides/cloud/smart-orchestration/load-balancing#Balance-strategy). Due to this balance strategy, the run
...
[setup guide](/guides/cloud/getting-started#Setup).
...
via [load-balancing](/guides/cloud/smart-orchestration/load-balancing) of specs
...
4. Based on these estimations, Cypress distributes
   ([load-balances](/guides/cloud/smart-orchestration/load-balancing)) spec
...
[balance strategy](/guides/cloud/smart-orchestration/load-balancing#Balance-strategy) to order to specs to run based on the
...
[configurable within Cypress Cloud project settings page](/guides/cloud/account-management/projects#Run-completion-delay).
