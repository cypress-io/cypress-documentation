...
Reduce test duration by running multiple test spec files simultaneously across
...
[recording](/guides/cloud/getting-started#Setup) within Continuous Integration.
...
[load balance strategy](/guides/cloud/smart-orchestration/load-balancing#Balance-strategy)
