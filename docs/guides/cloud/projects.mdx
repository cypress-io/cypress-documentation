...
- &#8239;<Logo src="/img/logo/github.svg" /> [GitHub integration guide](/guides/cloud/integrations/github-integration)
- &#8239;<Logo src="/img/logo/gitlab.svg" /> [GitLab integration guide](/guides/cloud/integrations/gitlab-integration)
- &#8239;<Logo src="/img/logo/bitbucket.svg" /> [Bitbucket integration guide](/guides/cloud/integrations/bitbucket-integration)

### Project Management

- &#8239;<Logo src="/img/logo/jira.svg" /> [Jira integration guide](/guides/cloud/integrations/jira-integration)

### Messaging

- &#8239;<Logo src="/img/logo/slack.svg" /> [Cypress integration for Slack guide](/guides/cloud/integrations/slack-integration)
