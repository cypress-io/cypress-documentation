...
3. You will need to log in to record your tests, so you'll be prompted to log in
   ...
   <DocsImage
     src="/img/guides/cloud/projects/setup-a-project-1.png"
...
4. Choose who owns the project. You can personally own it or select an
   ...
   **Create organization**. Organizations work just like they do in GitHub and
   ...
   <DocsImage
     src="/img/guides/cloud/projects/setup-a-project-2.png"
...
- Choose whether this project is Public or Private.
  ...
  <DocsImage
    src="/img/guides/cloud/projects/setup-a-project-3.png"
...
6. Alternatively, if you've already created a project in Cypress Cloud, you can
   ...
   <DocsImage
     src="/img/guides/cloud/projects/setup-a-project-4.png"
...
8. Now you should see a view explaining how to record your first run with your
   record key.
   <DocsImage
     src="/img/guides/cloud/projects/setup-a-project-5.png"
...
<DocsImage
  src="/img/guides/cloud/projects/cloud-runs-list.png"
  alt="Cloud Screenshot"
/>

<DocsImage src="/img/guides/cloud/projects/runs-list-in-desktop-gui.png" alt="Runs List" />
...
<DocsImage
  src="/img/guides/cloud/projects/record-key-desktop-gui.png"
...
<DocsImage
  src="/img/guides/cloud/projects/run-completion-delay.png"
...
<DocsImage
  src="/img/guides/cloud/projects/cloud-badge-configuration 1.png"
...
You can integrate your project with many third party tools and edit those settings from within the project settings page.

See our integration guides to learn more:

### CI/CD
- [GitHub integration guide](/guides/cloud/github-integration)
- [GitLab integration guide](/guides/cloud/gitlab-integration)
- [Bitbucket integration guide](/guides/cloud/bitbucket-integration)

### Project Management
- [Jira integration guide](/guides/cloud/jira-integration)

### Messaging
- [Cypress Integration for Slack guide](/guides/cloud/slack-integration)
- Cypress Integration for **Microsoft Teams** guide (coming soon)
