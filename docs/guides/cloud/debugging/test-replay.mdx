...
Navigate to the [test detail sidebar](/guides/cloud/debugging/recorded-runs#Test-detail-sidebar) header or above each attempt in the errors panel.
...
The left side of the screen displays the familiar command log, where you can step through your test just like you would in the Cypress app.
...
Toggle each test attempt, play back the error at four different speeds or scrub through the error by dragging the playhead along the timeline.
