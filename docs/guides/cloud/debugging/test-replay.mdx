...
Test Replay is automatically enabled when updating to `v13` of Cypress and an opt out is provided through project-level settings. Learn about what this means for [capturing video](#See-also) in Cypress Cloud below.
...
Dig deeper into all network-level traffic, console logs and inspect the application under test just as you can in Chrome.
