...
### Run header
The left side of the header displays the test run # with the git branch name along with all of the test, platform and browser information
{/* <DocsImage
  src="/img/guides/cloud/test-replay/test-replay-header 1.jpg"
