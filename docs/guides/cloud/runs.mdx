...
[Specs](/guides/core-concepts/cypress-app#Specs) page while
...
The [Debug](/guides/core-concepts/cypress-app#Debug) page allows you to easily debug failed CI test runs from within the
Cypress app. From this page, you can review, rerun, and debug failed CI test
runs that are recorded to Cypress Cloud – all
