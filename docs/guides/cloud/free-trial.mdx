...
and simply revert to our _Starter_ plan. The _Starter_ plan is free, but does not have the same
...
that you are not allowed to [transfer](/guides/cloud/account-management/projects#Transfer-ownership)
...
[Why Cypress](/guides/overview/why-cypress) and
[Key Differences](/guides/overview/key-differences) which will help you on your journey
of [getting started](/guides/getting-started/installing-cypress) with Cypress. You can then write
your own Cypress tests or use the built-in [Cypress Studio](/guides/references/cypress-studio)
...
[Jira](/guides/cloud/integrations/jira), [GitHub](/guides/cloud/integrations/source-control/github),
[GitLab](/guides/cloud/integrations/source-control/gitlab),
[Bitbucket](/guides/cloud/integrations/source-control/bitbucket),
[Slack](/guides/cloud/integrations/slack), [Microsoft Teams](/guides/cloud/integrations/teams), and
[SSO](/guides/cloud/account-management/enterprise-sso) to streamline your development workflow.
...
Unlock a treasure trove of insights with our [advanced analytics](/guides/cloud/analytics/overview).
...
[Smart Orchestration](/guides/cloud/smart-orchestration/overview) capabilities.
Seamlessly [parallelize tests](/guides/cloud/smart-orchestration/parallelization) for faster
execution, [prioritize failed specs](/guides/cloud/smart-orchestration/spec-prioritization) to
address critical issues promptly, and automate
[test run cancellation](/guides/cloud/smart-orchestration/run-cancellation) based on custom
thresholds. Intelligent test coordination, powered by Cypress Cloud, ensures you get the most out
of your testing efforts.

Additionally, with Cypress 13, you can leverage [Test Replay](/guides/cloud/test-replay), our
interactive debugging tool, to swiftly troubleshoot and debug failed or flaky test runs as they
...
- [Flake Detection](/guides/cloud/flaky-test-management#Flake-Detection): Quickly identify and resolve
  flaky tests, ensuring reliable test results.
- [Smart Orchestration](/guides/cloud/smart-orchestration/overview): Enhance testing efficiency with
  features like [test parallelization](/guides/cloud/smart-orchestration/parallelization) and
  [automated run cancellation](/guides/cloud/smart-orchestration/run-cancellation) based on custom
  thresholds.
- [Single Sign-On (SSO)](/guides/cloud/account-management/enterprise-sso): Simplify and secure access
  for your team.
- Integrations for On-Prem Instances: Seamlessly integrate with your existing infrastructure.
- [Enterprise Reporting](/guides/cloud/analytics/enterprise-reporting): Spot trends and anomalies,
  track usage, and govern your overall test suites across all projects in your organization.
- [Data Extract API](/guides/cloud/integrations/data-extract-api): Automatically download and extract
...
navigation sidebar that helps you gain understanding of the features and capbilities of Cloud.

<DocsImage
  src="/img/guides/cloud/free-trial/trial-progress-bar.jpg"
...
<DocsImage
  src="/img/guides/cloud/free-trial/trial-ci-setup.jpg"
