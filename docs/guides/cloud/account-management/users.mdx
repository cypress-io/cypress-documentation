...
1. Select the [organization](//guides/cloud/account-management/organizations) you want to invite a
   user to.
...
Refer to our [Enterprise SSO Guide](/guides/cloud/account-management/enterprise-sso).
