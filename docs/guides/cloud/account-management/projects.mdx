...
Learn more about [Smart Orchestration](/guides/cloud/smart-orchestration/parallelization).
...
[organization](/guides/cloud/account-management/organizations) you are a part
of or to another user in the organization. Projects can only be transferred from
[Cypress Cloud](https://on.cypress.io/cloud).
