...
- **Private** means that only [users](/guides/cloud/account-management/users) you invite to your
  [organization](//guides/cloud/account-management/organizations) can see its recorded runs. Even if
...
[parallelization guide](/guides/cloud/smart-orchestration/parallelization#Run-completion-delay) to
learn more.
...
[organization](//guides/cloud/account-management/organizations) you are a part of or to another user
