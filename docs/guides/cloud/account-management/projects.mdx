...
There is a scenario where you may have Cypress tests in a repo separate from the application code itself. This creates a sub-optimal Cloud experience when considering the commit and branch interpretation of each git directory.
