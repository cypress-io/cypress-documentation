...
To support the community, we provide the Open Source Software (OSS) plan to take
advantage of an upgrade to include 5 users, 100k tests, parallelization with load balancing, and access to integrations. To qualify, all Projects in
