...
With our [Smart Orchestration](/guides/cloud/smart-orchestration/overview) features, you can run tests across a swarm of
machines simultaneously while Cypress Cloud coordinates runners and
