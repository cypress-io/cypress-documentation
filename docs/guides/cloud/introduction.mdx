...
[Latest Runs](/guides/cloud/test-analytics/project-health#Latest-Runs) page,
...
[cancel in-progress runs](/guides/cloud/test-analytics/project-health#Run-cancellation)
