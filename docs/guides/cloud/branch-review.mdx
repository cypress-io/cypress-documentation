...
The Cypress Cloud GitHub Integration offers detailed run information via [PR comments](/guides/cloud/integrations/source-control/github#Pull-request-comments). Follow the "View all changes introduced in this branch" link to load the Branch Review between the feature and base branches.
