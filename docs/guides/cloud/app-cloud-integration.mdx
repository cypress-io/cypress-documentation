...
The runs data is sourced from Cypress Cloud (see [note above](/guides/cloud/app-cloud-integration)) so it
...
[note above](/guides/cloud/app-cloud-integration)) so should be the same everywhere.
...
runs that are recorded to Cypress Cloud (see [note above](/guides/cloud/app-cloud-integration)) - all
