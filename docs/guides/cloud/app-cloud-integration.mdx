...
[test runs](/guides/cloud/test-analytics/runs#Latest-Runs) across all git
branches, latest first. This data comes from Cypress Cloud (see
...
[test run](/guides/cloud/test-analytics/runs#Latest-Runs) that matches the HEAD
commit (the commit currently checked out in the working directory) of your local
