...
This report allows you to retrieve the average, median, min and max durations of a run. This data is reported over time.
...
other tests that run less often. The flaky rate per project is calculated for the time period requested.
