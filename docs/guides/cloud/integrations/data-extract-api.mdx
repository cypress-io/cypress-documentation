...
- end_date. Optional and should be passed in either yyyy-MM-dd or yyyy-MM-ddTHH:mm:ss format.
  ...
  For example, `?end_date=2024-01-01` or `?end_date=2024-01-01T12%3A30%3A00`
...
### Cypress build versions per project over time
...
This report allows you to retrieve the average, median, min and max durations of a build. This data is reported over time.
...
- project_name
- build_count
- avg_pass_build_duration (average)
