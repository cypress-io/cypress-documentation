...
<DocsImage
  src="/img/guides/cloud/integrations/gitlab/gitlab-merge-request-comment.jpg"
  width={800}
/>
...
<DocsImage
  src="/img/guides/cloud/integrations/gitlab/gitlab-status-checks.jpg"
  width={800}
/>
...
<DocsImage
  src="/img/guides/cloud/integrations/gitlab/gitlab-merge-requests.jpg"
  width={800}
/>
