...
:::caution This installation method is not applicable to GitHub Enterprise. :::
...
:::info All current and <em>future</em> repositories will be included with this
...
:::info You can quickly get to a project's GitHub Integrations settings, by
clicking on the <strong>Configure</strong> link of the desired project within an
