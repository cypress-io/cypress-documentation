...
Cypress Cloud can provide alerts via [GitHub](/guides/cloud/integrations/github-integration)
and [Slack integrations](/guides/cloud/integrations/slack-integration), to further assist
