...
[GitHub](/guides/cloud/integrations/github-integration) and
[Slack integrations](/guides/cloud/integrations/slack-integration), to further
assist with staying on top of flake occurrences.
