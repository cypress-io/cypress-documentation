...
[Burn-in](/guides/references/experiments#Experimental-burn-in) (an experimental feature) _proactively_ checks for flake on new, modified, or previously failing or flaky tests, by retrying tests that meet these conditions.
