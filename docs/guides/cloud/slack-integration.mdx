...
The Cypress integration for Slack allows you to see your Cypress test results directly in your
...
In order to install the Cypress integration for Slack, you must be an admin or owner of both
...
For more information about how the Cypress integration for Slack collects and manages your information, please visit our [Privacy Policy](https://on.cypress.io/privacy-policy).
...
1. Navigate to the **Integrations** page for the organization with the installed integration.
1. Within the Cypress integration for Slack, click **Configure**.
...
You can completely remove the Cypress integration for Slack from your workspace. This will
...
be able to install the Cypress integration for Slack again in the future.

1. Navigate to the **Integrations** page for the organization with the installed integration.
1. Within the Slack Integration, click **Configure**.
1. Click **Uninstall Slack Integration** to uninstall the Cypress integration for Slack.
