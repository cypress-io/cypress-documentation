...
Cypress offers an option to hide the Cypress Command Log from screenshots so that no information from that area will be captured in screenshots. [See docs](/api/commands/screenshot#Arguments).
