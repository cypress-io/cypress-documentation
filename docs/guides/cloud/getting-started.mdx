...
4. Choose who owns the project. You can personally own it or select an
   ...
   **Manage organizations**. Organizations work just like they do in GitHub and
   ...
   [Read more about organizations](//guides/cloud/account-management/organizations).
   <DocsImage
...
See more about [Public-vs-Private project settings](/guides/cloud/account-management/projects#Public-vs-Private).
