...
Updates to email addresses requires an **Owner** or **Admin** role.

To change a user email, invite the new user/email address and delete the
previous user/email address.
