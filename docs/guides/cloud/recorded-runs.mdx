...
systems used, the Cypress version, and what [Smart Orchestration](/guides/cloud/smart-orchestration/overview) settings were
active.
...
recommendations for improving the performance of your test suite. Our [Smart Orchestration](/guides/cloud/smart-orchestration/overview) features can help you run fewer, more relevant, and faster tests,
depending on the details of your test suite.
