...
via [load-balancing](/guides/cloud/features/smart-orchestration/load-balancing) of specs across available CI machines by
...
4. Based on these estimations, Cypress distributes
   ([load-balances](/guides/cloud/features/smart-orchestration/load-balancing)) spec files one-by-one to each available
