...
3. Go to the **Billing & Usage** page, and then click on the **Apply for an open source plan** link at the bottom of the page. *Access to all Projects must be set to **public** to enable this link.
