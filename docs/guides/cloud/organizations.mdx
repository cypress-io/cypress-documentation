...
Organizations are used to group and manage access to projects.
...
- [BitBucket](/guides/cloud/integrations/bitbucket)
- [GitHub](/guides/cloud/integrations/github)
- [GitLab](/guides/cloud/integrations/gitlab)
- [Jira](/guides/cloud/integrations/jira)
- [Slack](/guides/cloud/integrations/slack)
