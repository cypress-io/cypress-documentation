...
[Smart Orchestration](/guides/cloud/smart-orchestration/parallelization) settings were active.

At the right of the header are a set of indicators showing the number of
[flaky](/guides/cloud/test-analytics/flaky-test-management), skipped, pending,
passed, and failed tests in this run. Clicking any of these takes you to the
...
[Smart Orchestration](/guides/cloud/smart-orchestration/parallelization) features can help you
...
or [flaky tests](/guides/cloud/test-analytics/flaky-test-management).
...
- If you have Analytics enabled, canceled runs will appear in the
  [Runs over time](/guides/cloud/test-analytics/analytics#Run-status) chart.
...
- The archived run will no longer display in the runs list or
  [Analytics](/guides/cloud/test-analytics/analytics) reporting.
