...
To import component in a slot, you can pass a string to call you're component with props and add component option with your component.
...
describe('<DefaultSlot />', () => {
  it('renders', () => {
    cy.mount(DefaultSlot, {
      ...
      slots: {
        default: '<AnotherSlot label="Hello" />',
      },
    })
    cy.get('div.content').should('have.text', 'Hello there!')
  })
