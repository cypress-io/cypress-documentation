...
## Configuring Component Testing {#Configuring-Component-Testing}
...
<DocsImage src="/img/guides/component-testing/project-setup-vue.png" caption="">
  {' '}
</DocsImage>
...
Next, we will learn to mount the `<Stepper />` component with the `cy.mount()` command!
