...
## What is the Mount Function? {#What-is-the-Mount-Function}
...
### Using `cy.mount()` Anywhere {#Using-cymount-Anywhere}
...
### Your First Component Test {#Your-First-Component-Test}
...
### Optional JSX Support {#Optional-JSX-Support}
...
## Cypress and Testing Library {#Cypress-and-Testing-Library}
...
<NavGuide
  prev="/guides/component-testing/quickstart-vue"
  next="/guides/component-testing/testing-vue"
/>
