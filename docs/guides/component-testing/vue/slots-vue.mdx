...
## The Simplest Slot {#The-Simplest-Slot}
...
>
  ...
  >
    <div>Modal's body content (passed in via slot)</div>
  </div>
</div>

<Tabs>
<TabItem value="Test" active>
...
>
  ...
  >
    <div style={{ fontSize: '1.25rem' }}>Header Content</div>
    <hr />
    <div style={{ flexGrow: 1 }}>Modal's body content (passed in via slot)</div>
    <hr />
    <div
      style={{
        bottom: 0,
