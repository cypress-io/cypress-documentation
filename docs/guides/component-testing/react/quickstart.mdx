...
<DocsImage 
  src="/img/guides/component-testing/create-your-first-spec.jpg" />
...
<DocsImage 
  src="/img/guides/component-testing/first-test-run-react.jpg" />
...
purposes. Update the test to use a Cepper.cy.jsx" active>
...
Let's set up the spies and bind themepper.cy.jsx" active>
