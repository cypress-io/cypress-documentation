...
:::info
This feature is only available from Cypress 12.7.
:::


Cypress ships official support for many popular libraries and frameworks, such as [React](/guides/component-testing/react/overview) and [Angular](/guides/component-testing/angular/overview). We constantly monitor what libraries developers are interested in and are always open to adding new ones to Cypress.
...
When a user configures Component Testing with your Framework Definition, their `supportFile` will contain the correct `mount` function:
