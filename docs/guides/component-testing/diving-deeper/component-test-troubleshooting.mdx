...
### Spec File Doesn't Appear in the Cypress App {#Spec-File-Doesnt-Appear-in-the-Cypress-App}
...
### ESLint Global Errors {#ESLint-Global-Errors}
...
### The TypeScript Types for `cy.mount` is Not Working in Component Tests {#The-TypeScript-Types-for-cymount-is-Not-Working-in-Component-Tests}
...
### Cypress Types Conflict with Jest {#Cypress-Types-Conflict-with-Jest}
...
### Next.js Global Style Error {#Nextjs-Global-Style-Error}
...
See our <Icon inline="true" name="github" callout="example Next.js application" url="https://github.com/cypress-io/cypress-component-testing-apps/blob/main/react-next12-ts/next.config.js" /> for a demonstration of this configuration.
