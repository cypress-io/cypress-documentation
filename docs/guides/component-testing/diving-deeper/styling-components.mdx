...
## Component Support File {#Component-Support-File}
...
## 3rd Party CSS Libraries (Tailwind, Bootstrap, PopperJS) {#3rd-Party-CSS-Libraries-Tailwind-Bootstrap-PopperJS}
...
## Why Test Your Component's Styles? {#Why-Test-Your-Components-Styles}
...
## Rules for Setting Up Your Styles {#Rules-for-Setting-Up-Your-Styles}
...
### Global App Styles {#Global-App-Styles}
...
### CSS Reset or Normalize isn't applied {#CSS-Reset-or-Normalize-isnt-applied}

Are you importing your normalize file within
`cypress/support/component-index.html` or within `cypress/support/component.js`?

### Fonts: Everything is rendering in Times New Roman {#Fonts-Everything-is-rendering-in-Times-New-Roman}
...
### Icon Fonts: None of my icons are rendering {#Icon-Fonts-None-of-my-icons-are-rendering}

### Theme Providers: My components don't look right/compile because they can't access providers {#Theme-Providers-My-components-dont-look-rightcompile-because-they-cant-access-providers}
