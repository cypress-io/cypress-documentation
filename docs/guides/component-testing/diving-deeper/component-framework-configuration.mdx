...
### Automatic Configuration Setup {#Automatic-Configuration-Setup}
...
#### Sample Create React Apps {#Sample-Create-React-Apps}
...
#### Next.js Caveats {#Nextjs-Caveats}
...
#### Sample Next.js Apps {#Sample-Nextjs-Apps}
...
#### Sample React Vite Apps {#Sample-React-Vite-Apps}
...
#### Sample React Webpack Apps {#Sample-React-Webpack-Apps}
...
#### Sample Vue CLI Apps {#Sample-Vue-CLI-Apps}
...
#### Nuxt Sample Apps {#Nuxt-Sample-Apps}
...
#### Vue Vite Sample Apps {#Vue-Vite-Sample-Apps}
...
### Custom Index File {#Custom-Index-File}
...
### Spec Pattern for Component Tests {#Spec-Pattern-for-Component-Tests}
