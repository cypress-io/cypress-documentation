...
Standalone Components provide the Angular compiler with everything it needs to compile through it's [`@Component()`](https://angular.io/api/core/Component) decorator.
