---
title: Component Testing Cypress | Browser-Based | [Learn How]
sidebar_position: 10
sidebar_label: Overview
description:
  Quickly build and test components with multiple front-end UI libraries — no
  matter how simple or complex - with Cypress Component Testing. Learn how.
---
...
## Why Component Testing with Cypress?
...
We cover the
[differences between component and end-to-end testing](/guides/core-concepts/testing-types)
in-depth.
...
Check out the [Component Driven](https://componentdriven.org) organization,
which talks about the pros of component-driven development and may aid you when
trying to figure out if you should be taking a page-based or component-based
approach to building and testing a given feature.

## Transform how you perform component testing with Cypress in CI

Cypress Cloud unlocks the full potential of Cypress test automation tools in
your CI pipeline. Scale every facet of Cypress testing, and push your code with
confidence every time.
[Create your free Cypress Cloud account today](https://on.cypress.io/set-up-billing).
