...
a ([group](/guides/cloud/smart-orchestration/parallelization#Grouping-test-runs)) named `chrome`.
...
[group](/guides/cloud/smart-orchestration/parallelization#Grouping-test-runs) basis, where test
