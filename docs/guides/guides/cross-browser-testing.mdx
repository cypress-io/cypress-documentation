...
## Continuous Integration Strategies {#Continuous-Integration-Strategies}
...
### Subset of Tests {#Subset-of-Tests}
...
### Parallelize per browser {#Parallelize-per-browser}
...
### Running Specific Tests by Browser {#Running-Specific-Tests-by-Browser}
