...
## Splitting up your test suite {#Splitting-up-your-test-suite}
...
## Turning on parallelization {#Turning-on-parallelization}
...
## CI parallelization interactions {#CI-parallelization-interactions}
...
### Spec duration history analysis {#Spec-duration-history-analysis}
...
### Without parallelization {#Without-parallelization}
...
### With parallelization {#With-parallelization}
...
## Grouping test runs {#Grouping-test-runs}
...
### Grouping by browser {#Grouping-by-browser}
...
### Grouping to label parallelization {#Grouping-to-label-parallelization}
...
### Grouping by spec context {#Grouping-by-spec-context}
...
## Linking CI machines for parallelization or grouping {#Linking-CI-machines-for-parallelization-or-grouping}
...
### CI Build ID environment variables by provider {#CI-Build-ID-environment-variables-by-provider}
...
## Run completion delay {#Run-completion-delay}
...
## Visualizing parallelization and groups in the Dashboard {#Visualizing-parallelization-and-groups-in-the-Dashboard}
