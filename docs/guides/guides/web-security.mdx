...
#### Examples of what Cypress does under the hood: {#Examples-of-what-Cypress-does-under-the-hood}
...
### Same superdomain per test {#Same-superdomain-per-test}
...
#### Examples of test cases that will error due to superdomain limitations {#Examples-of-test-cases-that-will-error-due-to-superdomain-limitations}
...
#### Examples of uses for cross-origin iframes {#Examples-of-uses-for-cross-origin-iframes}
...
#### Example of accessing insecure content {#Example-of-accessing-insecure-content}
...
### Same port per test {#Same-port-per-test}
...
## Disabling Web Security {#Disabling-Web-Security}
...
### Set `chromeWebSecurity` to `false` {#Set-chromeWebSecurity-to-false}
...
#### Set `chromeWebSecurity` to `false` in the [Cypress configuration](/guides/references/configuration) {#Set-chromeWebSecurity-to-false-in-the-Cypress-configuration}
