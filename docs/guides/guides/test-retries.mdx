...
For more reliable and proactive detection of flake, it's recommended to use [test burn-in](/guides/references/experiments#Experimental-burn-in), an experimental Flake Detection feature.
