...
#### You can also launch Electron headed: {#You-can-also-launch-Electron-headed}
...
### Chrome Browsers {#Chrome-Browsers}
...
### Launching by a path {#Launching-by-a-path}
...
### Customize available browsers {#Customize-available-browsers}
...
### Disabled Barriers {#Disabled-Barriers}
...
#### The Cypress launched browser automatically: {#The-Cypress-launched-browser-automatically}
