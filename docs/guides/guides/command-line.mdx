...
#### `cypress run --browser <browser-name-or-path>` {#cypress-run---browser-browser-name-or-path}
...
#### `cypress run --ci-build-id <id>` {#cypress-run---ci-build-id-id}
...
#### `cypress run --config <config>` {#cypress-run---config-config}
...
[viewport](/guides/references/configuration#Viewport) sizes for responsive testing locally and in dedicated CI jobs.
...
#### `cypress run --config-file <configuration-file>` {#cypress-run---config-file-configuration-file}
...
#### `cypress run --env <env>` {#cypress-run---env-env}
...
#### `cypress run --group <name>` {#cypress-run---group-name}
...
#### `cypress run --port <port>` {#cypress-run---port-port}

```shell
cypress run --port 8080
```

#### `cypress run --project <project-path>` {#cypress-run---project-project-path}
...
#### `cypress run --record --key <record-key>` {#cypress-run---record---key-record-key}
...
#### `cypress run --reporter <reporter>` {#cypress-run---reporter-reporter}
...
#### `cypress run --spec <spec>` {#cypress-run---spec-spec}
...
#### `cypress run --tag <tag>` {#cypress-run---tag-tag}
...
#### `cypress open --browser <browser-path>` {#cypress-open---browser-browser-path}
...
#### `cypress open --config <config>` {#cypress-open---config-config}
...
#### `cypress open --config-file <configuration-file>` {#cypress-open---config-file-configuration-file}
...
#### `cypress open --env <env>` {#cypress-open---env-env}
...
#### `cypress open --port <port>` {#cypress-open---port-port}

```shell
cypress open --port 8080
```

#### `cypress open --project <project-path>` {#cypress-open---project-project-path}
...
### `cypress cache [command]` {#cypress-cache-command}
...
#### `cypress cache path` {#cypress-cache-path}
...
#### `cypress cache prune` {#cypress-cache-prune}
