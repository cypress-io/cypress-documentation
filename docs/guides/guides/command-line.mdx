...
[parallelization](/guides/cloud/smart-orchestration/parallelization) documentation to learn more.
...
Run recorded specs in [parallel](/guides/cloud/smart-orchestration/parallelization) across multiple
machines.
...
Read our [parallelization](/guides/cloud/smart-orchestration/parallelization) documentation to
learn more.
...
[set up your project to record](/guides/cloud/getting-started#Setup), make sure your
...
- Any environment variables that start with the `CYPRESS` prefix (with sensitive
  variables like [record key](/guides/cloud/account-management/projects#Record-key) masked for
  security).
