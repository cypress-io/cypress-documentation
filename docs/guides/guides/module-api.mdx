...
| ------------------------- | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `autoCancelAfterFailures` | _number_ \| _boolean_ | Specify the number of failures to cancel a run being recorded to the Cloud or `false` to disable auto-cancellation.                                                                                      |
...
| `parallel`                | _boolean_             | Run recorded specs in [parallel](/guides/cloud/smart-orchestration/parallelization) across multiple machines                                                                                             |
...
| `runnerUi`                | _boolean_             | Whether to display the Cypress Runner UI. Defaults to `false` when [Test Replay](/guides/cloud/test-replay) is enabled. Otherwise defaults to `true`.                                                    |
