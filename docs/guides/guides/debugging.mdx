...
### Debug just like you always do {#Debug-just-like-you-always-do}
...
### Using [`.debug()`](/api/commands/debug) {#Using-debug}
...
## Step through test commands {#Step-through-test-commands}
...
## Using the Developer Tools {#Using-the-Developer-Tools}
...
### <Icon name="video" /> See it in action! {#Icon-namevideo--See-it-in-action}
...
### Get console logs for commands {#Get-console-logs-for-commands}
...
#### When clicking on `.type()` command, the Developer Tools console outputs the following: {#When-clicking-on-type-command-the-Developer-Tools-console-outputs-the-following}
...
### Anatomy of an error {#Anatomy-of-an-error}
...
## Debugging flake {#Debugging-flake}
...
## Log Cypress events {#Log-Cypress-events}
...
## Run Cypress command outside the test {#Run-Cypress-command-outside-the-test}
...
## Troubleshooting Cypress {#Troubleshooting-Cypress}
