...
### Installed via npm {#Installed-via-npm}

When using custom reporters via npm, specify the package name.

#### Cypress configuration {#Cypress-configuration-1}
...
#### Cypress configuration {#Cypress-configuration-2}
...
#### Cypress configuration {#Cypress-configuration-3}
...
The below examples were implemented in <Icon name="github" inline="true" url="https://github.com/cypress-io/cypress-example-circleci-orb" />.

### Examples {#Examples}

#### Spec to `STDOUT`, save JUnit XML files {#Spec-to-STDOUT-save-JUnit-XML-files}
...
#### Cypress configuration {#Cypress-configuration-4}
...
#### Spec to `STDOUT`, produce a combined Mochawesome JSON file {#Spec-to-STDOUT-produce-a-combined-Mochawesome-JSON-file}
...
#### Cypress configuration {#Cypress-configuration-5}
