...
### Types for Custom Commands {#Types-for-Custom-Commands}
...
#### Adding child or dual commands {#Adding-child-or-dual-commands}
...
#### Overwriting child or dual commands {#Overwriting-child-or-dual-commands}
...
### Types for custom assertions {#Types-for-custom-assertions}
...
### Types for plugins {#Types-for-plugins}
...
### Using an External Typings File {#Using-an-External-Typings-File}
...
### Clashing types with Jest {#Clashing-types-with-Jest}
