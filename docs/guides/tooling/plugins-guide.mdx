...
Plugins from our [official list](/plugins) are npm modules. This
...
2. If you're using an older version of Cypress, you can add your plugin to the
   (deprecated) [plugins file](https://v9.docs.cypress.io/guides/tooling/plugins-guide#Using-a-plugin).
