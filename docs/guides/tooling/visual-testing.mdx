...
## Functional vs. visual testing {#Functional-vs-visual-testing}
...
### Recognize the need for visual testing {#Recognize-the-need-for-visual-testing}
...
<Icon name="check-circle" color="green" /> <strong>Best Practice:</strong> Take a
...
<Icon name="check-circle" color="green" /> <strong>Best Practice:</strong> Control the
...
<Icon name="check-circle" color="green" /> <strong>Best Practice:</strong> Use <a href="/api/commands/fixture">cy.fixture()</a> and network mocking to set the application
state.
...
### Visual diff elements {#Visual-diff-elements}

:::tip

<Icon name="check-circle" color="green" /> <strong>Best Practice:</strong> Use visual
...
<Icon name="check-circle" color="green" /> <strong>Best Practice:</strong> Use <a href="/plugins/directory"> Component Testing plugins</a> to test the individual components functionality in addition to end-to-end and visual tests.
...
- <Icon name="github" contentType="rwa" /> is a full stack example application that demonstrates **best practices and scalable strategies with Cypress in practical and realistic scenarios**.
- Read the blog post
