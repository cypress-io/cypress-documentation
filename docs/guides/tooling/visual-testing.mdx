...
&nbsp;<Icon name="check-circle" color="green" /> **Best Practice:** Use <a href="/plugins/directory"> Component Testing plugins</a> to test the individual components functionality in addition to end-to-end and visual tests.
