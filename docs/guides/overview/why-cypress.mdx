...
- **Smart Orchestration:** Once you're set up to record to Cypress Cloud, easily
  ...
  [Auto Cancellation](/guides/cloud/smart-orchestration/run-cancellation) for
...
We have guides for all the [popular CI providers](/guides/continuous-integration/ci-provider-examples#Guides).
You can also use [Cypress GitHub Action](/guides/continuous-integration/github-actions#Cypress-GitHub-Action) to run your tests.
...
With [Cypress Cloud](/guides/cloud/introduction), you can record your tests, replay them exactly as they
executed during the run, and then debug using [Test Replay](/guides/cloud/test-replay).
