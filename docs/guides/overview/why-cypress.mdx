...
## Who uses Cypress? {#Who-uses-Cypress}
...
## Cypress ecosystem {#Cypress-ecosystem}
...
We believe testing needs a lot of ❤️ and we are here to
...
### <Icon name="cog" /> Setting up tests {#Icon-namecog--Setting-up-tests}
...
### <Icon name="code" /> Writing tests {#Icon-namecode--Writing-tests}
...
### <Icon name="play-circle" /> Running tests {#Icon-nameplay-circle--Running-tests}
...
### <Icon name="bug" /> Debugging tests {#Icon-namebug--Debugging-tests}
...
## Cypress in the Real World {#Cypress-in-the-Real-World}

<DocsImage
  src="/img/guides/overview/v10/real-world-app.png"
...
To guide the way, the Cypress team has created the <Icon name="github" inline="true" contentType="rwa" />, a full stack example application that demonstrates testing with **Cypress in practical and realistic scenarios**.
