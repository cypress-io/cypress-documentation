...
- **Smart Orchestration:** Once you're set up to record to Cypress Cloud, easily
  [parallelize](/guides/cloud/smart-orchestration/parallelization) your test suite, rerun failed
  specs first with
...
- **Flake Detection:** Discover and diagnose unreliable tests with Cypress
  Cloud's [Flaky test management](/guides/cloud/test-analytics/flaky-test-management).
