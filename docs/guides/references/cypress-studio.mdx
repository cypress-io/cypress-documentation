...
<strong>
 <Icon name="exclamation-triangle" /> Removed 
</strong>

Cypress Studio has been removed in Cypress 10 and will be rethought/revisited in
a later release. This page is for reference only.
...
## Using Cypress Studio {#Using-Cypress-Studio}
...
The Cypress <Icon name="github" inline="true" contentType="rwa" /> is
an open source project implementing a payment application to demonstrate
real-world usage of Cypress testing methods, patterns, and workflows. It will be used to demonstrate the functionality of Cypress Studio below.

### Extending a Test {#Extending-a-Test}
...
Clone the <Icon name="github" inline="true" contentType="rwa" /> and refer to the
[cypress/tests/demo/cypress-studio.cy.ts](https://github.com/cypress-io/cypress-realworld-app/blob/develop/cypress/tests/demo/cypress-studio.spec.ts) file.

:::

#### Step 1 - Run the spec {#Step-1---Run-the-spec}
...
#### Step 2 - Launch Cypress Studio {#Step-2---Launch-Cypress-Studio}
...
#### Step 3 - Interact with the Application {#Step-3---Interact-with-the-Application}
...
#### Generated Test Code {#Generated-Test-Code}
