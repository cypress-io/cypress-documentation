...
If you [configure your tests to record](/guides/cloud/getting-started#Setup) the
...
| `defaultBrowser`       | `undefined`                       | The browser other than electron used if the user doesn't pass in "--browser".                                                                                                                |
