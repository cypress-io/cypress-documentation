...
| `indexHtmlFile`      | `cypress/support/component-index.html`   | This is where Cypress renders your components allows you to add in global assets, such as styles, fonts, and external scripts.                                       |
