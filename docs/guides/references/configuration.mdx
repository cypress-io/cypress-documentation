...
## Testing Type-Specific Options {#Testing-Type-Specific-Options}
...
### Overriding Individual Options {#Overriding-Individual-Options}
...
### Specifying an Alternative Config File {#Specifying-an-Alternative-Config-File}
...
### Testing Type-Specific Overrides {#Testing-Type-Specific-Overrides}
...
- ✅ Include the port other than `80`
  and `443`
- ‼️ Do **NOT** include protocol:
  `http://` or `https://`
...
#### Custom Dev Server {#Custom-Dev-Server}
...
### firefoxGcInterval {#firefoxGcInterval}
...
#### <Icon name="angle-right" /> `baseUrl` is not set {#Icon-nameangle-right--baseUrl-is-not-set}
...
#### <Icon name="angle-right" /> Test files not found when using `spec` parameter {#Icon-nameangle-right--Test-files-not-found-when-using-spec-parameter}
...
| Version                                       | Changes                                                                              |
| --------------------------------------------- | ------------------------------------------------------------------------------------ |
| [10.0.0](/guides/references/changelog#10-0-0) | Reworked page to support new `cypress.config.js` and removed `cypress.json` examples |
