...
the [legacy configuration](https://v9.docs.cypress.io/guides/references/configuration) guide.
...
[plugins file](https://v9.docs.cypress.io/guides/tooling/plugins-guide#Using-a-plugin).
