...
- The [Debug page](/guides/cloud/test-analytics/project-health#Debug) now allows
...
- The [Debug page](/guides/cloud/test-analytics/project-health#Debug) is now
  able to show real-time results from in-progress runs. Addresses
