...
- Types for [event emitters](/api/cypress-api/catalog-of-events#Binding-to-Events)
...
- You can now
  [disable Cypress global exception handlers](/api/cypress-api/catalog-of-events) for
...
- You can now programmatically control whether you accept or cancel
  [window.confirm()](/api/cypress-api/catalog-of-events) calls from your application.
