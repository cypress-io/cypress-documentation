...
- Cypress now captures the SHA of builds generated through Travis CI during pull
  ...
  running within [GitHub Integration](/guides/cloud/integrations/github-integration). Fixes
...
- We’re excited to announce
  [GitHub integration](/guides/cloud/integrations/github-integration) for the
...
- We have new instructions on how to set up
  [GitHub Integration](/guides/cloud/integrations/github-integration) with the Cypress
  Dashboard.
