...
- The [Debug page](/guides/cloud/test-analytics/project-health#Debug) now allows for navigating between
...
- The [Debug page](/guides/cloud/test-analytics/project-health#Debug) is now able to show real-time
...
- Cypress now captures the SHA of builds generated through Travis CI during pull
  ...
  running within [GitHub Integration](/guides/cloud/integrations/source-control/github). Fixes
...
- We have new instructions on how to set up
  [GitHub Integration](/guides/cloud/integrations/source-control/github) with the Cypress
  Dashboard.
...
- Added a section about how to request our new
  [Open Source Plan](/guides/cloud/account-management/billing-and-usage#Requesting-OSS-plan-for-an-Org) in the
