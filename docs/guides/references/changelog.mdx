...
- Adds Git-related messages for the
  [Runs page](https://docs.cypress.io/guides/core-concepts/cypress-app#Runs) and
  [Debug page](https://docs.cypress.io/guides/cloud/runs#Debug) when users
  aren't using Git or there are no recorded runs for the current branch. Fixes
...
- The [Debug page](/guides/cloud/runs#Debug) is now able to show real-time
  results from in-progress runs. Addresses
...
- It is now possible to set `hostOnly` cookies with
  [`cy.setCookie()`](https://docs.cypress.io/api/commands/setcookie) for a given
  domain. Addresses [#16856](https://github.com/cypress-io/cypress/issues/16856)
  and [#17527](https://github.com/cypress-io/cypress/issues/17527).
- Added a Public API for third party component libraries to define a Framework
  ...
  Learn more
  [here](https://docs.cypress.io/guides/component-testing/third-party-definitions).
...
- Added missing TypeScript type definitions for the
  [`cy.reload()`](https://docs.cypress.io/api/commands/reload) command.
  Addressed in [#25779](https://github.com/cypress-io/cypress/pull/25779).
...
- Fixed an issue where using
  [`cy.intercept`](https://docs.cypress.io/api/commands/intercept)'s
...
- Added a new CLI flag, called
  ...
  ["Auto Cancellation"](/guides/cloud/smart-orchestration#Auto-Cancellation)
...
- When a Cloud user is a part of multiple Cloud organizations, the
  [Connect to Cloud setup](/guides/cloud/projects#Set-up-a-project-to-record)
...
- Cypress now captures the SHA of builds generated through Travis CI during pull
  ...
  running within [GitHub Integration](/guides/cloud/integrations/github). Fixes
...
- We’re excited to announce
  [GitHub integration](/guides/cloud/integrations/github) for the
...
- We have new instructions on how to set up
  [GitHub Integration](/guides/cloud/integrations/github) with the Cypress
  Dashboard.
