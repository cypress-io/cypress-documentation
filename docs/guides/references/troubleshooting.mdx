...
### Common GitHub issues {#Common-GitHub-issues}
...
## Clear Cypress cache {#Clear-Cypress-cache}
...
## Allow the Cypress Chrome extension {#Allow-the-Cypress-Chrome-extension}
...
## Allow Cypress URLs on VPNs {#Allow-Cypress-URLs-on-VPNs}
...
### To clear App Data {#To-clear-App-Data}
...
#### Debug log depth {#Debug-log-depth}
...
### Debug logs in the browser {#Debug-logs-in-the-browser}
...
## Log memory and CPU usage {#Log-memory-and-CPU-usage}
...
## Disable the Command Log {#Disable-the-Command-Log}
...
### Write command log to the terminal {#Write-command-log-to-the-terminal}
...
## Hacking on Cypress {#Hacking-on-Cypress}
...
### Run the Cypress app by itself {#Run-the-Cypress-app-by-itself}
...
### Edit the installed Cypress code {#Edit-the-installed-Cypress-code}
