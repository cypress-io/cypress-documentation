...
sidebar_label: Configuration (Legacy)
slug: legacy-configuration
---

:::caution

This guide is for Cypress 9 and below, which supports the `cypress.json`
configuration file. For Cypress 10 and above, visit the
[Configuration](/guides/references/configuration) guide.
...
you [configure your tests to record](/guides/cloud/getting-started#Setup) the
...
| `testFiles`         | <code>\*\*_/_\*.\*</code>  | A String or Array of glob patterns of the test files to load                                                                                                                                                                                                                               |
...
- Build files in the
  [integrationFolder](#Folders--Files).
- Build files in the
  [supportFile](#Folders--Files).
- Execute code in the
  [pluginsFile](#Folders--Files).
...
Make sure you do not accidentally place the `baseUrl` or another
top-level config variable into the `env` block. The following
configuration is _incorrect_ and WILL NOT WORK:
