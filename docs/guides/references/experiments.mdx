...
experiments for your project by turning on specifc features using the 
Cypress configuration options described below.
...
real-world feedback during their development. For more information, see
