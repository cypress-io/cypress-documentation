...
#### Permanent trade-offs: {#Permanent-trade-offs}
...
#### Temporary trade-offs: {#Temporary-trade-offs}
...
## Permanent trade-offs {#Permanent-trade-offs-1}

### Automation restrictions {#Automation-restrictions}
...
### Multiple browsers open at the same time {#Multiple-browsers-open-at-the-same-time}
...
#### 1. Use only the browser: {#1-Use-only-the-browser}
...
#### 2. Stub the other connection: {#2-Stub-the-other-connection}
...
#### 3: Introduce another connection: {#3-Introduce-another-connection}
...
- ‼️ You **cannot** [visit](/api/commands/visit) two domains of different origin in the same test.
- ✅ You **can** [visit](/api/commands/visit) two or more domains of different origin in **different** tests.
