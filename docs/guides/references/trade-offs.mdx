...
- ‼️ You **cannot** [visit](/api/commands/visit) two domains of different origin
  in the same test.
- ✅ You **can** [visit](/api/commands/visit) two or more domains of different
  origin in **different** tests.
