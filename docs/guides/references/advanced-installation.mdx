...
## Using a custom CA {#Using-a-custom-CA}
...
## Opt out of sending exception data to Cypress {#Opt-out-of-sending-exception-data-to-Cypress}
...
### Opt out on Linux or macOS {#Opt-out-on-Linux-or-macOS}
...
### Opt out on Windows {#Opt-out-on-Windows}
