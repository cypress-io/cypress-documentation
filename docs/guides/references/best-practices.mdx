...
[load balancing](/guides/cloud/smart-orchestration/load-balancing#Balance-strategy),
[Auto Cancellation](/guides/cloud/smart-orchestration/run-cancellation), and
...
your [Cypress configuration](/guides/references/configuration).
