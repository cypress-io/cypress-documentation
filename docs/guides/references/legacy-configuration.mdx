...
<Icon name="exclamation-triangle" /> The <code>nodeVersion</code> configuration option
is deprecated and will be removed in a future version of Cypress. Please remove this
