...
## Set a proxy on Linux or macOS {#Set-a-proxy-on-Linux-or-macOS}
...
## Set a proxy on Windows {#Set-a-proxy-on-Windows}
...
## View, unset, and set environment variables {#View-unset-and-set-environment-variables}
...
#### Set an environment variable for the current session {#Set-an-environment-variable-for-the-current-session}
...
#### See all the currently set environment variables {#See-all-the-currently-set-environment-variables}
...
#### Set an environment variable for current session {#Set-an-environment-variable-for-current-session}
...
#### Set environment variable globally for all future sessions {#Set-environment-variable-globally-for-all-future-sessions}

```shell
setx SOME_VARIABLE some-value
```

#### Unset an environment variable in the current session {#Unset-an-environment-variable-in-the-current-session}
...
#### See all currently set environment variables {#See-all-currently-set-environment-variables}
...
## View proxy settings in Cypress {#View-proxy-settings-in-Cypress}
