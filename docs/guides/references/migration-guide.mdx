...
[Test Replay](/guides/cloud/debugging/test-replay) capture is enabled by default in `v13.0` of the Cypress App.
...
You can opt out of this feature in Cloud project-level settings. [add link to opt-out]
