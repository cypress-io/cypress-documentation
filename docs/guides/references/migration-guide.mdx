...
version 13.0.
[See the full changelog for version v13.0](https://docs.cypress.io/guides/overview/why-cypress).

### Cypress Cloud Test Replay

[Test Replay](/guides/cloud/debugging/test-replay) is enabled by default in `v13.0` of the Cypress App.
...
You can [opt out](/guides/cloud/debugging/test-replay#Opt-out-of-Test-Replay) of this feature in Cloud project-level settings.

<!---
TODO: replace urls for v13 changelog:
...
You can continue recording video, by passing `video: true`, if you want video locally or you want video for some other reason, like in non-Chromium browsers where [Test Replay](/guides/cloud/debugging/test-replay) is not available.
