...
## End-to-End or Component Tests? {#End-to-End-or-Component-Tests}
...
### Benefits of end-to-end tests: {#Benefits-of-end-to-end-tests}
...
### Considerations for end-to-end tests: {#Considerations-for-end-to-end-tests}
...
### Common scenarios for end-to-end tests: {#Common-scenarios-for-end-to-end-tests}
...
### Benefits of component tests: {#Benefits-of-component-tests}
...
### Considerations for component tests: {#Considerations-for-component-tests}
...
### Common scenarios for component tests: {#Common-scenarios-for-component-tests}
...
## Testing Type Comparison {#Testing-Type-Comparison}
