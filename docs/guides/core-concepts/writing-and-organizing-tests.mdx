...
### Configuring Folder Structure {#Configuring-Folder-Structure}
...
#### Screenshot Files {#Screenshot-Files}
...
#### Asset File Paths {#Asset-File-Paths}
...
<Icon name="exclamation-triangle" /> For a given testing type, multiple matching <code>supportFile</code> files will result in an error when Cypress loads.
...
#### The order of hook and test execution is as follows: {#The-order-of-hook-and-test-execution-is-as-follows}
...
🚨 Before writing `after()` or `afterEach()`
hooks, please see our [thoughts on the anti-pattern of cleaning up state with `after()`
or `afterEach()`](/guides/references/best-practices#Using-after-or-afterEach-hooks).

:::

### Excluding and Including Tests {#Excluding-and-Including-Tests}
...
#### Allowed config values {#Allowed-config-values}

:::caution

**Note:** Some configuration values are readonly and cannot be changed via test configuration. Be sure to review the list of [test configuration options](/guides/references/configuration##Test-Configuration).
...
#### Single test configuration {#Single-test-configuration}
...
<DocsImage
  ...
  alt="Cypress App with a single passed test"
></DocsImage>
...
<DocsImage
  ...
  alt="Cypress App with a single failed test"
></DocsImage>
...
<DocsImage
  ...
  alt="Cypress App with three pending test"
></DocsImage>
...
<DocsImage
  ...
  alt="Cypress App showing two passing tests"
></DocsImage>
...
<DocsImage
  ...
  alt="Cypress App showing one failed and one skipped test"
></DocsImage>
...
<DocsImage
  ...
  alt="Cypress App showing one skipped test"
></DocsImage>
...
### What isn't watched? {#What-isnt-watched}
