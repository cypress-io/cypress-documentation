...
<strong><Icon name="cogs"></Icon> supportFile per testing
type</strong>

Depending on which [testing type](/guides/core-concepts/testing-types)
you are using, you can configure your `supportFile` accordingly.
...
<Icon name="check-circle" color="green"></Icon> <strong>Best Practice:</strong> Clean up state <strong>before</strong> tests run.
