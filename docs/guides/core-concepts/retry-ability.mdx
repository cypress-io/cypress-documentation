...
<strong>Test Burn-in and Retries</strong>

To determine retry-ability of tests that may be at higher risk for flake, check out our experimental [test burn-in](/guides/references/experiments#Experimental-burn-in) feature.

To determine retry-ability of tests a configured number of times when the test
...
[Action commands](/guides/core-concepts/interacting-with-elements) - such as
