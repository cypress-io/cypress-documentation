...
## <Icon name="graduation-cap" /> What you'll learn {#Icon-namegraduation-cap--What-youll-learn}
...
## Commands vs assertions {#Commands-vs-assertions}
...
<DocsImage
  src="/img/guides/retry-ability/v10/command-assertions.png"
  alt="Cypress tests shoing commands and assertions"
></DocsImage>
...
<DocsImage
  src="/img/guides/retry-ability/v10/retry-2-items.gif"
...
<DocsImage
  src="/img/guides/retry-ability/v10/second-assertion-fails.gif"
  alt="Retrying multiple assertions"
></DocsImage>

## Not every command is retried {#Not-every-command-is-retried}
...
### Why are some commands _NOT_ retried? {#Why-are-some-commands-_NOT_-retried}
...
<DocsImage
  src="/img/guides/retry-ability/v10/eq.gif"
...
### Increase time to retry {#Increase-time-to-retry}
...
## Only the last command is retried {#Only-the-last-command-is-retried}
...
<DocsImage
  src="/img/guides/retry-ability/v10/adds-two-items-passes.gif"
  alt="Test passes"
></DocsImage>
...
<DocsImage
  src="/img/guides/retry-ability/v10/adds-two-items-fails.gif"
  alt="Test fails"
></DocsImage>
...
<DocsImage
  src="/img/guides/retry-ability/v10/first-item-label.png"
  alt="First item label"
></DocsImage>
...
<DocsImage
  src="/img/guides/retry-ability/v10/second-item-label.png"
...
<DocsImage
  src="/img/guides/retry-ability/v10/second-get-li.png"
  alt="Second get li"
></DocsImage>
...
<DocsImage
  src="/img/guides/retry-ability/v10/two-items.png"
  alt="Two items"
></DocsImage>
...
## Use retry-ability correctly {#Use-retry-ability-correctly}
...
### Merging queries {#Merging-queries}
...
<DocsImage
  src="/img/guides/retry-ability/v10/combined-selectors.gif"
  alt="Combined selector"
></DocsImage>

:::info

**Use [`cy.contains()`](/api/commands/contains)**
...
### Alternate commands and assertions {#Alternate-commands-and-assertions}
...
<DocsImage
  src="/img/guides/retry-ability/v10/alternating-commands-assertions.png"
  alt="Passing test"
></DocsImage>
...
### Use `.should()` with a callback {#Use-should-with-a-callback}
...
<DocsImage
  src="/img/guides/retry-ability/v10/random-number.gif"
  alt="Random number"
></DocsImage>

#### <Icon name="exclamation-triangle" color="red" /> Incorrectly waiting for values {#Icon-nameexclamation-triangle-colorred--Incorrectly-waiting-for-values}
...
<DocsImage
  src="/img/guides/retry-ability/v10/random-number-first-attempt.png"
  alt="First attempt at writing the test"
></DocsImage>

#### <Icon name="check-circle" color="green" /> Correctly waiting for values {#Icon-namecheck-circle-colorgreen--Correctly-waiting-for-values}
...
<DocsImage
  src="/img/guides/retry-ability/v10/random-number-callback.gif"
...
#### <Icon name="exclamation-triangle" color="red" /> Incorrectly checking if the stub was called {#Icon-nameexclamation-triangle-colorred--Incorrectly-checking-if-the-stub-was-called}
...
<DocsImage
  src="/img/guides/retry-ability/v10/delay-click.png"
...
#### <Icon name="check-circle" color="green" /> Correctly waiting for the stub to be called {#Icon-namecheck-circle-colorgreen--Correctly-waiting-for-the-stub-to-be-called}
...
<DocsImage
  src="/img/guides/retry-ability/v10/click-twice.gif"
