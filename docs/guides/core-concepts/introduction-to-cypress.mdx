...
## Cypress Can Be Simple (Sometimes) {#Cypress-Can-Be-Simple-Sometimes}
...
### Cypress is Like jQuery {#Cypress-is-Like-jQuery}
...
### Cypress is _Not_ Like jQuery {#Cypress-is-_Not_-Like-jQuery}
...
#### 1. The element is found {#1-The-element-is-found}
...
#### 2. A set timeout is reached {#2-A-set-timeout-is-reached}
...
### Querying by Text Content {#Querying-by-Text-Content}
...
### When Elements Are Missing {#When-Elements-Are-Missing}
...
## Chains of Commands {#Chains-of-Commands}
...
### Asserting About Elements {#Asserting-About-Elements}
...
#### Some commands can be chained from... {#Some-commands-can-be-chained-from}
...
#### Some commands yield... {#Some-commands-yield}
...
#### Using [`.then()`](/api/commands/then) To Act On A Subject {#Using-then-To-Act-On-A-Subject}
...
#### Using Aliases to Refer to Previous Subjects {#Using-Aliases-to-Refer-to-Previous-Subjects}
...
#### Take this short test, for example: {#Take-this-short-test-for-example}
...
#### Mixing Async and Sync code {#Mixing-Async-and-Sync-code}
...
#### Let's take another look at an example {#Lets-take-another-look-at-an-example}
...
#### You cannot race or run multiple commands at the same time {#You-cannot-race-or-run-multiple-commands-at-the-same-time}
...
#### You cannot add a `.catch` error handler to a failed command {#You-cannot-add-a-catch-error-handler-to-a-failed-command}
...
### Asserting in English {#Asserting-in-English}
...
#### Example #1: Existence and Actionability {#Example-1-Existence-and-Actionability}
...
#### Example #2: Reversing the Default Assertion {#Example-2-Reversing-the-Default-Assertion}
...
#### Example #3: Other Default Assertions {#Example-3-Other-Default-Assertions}
...
### Implicit Subjects {#Implicit-Subjects}
...
<strong>Make sure `.should()` is safe</strong>
...
### Applying Timeouts {#Applying-Timeouts}
...
#### Example #1: Default Assertion {#Example-1-Default-Assertion}
...
#### Example #2: Additional Assertions {#Example-2-Additional-Assertions}
...
#### Example #3: Modifying Timeouts {#Example-3-Modifying-Timeouts}
