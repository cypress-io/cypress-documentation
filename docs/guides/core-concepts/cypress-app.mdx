...
<DocsImage
  src="/img/guides/cypress-app/gui-diagram.png"
  alt="Cypress App"
></DocsImage>
...
<DocsImage
  src="/img/guides/cypress-app/v10/command-log.png"
  alt="Cypress App"
  width-600
></DocsImage>
...
<DocsImage
  src="/img/guides/cypress-app/v10/open-file-in-IDE.gif"
...
<DocsImage
  src="/img/guides/cypress-app/v10/first-test-hover-contains.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/first-test-url-revert.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/first-test-click-revert.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/first-test-page-load.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/instrument-panel-routes.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/instrument-panel-stubs.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/instrument-panel-spies.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/application-under-test.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/viewport-scaling.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/aut-error-e2e.png"
  alt="Errors"
></DocsImage>
...
<DocsImage
  src="/img/guides/cypress-app/v10/viewport-scaling-ct.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/aut-error-ct.png"
...
<DocsImage
  src="/img/guides/cypress-app/open-selector-playground.gif"
...
<DocsImage
  src="/img/guides/cypress-app/copy-selector-in-selector-playground.gif"
...
<DocsImage
  src="/img/guides/cypress-app/typing-a-selector-to-find-in-playground.gif"
...
<DocsImage
  src="/img/guides/cypress-app/cy-contains-in-selector-playground.gif"
...
<DocsImage
  src="/img/guides/cypress-app/turn-off-highlight-in-selector-playground.gif"
...
<DocsImage
  src="/img/guides/cypress-app/v10/keyboard-shortcuts.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/first-test-console-output.png"
...
<DocsImage
  src="/img/guides/cypress-app/v10/first-test-paused.png"
