...
### The Spec Explorer {#The-Spec-Explorer}
...
### Open files in your IDE {#Open-files-in-your-IDE}
...
### Pinning Snapshots {#Pinning-Snapshots}
...
#### 1. Pinned snapshots {#1-Pinned-snapshots}
...
#### 3. Snapshot menu panel {#3-Snapshot-menu-panel}
...
### Application Under Test <E2EOnlyBadge /> {#Application-Under-Test-E2EOnlyBadge-}
...
### Component Under Test <ComponentOnlyBadge /> {#Component-Under-Test-ComponentOnlyBadge-}
...
#### Editing a Selector {#Editing-a-Selector}
...
#### Switching to Contains {#Switching-to-Contains}
...
#### Disabling Highlights {#Disabling-Highlights}
