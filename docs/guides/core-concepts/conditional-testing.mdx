...
### The DOM is unstable {#The-DOM-is-unstable}
...
### A/B campaign <E2EOnlyBadge /> {#AB-campaign-E2EOnlyBadge-}
...
#### Use URL query params: {#Use-URL-query-params}
...
#### Use session cookies: {#Use-session-cookies}
...
#### Embed data in the DOM: {#Embed-data-in-the-DOM}
...
### Welcome wizard <E2EOnlyBadge /> {#Welcome-wizard-E2EOnlyBadge-}
...
#### Use the URL to control it: {#Use-the-URL-to-control-it}
...
#### Use Cookies to know ahead of time: {#Use-Cookies-to-know-ahead-of-time}
...
#### Use your server or database: {#Use-your-server-or-database}
...
#### Embed data in DOM: {#Embed-data-in-DOM}
...
#### Conditionally check whether an element has certain text: {#Conditionally-check-whether-an-element-has-certain-text}
