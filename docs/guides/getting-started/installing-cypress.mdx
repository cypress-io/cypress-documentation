...
### <Icon name="terminal" /> `npm install` {#Icon-nameterminal--npm-install}
...
### <Icon name="terminal" /> `yarn add` {#Icon-nameterminal--yarn-add}
...
### <Icon name="download" /> Direct download {#Icon-namedownload--Direct-download}
...
### <Icon name="cog" /> Advanced Installation {#Icon-namecog--Advanced-Installation}
...
### <Icon name="sync-alt" /> Continuous integration {#Icon-namesync-alt--Continuous-integration}
