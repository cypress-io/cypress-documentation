...
#### **Sign Up with Basic Authentication** {#Sign-Up-with-Basic-Authentication}
...
#### **Sign Up with Social Authentication** {#Sign-Up-with-Social-Authentication}
...
#### **Sign Up with Single Sign On (SSO) Authentication** {#Sign-Up-with-Single-Sign-On-SSO-Authentication}
