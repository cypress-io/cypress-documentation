...
## Installing the Jira integration {#Installing-the-Jira-integration}
...
## Creating a Jira issue for a test case {#Creating-a-Jira-issue-for-a-test-case}
...
## Uninstalling the Jira integration {#Uninstalling-the-Jira-integration}
