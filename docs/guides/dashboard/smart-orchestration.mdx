...
## Run failed specs first {#Run-failed-specs-first}
...
### Toggle running of failed specs first {#Toggle-running-of-failed-specs-first}
...
## Cancel test run when a test fails {#Cancel-test-run-when-a-test-fails}
...
### Toggle cancellation of test runs upon first failure {#Toggle-cancellation-of-test-runs-upon-first-failure}
