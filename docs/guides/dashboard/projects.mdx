...
### Set up a project to record {#Set-up-a-project-to-record}
...
#### The `projectId` is a 6 character string in your Cypress configuration {#The-projectId-is-a-6-character-string-in-your-Cypress-configuration}
...
#### A record key is a GUID that looks like this {#A-record-key-is-a-GUID-that-looks-like-this}
...
### Create new record key {#Create-new-record-key}
...
### Create a README badge {#Create-a-README-badge}
...
### Change project access {#Change-project-access}
...
### Transfer project to other user or organization {#Transfer-project-to-other-user-or-organization}
...
### Cancel project transfer {#Cancel-project-transfer}
...
### Accept or reject transferred project {#Accept-or-reject-transferred-project}
