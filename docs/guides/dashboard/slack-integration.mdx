...
## Install the Cypress Slack app {#Install-the-Cypress-Slack-app}
...
## Per-organization configuration {#Per-organization-configuration}

### Add additional Slack channels {#Add-additional-Slack-channels}
...
### Remove a Slack channel {#Remove-a-Slack-channel}
...
### Add a new Slack channel {#Add-a-new-Slack-channel}
...
### Set notification preferences {#Set-notification-preferences-1}
...
### Mute a channel {#Mute-a-channel-1}
