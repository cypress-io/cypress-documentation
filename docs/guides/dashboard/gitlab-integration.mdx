...
## Installing the GitLab integration {#Installing-the-GitLab-integration}
...
## Configuring the GitLab integration {#Configuring-the-GitLab-integration}
...
## Uninstalling the GitLab integration {#Uninstalling-the-GitLab-integration}
