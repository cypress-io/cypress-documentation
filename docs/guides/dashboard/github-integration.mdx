...
## Install the Cypress GitHub app {#Install-the-Cypress-GitHub-app}
...
### Install via project settings {#Install-via-project-settings}
...
### Cypress GitHub app installation process {#Cypress-GitHub-app-installation-process}
...
### Cypress GitHub Enterprise app installation process {#Cypress-GitHub-Enterprise-app-installation-process}
...
## Enabling GitHub integration for a project {#Enabling-GitHub-integration-for-a-project}
...
### Disable status checks {#Disable-status-checks}
...
### Disable PR comments {#Disable-PR-comments}
...
## Uninstall the Cypress GitHub app {#Uninstall-the-Cypress-GitHub-app}
