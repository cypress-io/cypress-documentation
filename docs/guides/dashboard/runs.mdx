...
## <Icon name="file-code" /> Spec files {#Icon-namefile-code--Spec-files}
...
### Jump to failed tests {#Jump-to-failed-tests}
...
### <Icon name="code" /> CI logs {#Icon-namecode--CI-logs}
...
### <Icon name="camera" /> Screenshots {#Icon-namecamera--Screenshots}
...
### <Icon name="video" /> Videos {#Icon-namevideo--Videos}
...
## <Icon name="exclamation-triangle" /> Test failures {#Icon-nameexclamation-triangle--Test-failures}

Any tests that fail during a test run can be found under the **Test Results**
tab. Each failure is listed under its test title.

### Each failure displays: {#Each-failure-displays}
...
<DocsImage
  src="/img/dashboard/runs/test-attempts-and-errors.png"
  alt="failure tab"
></DocsImage>
...
### To cancel a run {#To-cancel-a-run}
...
<DocsVideo
  ...
  title="Dashboard cancel runs"
></DocsVideo>

### What happens when a run is canceled? {#What-happens-when-a-run-is-canceled}
...
### To archive a run {#To-archive-a-run}
...
### What happens when a run is archived? {#What-happens-when-a-run-is-archived}
...
### To restore an archived run {#To-restore-an-archived-run}
