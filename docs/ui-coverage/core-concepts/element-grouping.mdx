...
* Elements are grouped by [elementgroups.md](https://cypressio.gitbook.io/ui-coverage/configuration/elementgroups) configuration if defined.
...
* Links with similar href patterns are resolved to [views.md](https://cypressio.gitbook.io/ui-coverage/configuration/views) and grouped by their corresponding view.
