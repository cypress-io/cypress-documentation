...
Element identification can be configured via [attributefilters.md](https://cypressio.gitbook.io/ui-coverage/configuration/attributefilters) and [significantattributes.md](https://cypressio.gitbook.io/ui-coverage/configuration/significantattributes) configuration.
