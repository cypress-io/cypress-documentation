...
UI Coverage has logic that automatically [identifies](https://cypressio.gitbook.io/ui-coverage/important-concepts/element-identification) and [groups](https://cypressio.gitbook.io/ui-coverage/important-concepts/element-grouping) elements based on their appearance and structure in the DOM.
