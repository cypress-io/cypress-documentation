...
- **Remove links to pages no test will ever visit**: Your application may link to destinations your tests never navigate to, whether pages of your own like a help center or marketing site, or entirely external websites like social media profiles or a partner's site. Those links count against your score as [untested links](/ui-coverage/core-concepts/interactivity#Untested-Links) even though no view exists for them. Excluding the destination URLs is the way to remove them, since there is no view to exclude.
