...
For optional **policies** that gate runs on UI Coverage and Accessibility thresholds in Cloud, see the dedicated [policies](/ui-coverage/configuration/policies) guide.
...
- [policies](/ui-coverage/configuration/policies)
