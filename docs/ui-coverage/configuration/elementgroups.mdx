...
UI Coverage has logic that automatically [groups](https://cypressio.gitbook.io/ui-coverage/important-concepts/element-grouping) elements based on their appearance and structure in the DOM.
