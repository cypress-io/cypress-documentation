...
:::tip
If you use an AI coding assistant, you can query UI Coverage data directly from your editor using [Cypress Cloud MCP](/ui-coverage/work-with-ai-agents). Ask your agent to pull the report, identify the riskiest views, and drill into specific untested elements — without opening a browser tab.
:::
