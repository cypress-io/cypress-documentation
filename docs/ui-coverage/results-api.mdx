...
If something goes wrong, the function throws an error with a clear, actionable message that explains what
happened and how to fix it. The errors you may encounter include:
