...
- **Shadow DOM and iframe Support:** UI Coverage now supports Shadow DOM and iframes for reporting on interactions. These settings are off by default, please contact your Cypress representative to opt-in.
