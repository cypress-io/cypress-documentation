...
<Icon name="star" /> **Cypress Cloud Add-on**

**UI Coverage** is a paid add-on. [Schedule a demo](https://www.cypress.io/ui-coverage) today and see how easy it is to enhance your testing while speeding up your development process.
