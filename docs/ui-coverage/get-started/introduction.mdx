...
- **AI agent integration**: Use [Cypress Cloud MCP](/ui-coverage/work-with-ai-agents) to query coverage scores, identify untested views, and generate tests directly from your AI coding assistant.
