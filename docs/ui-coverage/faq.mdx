...
description: 'Get answers to common questions about Cypress UI Coverage, including scores, view and URL grouping, element grouping, iframes and shadow DOM, and configuration.'
sidebar_label: FAQ
