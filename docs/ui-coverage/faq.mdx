...
### <Icon name="angle-right" /> Can AI agents read my Cypress UI Coverage results?

Yes. AI agents can read your Cypress UI Coverage results through [Cypress Cloud MCP](/cloud/integrations/cloud-mcp), which exposes UI Coverage data to compatible agents through structured, read-only tools. An agent can pull a Cypress run's coverage score and untested elements directly instead of you copy-pasting from the report. See [Work with AI agents](/ui-coverage/work-with-ai-agents) for setup and example prompts.
...
- [Work with AI agents](/ui-coverage/work-with-ai-agents) explains how to query UI Coverage with AI agents over Cypress Cloud MCP.
