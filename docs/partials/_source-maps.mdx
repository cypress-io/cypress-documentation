Cypress uses source maps to enhance the error experience. Stack traces are
...
See our recommended [tsconfig.json](/app/tooling/typescript-support#Configure-tsconfigjson) as a reference.
