...
- URLs that don't match any pattern are grouped by the [automatic view grouping rules](/ui-coverage/core-concepts/views#How-views-are-created), where possible.
