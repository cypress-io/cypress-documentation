...
- There is now a new [Error Messages Page](/guides/references/error-messages) which will provide additional explanation when you are getting errors from Cypress. These errors will be directly linked to (like how Angular provides errors).
...
- Clarified the "Default Message" page when you have not [`cy.visit()`](/api/commands/visit) your application yet.
