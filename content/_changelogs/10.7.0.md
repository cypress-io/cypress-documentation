...
- Fixed an issue where an incomplete `component.devServer` configuration would
  cause the specs list to not display in the Cypress App when running Component
  Tests in open mode. Fixes
