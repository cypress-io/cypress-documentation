...
- The Chrome browser version used during `cypress run` and when selecting Electron browser in `cypress open` has been downgraded from `89` to `87`. Addressed in [#16113](https://github.com/cypress-io/cypress/pull/16113).
