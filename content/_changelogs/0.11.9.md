...
- Created new debugging command: [`.pause()`](/api/commands/pause) which will pause executing commands and allow you to resume or step into the next command one at a time.
