...
element resolution to reduce the likelihood of hitting detached DOM
...
- Cypress dropped support for Node.js 12, 15 and 17. Those versions have
...
- Cypress has always recommended writing tests in a clean context. In Cypress
  ...
  disabled, this changes how Cypress cleans up the
...
- Fixed unexpected behaviors when verifying a cookie was not returned from
   [`cy.getCookie()`](/api/commands/getcookie). Now it's possible
