...
1. **Learn more:** Some error messages contain a **Learn more** link that will
...
<DocsImage src="/img/guides/core-concepts/cypress-app/command-failure-error.png" alt="example command failure error"></DocsImage>
