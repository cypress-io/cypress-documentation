...
globally in [configuration file](/guides/references/configuration).
...
project's root folder (where the
[configuration file](/guides/references/configuration) file is generated by
default).
...
[configuration file](/guides/references/configuration) file to prevent repeating
