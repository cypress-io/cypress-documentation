...
Yes.
[You can override this with `userAgent` in your configuration file.](/guides/references/configuration#Browser)
...
Yes.
[You can set this with `blockHosts` in your configuration file.](/guides/references/configuration#Browser)
...
[configuration file](/guides/references/configuration) file.
