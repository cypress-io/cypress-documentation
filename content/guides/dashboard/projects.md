...
3. You will need to log in to record your tests, so you'll be prompted to log in
   ...
   <DocsImage src="/img/dashboard/projects/setup-a-project-1.png" alt="Connect to Cloud" no-border></DocsImage>
...
4. Here you will see a **Record Keys** section
   <DocsImage src="/img/dashboard/record-keys-in-project-settings-dashboard.png" alt="Record keys in Cloud" ></DocsImage>
