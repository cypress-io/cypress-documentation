...
9. After setting up your project, Cypress inserts a unique
   [projectId](#Identification) into your Cypress configuration file. If you're using
...
If you're using source control, we recommend that you check your Cypress configuration
