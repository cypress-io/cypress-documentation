...
2. Click **Users**, then **Invite User**. *Note: you must have the [role of 'owner' or 'admin'](#User-roles) to invite users.*
3. Fill in their email and select their [role](#User-roles) then click **Invite User** *Note: only owners can give other users 'owner' access.*
