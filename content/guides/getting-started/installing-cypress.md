...
Read [Launching Browsers](/guides/guides/launching-browsers) for more information on how Cypress controls a real browser during end-to-end tests.
...
- Windows 32-bit (`?platform=win32&arch=ia32`, available since [Cypress 3.3.0](/guides/references/changelog#3-3-0))
