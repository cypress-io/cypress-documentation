...
Feel free to [explore these additional logging in](/examples/examples/recipes) recipes.
...
- [Introduction to Cypress](/guides/core-concepts/introduction-to-cypress) explains how Cypress *really* works
