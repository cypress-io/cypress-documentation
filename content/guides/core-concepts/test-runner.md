...
To open the Selector Playground, click the
`<Icon name="crosshairs" color="grey"></Icon>` button next to the URL at the top
of the runner. Hover over elements in your app to preview a unique selector for
that element in the tooltip.
...
can copy it to your clipboard (`<Icon name="copy" color="grey"></Icon>`) or
print it to the console (`<Icon name="terminal"></Icon>`).
