...
| `experimentalSessionAndOrigin`     | `false` | Enable use of [`cy.session()`](/api/commands/session) and [`cy.origin()`](/api/commands/session), and new behavior to handle caching and restoring cookies, localStorage, and sessionStorage.                                                                                                           |
