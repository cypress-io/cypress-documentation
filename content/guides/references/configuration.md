...
| `slowTestThreshold`    | `10000 | 250` | Time, in milliseconds, to consider a test "slow" during `cypress run`. You will often want to configure this differently for component and e2e testing. Default is 10000 for e2e and 250 for component tests. This never causes tests to fail.                                                                                                                                                                                                                                    |
