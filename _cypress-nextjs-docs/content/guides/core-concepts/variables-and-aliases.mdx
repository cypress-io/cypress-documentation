...
<strong className="alert-header">Do not worry!</strong>
...
<strong className="alert-header">Return Values</strong>
...
<strong className="alert-header">Do not do this</strong>
...
<strong className="alert-header">Introducing Aliases</strong>
...
<strong className="alert-header">Watch out for async commands</strong>
...
<strong className="alert-header">Arrow Functions</strong>
...
<DocsImage
  src="/img/guides/aliasing-routes.jpg"
  alt="Alias commands"
></DocsImage>
