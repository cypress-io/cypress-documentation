...
<strong className="alert-header">Opacity</strong>
...
<strong className="alert-header">What's the difference?</strong>
...
<strong className="alert-header">force `.select()` disabled options</strong>
