...
<strong className="alert-header">Did you know?</strong>
...
```html
<button id="main" className="btn btn-large" data-cy="submit">Submit</button>
```
...
<strong className="alert-header">Recipes</strong>
...
in your [configuration file (`cypress.json` by default)](/guides/references/configuration).
