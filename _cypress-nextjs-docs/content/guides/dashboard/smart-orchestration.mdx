...
<strong className="alert-header">CI Tip: Reduce Costs</strong>
...
<strong className="alert-header">Consideration for Teams</strong>
...
<strong className="alert-header">CI Tip: Save Time</strong>
