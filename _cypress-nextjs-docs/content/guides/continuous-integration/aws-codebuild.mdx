...
<strong className="alert-header">Try it out</strong>
...
<Alert type="info">
<strong className="alert-header">Enabling batch builds in the CodeBuild UI for the project</strong>
<br />
<br />
...
<strong className="alert-header">Cypress Amazon Public ECR</strong>
...
<strong className="alert-header">Choosing the right Docker Image</strong>
