...
<strong className="alert-header">Web Security</strong>
...
<strong className="alert-header">Docker Images for Testing</strong>
...
<strong className="alert-header">Cron Scheduling</strong>
...
<strong className="alert-header">Tip</strong>
