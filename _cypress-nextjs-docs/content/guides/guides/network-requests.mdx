...
<strong className="alert-header">Benefits</strong>
...
<strong className="alert-header">Downsides</strong>
...
<strong className="alert-header">Suggested Use</strong>
...
<DocsImage
  src="/img/guides/server-routing-table.png"
  alt="Routing Table"
></DocsImage>
...
<DocsImage
  src="/img/guides/clear-source-of-failure.png"
  alt="Wait Failure"
></DocsImage>
