...
<strong className="alert-header">Anti-Pattern</strong>
...
<strong className="alert-header">Why start a local development server?</strong>
...
<strong className="alert-header">Configuration Options</strong>
...
<strong className="alert-header">Guide: Network Requests</strong>
...
<strong className="alert-header">No! Please don\'t.</strong>
...
<strong className="alert-header">Authentication Recipes</strong>
...
- <Icon name="github"></Icon>
  ...
  (RWA)](https://github.com/cypress-io/cypress-realworld-app) for practical
  demonstrations of Cypress testing practices, configuration, and strategies in
