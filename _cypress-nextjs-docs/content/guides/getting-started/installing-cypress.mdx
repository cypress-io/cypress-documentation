...
<strong className="alert-header">Best Practice</strong>
...
<strong className="alert-header">Direct downloading for old versions</strong>
...
<strong className="alert-header">Cross Browser Support</strong>
